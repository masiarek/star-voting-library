...
**Concept docs:** [Ranked Robin (the method)](../concepts/ranked_robin.md) · [Condorcet efficiency (topic hub)](../../07_Concepts/topics/condorcet/README.md) · why IRV is fragile here: center squeeze in [Ranked Robin vs. Condorcet](../concepts/ranked_robin_vs_condorcet.md).

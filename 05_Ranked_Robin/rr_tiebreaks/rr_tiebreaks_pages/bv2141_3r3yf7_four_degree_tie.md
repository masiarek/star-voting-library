...
Full report from the [`_tabulated` mirror](../rr_tiebreaks_tabulated/bv2141_3r3yf7_four_degree_tie_tabulated.txt) (regenerated on every run; every analysis forced on):
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 05_Ranked_Robin/rr_tiebreaks/bv2141_3r3yf7_four_degree_tie.yaml
```

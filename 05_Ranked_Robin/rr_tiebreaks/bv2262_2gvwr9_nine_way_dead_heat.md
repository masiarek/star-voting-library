...
```bash
python3 STARVote_LH_tabulation_engine/tools_adam/bv_replay_tiebreak.py 05_Ranked_Robin/rr_tiebreaks/cases/bv2262_2gvwr9_nine_way_dead_heat_bv_export.json
```

```bash
uv run STARVote_LH_tabulation_engine/tools_adam/pref_voting_tabulation_engine/ranked_robin_report.py 05_Ranked_Robin/rr_tiebreaks/cases/bv2262_2gvwr9_nine_way_dead_heat.yaml
```
...
- **The ladder, and where LH and BV part ways:** [Ranked Robin tiebreaks — LH vs BetterVoting](../concepts/rr_tiebreak_lh_vs_bv.md)
...
- **Why a cycle has no right answer:** [cycle resolution](../concepts/cycle_resolution.md) · **why some tie is unavoidable:** [Ties Are Forced](../../07_Concepts/topics/ties/ties_are_forced.md)

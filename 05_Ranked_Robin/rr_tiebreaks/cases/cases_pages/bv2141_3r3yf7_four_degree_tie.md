...
Winner — Ranked Robin (RCV-RR): Ava
   *** 2 candidates tie for the top Copeland score, 3.5 (Ava, Bianca) — a Condorcet cycle (Ava → Deegan → Bianca → Cedric → Ava: no candidate beats all others). Resolved by total margin, then lot order. (This is where Minimax / Ranked Pairs / Schulze differ — see 00_start_here/RCV_Ranked_Robin/cycle_resolution.md.)
```

...
**Method:** [Ranked Robin (RCV-RR / Copeland)](../../../concepts) · **1 seat** · **Expected winner:** Boris

**▶ Live on BetterVoting:** [vote](https://bettervoting.com/2gvwr9) · **[results ↗](https://bettervoting.com/2gvwr9/results)** (election `2gvwr9`).

**Official tie-break (lot) order:** Boris > Felix > Greta > Dmitri > Carmen > Alice > Ivan > Elena > Hugo — consulted only if every deterministic tiebreaker stays tied ([how the ladder works](../../../../01_STAR/concepts/Tie_Breaking_STAR/tie_breaking.md)).
...
Winner — Ranked Robin (RCV-RR): Boris
   *** 9 candidates tie for the most wins (Alice, Boris, Carmen, Dmitri, Elena, Felix, Greta, Hugo, Ivan) — a Condorcet cycle (no candidate beats all others). Resolved by total margin, then lot order. (This is where Minimax / Ranked Pairs / Schulze differ — see 05_Ranked_Robin/concepts/cycle_resolution.md.)
```
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 05_Ranked_Robin/rr_tiebreaks/cases/bv2262_2gvwr9_nine_way_dead_heat.yaml
```
...
More cases in this set: [bv2141_3r3yf7_four_degree_tie](bv2141_3r3yf7_four_degree_tie.md) · [bv2261_y2fbpc_tiebreak_recorded_cycle](bv2261_y2fbpc_tiebreak_recorded_cycle.md) · [bv2261_y2fbpc_tiebreak_recorded_draws](bv2261_y2fbpc_tiebreak_recorded_draws.md) · [dead_heat_lot_tiebreak](dead_heat_lot_tiebreak.md)

...
Full report from the [`_tabulated` mirror](../cases_tabulated/dead_heat_lot_tiebreak_tabulated.txt) (regenerated on every run; every analysis forced on):
...
More cases in this set: [bv2141_3r3yf7_four_degree_tie](bv2141_3r3yf7_four_degree_tie.md)

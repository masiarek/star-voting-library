...
- **The ladder and where the engines part ways:** [Ranked Robin tiebreaks — LH vs BetterVoting](../concepts/rr_tiebreak_lh_vs_bv.md)
...
- **Why a cycle has no right answer:** [cycle resolution](../concepts/cycle_resolution.md) · [the method itself](../concepts/ranked_robin.md)

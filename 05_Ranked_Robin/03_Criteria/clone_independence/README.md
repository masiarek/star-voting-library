...
Frozen BV exports sit next to their yamls; full audit mirrors in `clone_independence_tabulated/`. Why the divergence is possible at all: LH breaks Copeland ties by margin → lot (deterministic), BV by head-to-head → random — see [RR tiebreak, LH vs BV](../../01_Learn/rr_tiebreak_lh_vs_bv.md).

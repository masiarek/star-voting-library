# 05_Ranked_Robin/03_Criteria/burial — the worked burial pair
...
- **Every method has its wart.** IRV: [center squeeze](../../../07_Concepts/topics/center_squeeze/README.md). STAR: the [runoff-born favorite-betrayal sliver](../../../01_STAR/03_Criteria/favorite_betrayal/README.md). Approval: the [threshold dilemma](../../../01_STAR/05_Practice/ex13_draw_the_line.md). Ranked Robin and all Condorcet methods: burial. The honest comparison is *which warts are systematic and which need a heist* — this one is a heist, but a real one.
...
**Where this comes from.** Ballots and cast are this repo's own, built so the burial's anatomy is visible in the pairwise table (which wins the buriers sit inside, which they don't). Method home: [Ranked Robin](../../README.md) · cycle handling: [cycle_resolution.md](../../01_Learn/cycle_resolution.md) · the LH-vs-BV tiebreak caveat: [rr_tiebreak_lh_vs_bv.md](../../01_Learn/rr_tiebreak_lh_vs_bv.md).

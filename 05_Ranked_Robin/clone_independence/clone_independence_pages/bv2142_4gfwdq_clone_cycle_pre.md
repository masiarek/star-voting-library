...
Full report from the [`_tabulated` mirror](../clone_independence_tabulated/bv2142_4gfwdq_clone_cycle_pre_tabulated.txt) (regenerated on every run; every analysis forced on):
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 05_Ranked_Robin/clone_independence/bv2142_4gfwdq_clone_cycle_pre.yaml
```

...
**Official tie-break (lot) order:** Alice > Bruno > Carmen > Dmitri > Elena — consulted only if every deterministic tiebreaker stays tied ([how the ladder works](../../../../01_STAR/concepts/Tie_Breaking_STAR/tie_breaking.md)).

...
> Want the whole count? Full LH report → [`rr_blank_is_last_c4_b3_tabulated.txt`](../02_Examples/cases/cases_tabulated/rr_blank_is_last_c4_b3_tabulated.txt) · source → [`rr_blank_is_last_c4_b3.yaml`](../02_Examples/cases/rr_blank_is_last_c4_b3.yaml). Independently cross-checked with `pref_voting`'s Copeland (AGREE, unique winner).

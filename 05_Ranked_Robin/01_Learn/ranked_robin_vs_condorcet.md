...
Five voters, candidates Ada / Ben / Cara ([`01_condorcet_winner.yaml`](../02_Examples/condorcet_vs_ranked_robin/cases/01_condorcet_winner.yaml)):
...
Now seven voters, same three candidates ([`02_cycle_no_condorcet.yaml`](../02_Examples/condorcet_vs_ranked_robin/cases/02_cycle_no_condorcet.yaml)):

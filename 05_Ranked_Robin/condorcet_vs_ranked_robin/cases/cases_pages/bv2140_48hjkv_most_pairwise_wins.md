...
Full report from the [`_tabulated` mirror](../cases_tabulated/bv2140_48hjkv_most_pairwise_wins_tabulated.txt) (regenerated on every run; every analysis forced on):

...
**Method:** [Ranked Robin (RCV-RR / Copeland)](../../01_Learn/README.md) · **1 seat** · **Expected winner:** Nashville · [full count →](cases/cases_pages/bv2131_tennessee_condorcet_center_vqyqkr.md)
<!-- case-meta:end -->
...
uv run STARVote_LH_tabulation_engine/tools_adam/pref_voting_tabulation_engine/ranked_robin_report.py \
  05_Ranked_Robin/02_Examples/rr_vs_irv_plurality/cases/bv2131_tennessee_condorcet_center_vqyqkr.yaml
```

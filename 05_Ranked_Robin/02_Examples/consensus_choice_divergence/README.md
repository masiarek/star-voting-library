...
Everyone finishes **1–1**. Copeland ties all three, the [Smith set](../../../07_Concepts/topics/smith_set.md) is the whole field, and the cycle rule decides the election by itself.

...
Up: [05_Ranked_Robin — Ranked Robin (RCV-RR / Copeland)](../) · the method taught: [Ranked Robin (RCV-RR)](../01_Learn/ranked_robin.md) · where RR and IRV genuinely part ways: [rr_vs_irv_plurality](rr_vs_irv_plurality/) (the Tennessee center squeeze)

...
→ **Full lesson (the teaching write-up):** [Ranked Robin vs. Condorcet](../../01_Learn/ranked_robin_vs_condorcet.md) · deeper math: [the math behind Condorcet](../../01_Learn/the_math_behind_condorcet.md)
...
*Regenerate any report by re-running the `.yaml` through the LH engine; the `…_tabulated.txt` mirrors are generated siblings. Full teaching write-up: [ranked_robin_vs_condorcet.md](../../01_Learn/ranked_robin_vs_condorcet.md).*

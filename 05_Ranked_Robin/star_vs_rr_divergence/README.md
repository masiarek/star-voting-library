...
- **Dark horse** — a Condorcet winner exists but **misses STAR's score top-two**: a broadly-preferred, low-intensity compromise. The [preference-vs-support](../../07_Concepts/scores_and_ranks/preference_vs_support.md) split; a real [RR limit](../concepts/RCV_RR_honest_limits.md).

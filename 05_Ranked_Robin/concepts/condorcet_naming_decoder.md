...
| **Ranked Robin** (**RCV-RR**) | a **branded method** — Copeland + a defined cycle tiebreak (sum of win margins) | [Equal Vote Coalition](https://equal.vote), 2021 — method designed by [Sass](https://electowiki.org/wiki/User:Sass), name coined by [Sara Wolk](https://electowiki.org/wiki/Talk:Ranked_Robin) | [electowiki](https://electowiki.org/wiki/Ranked_Robin) · [equal.vote](https://www.equal.vote/ranked_robin) |

...
Five voters, candidates Ada / Ben / Cara ([`01_condorcet_winner.yaml`](../condorcet_vs_ranked_robin/cases/01_condorcet_winner.yaml)):
...
Now seven voters, same three candidates ([`02_cycle_no_condorcet.yaml`](../condorcet_vs_ranked_robin/cases/02_cycle_no_condorcet.yaml)):
...
This isn't just a contrived 3-candidate trick. It's why the **Condorcet column was blank** in the random STAR sweep you ran (`tools_adam/random_star_divergence.py`). Take its very first divergent election — **record 0**, 6 candidates, 5 voters ([`03_real_record0_c6_b5.yaml`](../condorcet_vs_ranked_robin/cases/03_real_record0_c6_b5.yaml)):
...
- [Which RCV-IRV?](../../00_start_here/RCV_IRV/variants/RCV_IRV_variants.md) — the BTR/Baldwin/Nanson variants are also Condorcet methods

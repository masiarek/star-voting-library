...
| **Score distribution** | Per-candidate star histogram; **Avg** via exact-rational `ROUND_HALF_UP` (not float `/`). | `show_score_counts` · [score distribution](../01_STAR/concepts/reporting/score_distribution_and_averages.md) |

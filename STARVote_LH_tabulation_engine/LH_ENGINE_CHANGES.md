...
The vendored `starvote 2.1.6` package is ~97% character-identical to PyPI (the rest is line-reflow). Only six functional edits exist — two output toggles and four bug fixes; all are candidates to offer upstream:

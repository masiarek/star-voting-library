...
CASES = [
    ("06_Other/Range/cases/range_101_c3_b5.yaml", "Beth"),
    ("method_comparisons/black_curtain/cases/Black_Curtain_01_c3_b5_hidden-consensus.yaml", "Bob"),
    ("method_comparisons/black_curtain/cases/Black_Curtain_02_c3_b5_near-clones.yaml", "Cal"),
    ("method_comparisons/black_curtain/cases/Black_Curtain_03_c3_b5_polarized-on-cal.yaml", "Ann"),
    ("method_comparisons/black_curtain/cases/Black_Curtain_04_c4_b5_four-candidates.yaml", "Cal"),
]
...
def test_pref_voting_crosscheck_agrees_when_present():
    ...
    path = REPO_ROOT / "06_Other/Range/cases/range_101_c3_b5.yaml"
    r = subprocess.run([sys.executable, str(ENGINE), str(path)],
                       capture_output=True, text=True)

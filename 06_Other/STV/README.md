...
Full audit mirror in `STV_tabulated/`. Concepts: [proportional representation](../../03_STAR_PR/concepts/README.md) — and don't fold STV into "RCV" = IRV; it's the *multi-winner* count of the same ballot ([terminology](../../07_Concepts/tips/TIPS_terminology.md)).

...
| Case | Page | YAML |
|---|---|---|
| STV — 3 seats, 7 candidates (proportional RCV) | [page](STV_pages/03a_stv_3seats.md) | [`03a_stv_3seats.yaml`](03a_stv_3seats.yaml) |
| **The sole-survivor STV crash** — a live BetterVoting bug, bisected with five public elections and diagnosed in BV's `IRV.ts` (BV2203–BV2205) | [lab notebook](bv_stv_sole_survivor_crash/README.md) | [flag probe](bv_stv_sole_survivor_crash/bv2203_gvtg2h_flag_probe.yaml) · [control](bv_stv_sole_survivor_crash/bv2204_39py93_control_standing_hopefuls.yaml) · [minimal](bv_stv_sole_survivor_crash/bv2205_8xwx43_minimal_sole_survivor.yaml) |

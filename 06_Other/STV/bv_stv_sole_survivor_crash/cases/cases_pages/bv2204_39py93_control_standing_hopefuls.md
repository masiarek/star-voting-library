...
eliminated. 13 voters, hand-count Droop quota = floor(13/3)+1 = 5.
Round 1: Angelou holds 6 ≥ 5, elected; her surplus of 1 transfers (six
ballots at 1/6 each) to Blake: 1+1 = 2. Round 2: Cummings holds 5 ≥ 5,
elected with zero surplus — both seats filled, Blake and Dickinson
never eliminated. (NOTE — which Droop quota: those two rounds are the
hand count's. The LH report below applies the other standard Droop
quota, the exact 13/3 = 4.33, which BOTH Angelou and Cummings already
clear on first choices — so it seats them together in one round and
prints a single table, with no surplus transfer to Blake shown. Same
two seats, and the point of the probe — an endgame with hopefuls still
standing — holds under either rule.) PREDICTION: computes. RESULT: computes — BetterVoting

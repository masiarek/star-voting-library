...
|---|---|---|:--:|
| **[RCV-IRV](RCV_IRV)** | [RCV ballot example](RCV_IRV/RCV_IRV_pages/RCV_ballot_example.md) | a plain ranked-ballot instant-runoff count | [`.yaml`](RCV_IRV/RCV_ballot_example.yaml) |
...
| **[Range / Score](Range)** | [Range / Score 101](Range/Range_pages/range_101_c3_b5.md) | highest total score wins — STAR without the runoff | [`.yaml`](Range/range_101_c3_b5.yaml) |
| **[3-2-1 Voting](three_two_one)** | [3-2-1 Voting](three_two_one/README.md) | Good/OK/Bad → 3 semifinalists → 2 finalists → 1 winner (Tennessee, blank = Bad) | [`.yaml`](three_two_one/321_tennessee_blank_encoding_c4_b100.yaml) |

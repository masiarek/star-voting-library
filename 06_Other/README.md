...
| **[STV](STV)** | [STV — 3 seats](STV/cases/cases_pages/03a_stv_3seats.md) | proportional seats from ranked ballots (compare [proportional STAR](../03_STAR_PR/README.md) on score ballots) | [`.yaml`](STV/cases/03a_stv_3seats.yaml) |

...
→ Companions: [Ranked Robin](../../00_start_here/RCV_Ranked_Robin/ranked_robin.md) (the *neutral* way to run the same pairwise matchups) · [Borda](borda.md) · Glossary: [`Condorcet`](../../00_start_here/GLOSSARY.md)
...
- [Ranked Robin](../../00_start_here/RCV_Ranked_Robin/ranked_robin.md) — the neutral round-robin over the same matchups
- [Cycle resolution](../../00_start_here/RCV_Ranked_Robin/cycle_resolution.md) — what to do when the cycle isn't manufactured
- [Borda](borda.md) — the other classic "ranked but not Condorcet" method in this folder
- [Scoring methods vs. ranked voting](../../00_start_here/topics/scoring-methods-vs-ranked-voting.md) — the ballot-type map

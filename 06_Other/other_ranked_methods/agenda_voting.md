...
→ Companions: [Ranked Robin](../../05_Ranked_Robin/concepts/ranked_robin.md) (the *neutral* way to run the same pairwise matchups) · [Borda](borda.md) · Glossary: [`Condorcet`](../../00_start_here/GLOSSARY.md)

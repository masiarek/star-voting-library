...
**Method:** [range](../../../../07_Concepts/README.md) · **1 seat** · **Expected winner:** C
...
--- Range / Score Voting (single winner) ---
  Range / Score Voting — Sullivan's Example 5.2 (0–10 scale)
 Tabulating 10 ballots on a 0–10 scale (range/score: highest total wins, no runoff).
...
Cross-check — pref_voting score_voting: C  (✓ agrees with the hand count)

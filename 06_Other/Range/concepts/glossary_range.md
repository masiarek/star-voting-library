...
*Range is a non-EVC method (this library teaches it for honest comparison). Shared criteria — monotonicity, the Majority criterion, the Equal Vote criterion — are in the [main glossary](../../../07_Concepts/GLOSSARY.md#properties-criteria).*

...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/04_c4_b47_noise-soup_RCV-IRV_tabulated.txt
  RCV-RR round-robin: cases_tabulated/04_c4_b47_noise-soup_RCV-RR_tabulated.txt
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 06_Other/ballot_style_lab/cases/04_c4_b47_noise-soup.yaml
```

...
**Method:** [Bloc STAR (multi-winner, majoritarian)](../../../../02_STAR_Bloc/01_Learn/README.md) · **4 seats** · **Expected winners:** Dogwood, Aspen, Elm, Cedar
...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/09_c7_b44_park-bloc-4-seats_RCV-IRV_tabulated.txt
...
[Condorcet Loser]
  Condorcet Loser: Birch — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 06_Other/ballot_style_lab/cases/09_c7_b44_park-bloc-4-seats.yaml
```

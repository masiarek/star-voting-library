...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/02_c4_b40_cliff-city_RCV-IRV_tabulated.txt
...
[Condorcet Loser]
  Condorcet Loser: Dumpling — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 06_Other/ballot_style_lab/cases/02_c4_b40_cliff-city.yaml
```

...
The multi-winner files need no display options — the engine switches the finalists matrix off for multi-winner races automatically (a "Top 2 Finalist" matrix is a single-winner concept). The hand-built companion set for the sweep-vs-share lesson is [03_STAR_PR/\_main/02a–02c](../../03_STAR_PR/02_Examples/README.md); the style lab adds realistic style mixing, individual rows, and the tie drama.

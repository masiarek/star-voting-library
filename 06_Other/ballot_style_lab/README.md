...
Renderings implemented by the generator (utilities → 0–5 scores). Gallery styles carry the [style-gallery](../../01_STAR/concepts/STAR_ballot_voting_styles.md) names; band styles are the lab's additions.

...
The multi-winner files follow the house multi-winner options (`show_matrix: false` — a "Top 2 Finalist" matrix is a single-winner concept). The hand-built companion set for the sweep-vs-share lesson is [03_STAR_PR/\_main/02a–02c](../../03_STAR_PR/02_Examples/); the style lab adds realistic style mixing, individual rows, and the tie drama.

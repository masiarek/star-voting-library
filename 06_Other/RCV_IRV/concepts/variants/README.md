...
- [Which RCV-IRV?](RCV_IRV_variants.md) — the family overview: Hare (the US "RCV") and its siblings, compared on one table.
- [RCV-IRV (BTR) — Bottom-Two-Runoff](RCV-IRV-BTR.md) — eliminate the pairwise loser of the bottom two; the variant that becomes Condorcet-compliant.

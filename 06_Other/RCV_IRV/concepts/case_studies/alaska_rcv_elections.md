...
|---|---|---|---|
| **Aug 2022** | **US House — special** (Peltola / Begich / Palin) | **Peltola** | **YES — center squeeze.** Begich beat both head-to-head (the [Condorcet winner](../../../../00_start_here/topics/condorcet/)) but had the fewest first choices, so IRV eliminated him first. **← the case this repo models.** |

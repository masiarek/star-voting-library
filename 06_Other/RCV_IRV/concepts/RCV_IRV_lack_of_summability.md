...
The classic demonstration (after [rangevoting.org](https://www.rangevoting.org/IrvNonAdd.html), verified on the engine — run [`summability_demo/`](../../../method_comparisons/summability_demo/README.md)):
...
(This is one row on the method scorecard: *Summable / local tally? — STAR: yes, RCV-IRV: no.* See the flagship Segment 6 in [What's So Good About STAR Voting?](../../../01_STAR/01_Learn/reference/whats_so_good_about_STAR_Voting.md).)

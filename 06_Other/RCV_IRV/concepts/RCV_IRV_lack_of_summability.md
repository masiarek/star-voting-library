...
(This is one row on the method scorecard: *Summable / local tally? — STAR: yes, RCV-IRV: no.* See the flagship Segment 6 in [What's So Good About STAR Voting?](../../../01_STAR/concepts/reference/whats_so_good_about_STAR_Voting.md).)

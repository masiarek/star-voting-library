...
Full report from the [`_tabulated` mirror](../_demo_dropbox_tabulated/Ballot Data - The BV recipe (the _crazy_ scenario)-jfk7pd_published_order_tabulated.txt) (regenerated on every run; every analysis forced on):

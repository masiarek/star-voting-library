...
*Worked example ([the baseline case, counted in full](_main/cases/cases_pages/00_c3_b3_bloc-baseline-2-seats.md)):* 3 candidates, 2 seats. Score round: Alice 14, Bruno 12 are the top two; in the runoff Alice is preferred 2–1, so **Alice takes seat 1**. Remove Alice and re-run on the remaining two: **Bruno takes seat 2**.
...
This tension is the whole reason proportional methods exist. Gentle intro to the trade-off (approval side, counting only): [Electing a committee — making sure people have a voice](../04_Approval/concepts/Multiwinner_Approval/abc_rules_intro.md). Concept hub: [proportional representation](../03_STAR_PR/concepts/).

## Learning path

1. **The baseline** — the smallest Bloc election that decides something: [Bloc STAR baseline — 3 candidates, 2 seats](_main/cases/cases_pages/00_c3_b3_bloc-baseline-2-seats.md).
2. **A basic two-seat race** — see the elect-remove-rerun loop on a slightly bigger field: [Bloc STAR — a 2-seat committee election](_main/cases/cases_pages/01_c4_b2_bloc-star-2-seats.md) (4 candidates; the CURRICULUM 201.5 file).
...
|---|:--:|---|---|
| `00` — pure baseline | 2 | The clean elect-remove-rerun loop, no tiebreak — read this first. | [page](_main/cases/cases_pages/00_c3_b3_bloc-baseline-2-seats.md) · [yaml](_main/cases/00_c3_b3_bloc-baseline-2-seats.yaml) |
| `01` — basic two-seat | 2 | 4 candidates, 2 seats — the CURRICULUM 201.5 intro file. | [page](_main/cases/cases_pages/01_c4_b2_bloc-star-2-seats.md) · [yaml](_main/cases/01_c4_b2_bloc-star-2-seats.yaml) |
| Shadow STAR — Lackner & Skowron | 4 | Bloc STAR on the academic running example used across the multi-winner literature. | [page](_main/cases/cases_pages/lackner_skowron_shadow_bloc_star_c7_b12.md) · [yaml](_main/cases/lackner_skowron_shadow_bloc_star_c7_b12.yaml) |

**Tie-breaking & BetterVoting reproductions (201/301):**

| BV id | Scenario | Seats | Tie? | BV status / issue | Read · run |
|-------|----------|:--:|------|-------------------|------|
| BV1815 | 3c/2s — seat 2 by **score** tiebreak | 2 | runoff (seat 2) | Passed | [lesson](_main/bv1815_bloc_3c2s_basic.md) · [count](_main/cases/cases_pages/bv1815_bloc_3c2s_basic.md) · [yaml](_main/cases/bv1815_bloc_3c2s_basic.yaml) |
| BV132 | verify votes cast — flat ballots dropped | 2 | flat/no-pref | Failed · [#1073](https://github.com/Equal-Vote/bettervoting/issues/1073) | [lesson](_main/bv132_verify_votes_bloc.md) · [count](_main/cases/cases_pages/bv132_verify_votes_bloc.md) · [yaml](_main/cases/bv132_verify_votes_bloc.yaml) |
| BV131 | Guido example — **hidden lot-decided tie** (seat 1) | 2 | lot (seat 1) | "Passed" (but a coin toss; `tieBreakType` mislabeled `none`) | [lesson](_main/bv131_guido_bloc.md) · [count](_main/cases/cases_pages/bv131_guido_bloc.md) · [yaml](_main/cases/bv131_guido_bloc.yaml) |
| BV129 | 3c/2w — seat 2 by **score** tiebreak | 2 | runoff (seat 2) | count OK; "Failed" = method-name label [#1086](https://github.com/Equal-Vote/bettervoting/issues/1086) ([note](_main/bv129_1086_method_name_note.md)) | [lesson](_main/bv129_score_tiebreak_bloc.md) · [count](_main/cases/cases_pages/bv129_score_tiebreak_bloc.md) · [yaml](_main/cases/bv129_score_tiebreak_bloc.yaml) |
| BV126 | "ties every step" | — | yes | Failed · [#1052](https://github.com/Equal-Vote/bettervoting/issues/1052) | *pending* |
| BV750 | tie-breaking — all ballots identical (5,5,5) | 2 | lot (both seats) | Failed — every ballot dropped (`nTallyVotes 0`) [#1052](https://github.com/Equal-Vote/bettervoting/issues/1052) | [lesson](_main/bv750_tie_breaking_bloc.md) · [count](_main/cases/cases_pages/bv750_tie_breaking_bloc.md) · [yaml](_main/cases/bv750_tie_breaking_bloc.yaml) |
| BV130 | 6c/3w — original (clean, no tie) | 3 | none | tabulation OK; reporting fix (tabs → pages) star-server#731 | [lesson](_main/bv130_bloc_pagination_731.md) · [count](_main/cases/cases_pages/bv130_bloc_pagination_731.md) · [yaml](_main/cases/bv130_bloc_pagination_731.yaml) |
| BV130-r2 | 6c/3w — **dead-rung lot tie** (seat 1) | 3 | lot (seat 1) | Passed (`9ff9jk`); lot-decided seat, `tieBreakType` reads `none` | [lesson](_main/bv130r2_dead_rung_bloc.md) · [count](_main/cases/cases_pages/bv130r2_dead_rung_bloc.md) · [yaml](_main/cases/bv130r2_dead_rung_bloc.yaml) |
| BV1525 | 5c/4w — **Condorcet-loser ties for seat 1** (electowiki) | 4 | lot (seat 1) | LH reproduces First–Fourth; STAR 2.0 random-tie non-reproducible | [lesson](_main/bv1525_condorcet_loser_bloc.md) · [count](_main/cases/cases_pages/bv1525_condorcet_loser_bloc.md) · [yaml](_main/cases/bv1525_condorcet_loser_bloc.yaml) |
| BV2105 | Favorite ice cream demo | 2 | — | Failed (regression) | [lesson](_main/bv2105_r4dqvd_ice_cream_bloc.md) · [count](_main/cases/cases_pages/bv2105_r4dqvd_ice_cream_bloc.md) · [yaml](_main/cases/bv2105_r4dqvd_ice_cream_bloc.yaml) |

...
→ The other half of the map: [proportional methods](../../03_STAR_PR/01_Learn/) · the fork itself: [Electing more than one, simply](../../07_Concepts/topics/electing_more_than_one.md) · the mechanics here: [Bloc STAR](bloc_star.md)
...
The plurality family — [Block, Limited and SNTV](../../method_comparisons/multi_member_plurality/) — differs *only* in votes per voter, and that one dial slides the outcome from majority sweep (3:0) to minority-tops-the-poll (2:1 with the minority leading) on the same 60/40 electorate.
...
This is the practical argument, and [Food-Truck Row](../../method_comparisons/food_truck_row/) makes it in one table. One 100-voter electorate, two seats: a **57-voter savory majority running three trucks** against a **43-voter sweet minority running two**.
...
2. **Do you want one ballot for every race?** This is the underrated one. The 0–5 STAR ballot is the *same physical ballot* for single-winner, Bloc, and [proportional](../../03_STAR_PR/01_Learn/) races — so a jurisdiction can change what a body is for without retraining its voters. SNTV and Limited Voting change the instruction line with the seat count.

And if the sweep is what you're trying to avoid, don't shop within this family at all — every method on this page will sweep. Go to [STAR-PR](../../03_STAR_PR/01_Learn/STAR_PR/) or [STV](../../06_Other/STV/README.md).

## See also

- [Bloc STAR](bloc_star.md) · [the majority sweep](majority_sweep.md) · [honest limits](bloc_honest_limits.md)
- [Food-Truck Row](../../method_comparisons/food_truck_row/) — one electorate, five counts, three outcomes
- [Block, Limited & SNTV](../../method_comparisons/multi_member_plurality/) — the plurality family on one 60/40 electorate
- [Pets Governance](../../method_comparisons/pets_governance/) — six methods, one electorate, at 3 seats

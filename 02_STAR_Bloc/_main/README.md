...
**Index & status** — the BV id → scenario → tie type → issue → case table lives one level up, in the folder overview: [02_STAR_Bloc/README.md → The reference cases](../README.md#the-reference-cases). That's the single source of truth; this page just makes the case folder discoverable on GitHub.

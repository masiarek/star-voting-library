...
- Concept: [Flat scores, ties & tie-breaking](../../01_STAR/Flat_scores_ties/README.md) · [why flat ballots don't change the winner](../../07_Concepts/topics/ties/why_contrived_tie_cases.md).

...
**Method:** [Bloc STAR (multi-winner, majoritarian)](../../../../03_STAR_PR/01_Learn) · **2 seats** · **Expected winners:** Cand2, Cand3
...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/bv131_guido_bloc_RCV-IRV_tabulated.txt
  RCV-RR round-robin: cases_tabulated/bv131_guido_bloc_RCV-RR_tabulated.txt
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 02_STAR_Bloc/02_Examples/cases/bv131_guido_bloc.yaml
```

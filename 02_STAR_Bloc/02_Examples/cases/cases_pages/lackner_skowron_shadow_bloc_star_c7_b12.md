...
**Method:** [Bloc STAR (multi-winner, majoritarian)](../../../../03_STAR_PR/01_Learn) · **4 seats** · **Expected winners:** A, B, C, D
...
04_Approval/02_Examples/multiwinner/approval_bloc_4seats_c7_b12_lackner_skowron.yaml.
...
Allocated Score) at 03_STAR_PR/02_Examples/lackner_skowron_shadow_star_pr_c7_b12.yaml,
...
[Condorcet Loser]
  No strict Condorcet loser; jointly weak Condorcet losers: E, G (winless — pairwise ties)
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/lackner_skowron_shadow_bloc_star_c7_b12_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 02_STAR_Bloc/02_Examples/cases/lackner_skowron_shadow_bloc_star_c7_b12.yaml
```

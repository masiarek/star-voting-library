...
**Method:** [Bloc STAR (multi-winner, majoritarian)](../../../../03_STAR_PR/01_Learn) · **2 seats** · **Expected winners:** Don, Cal
...
[Condorcet Loser]
  No strict Condorcet loser; jointly weak Condorcet losers: Ann, Bob (winless — pairwise ties)
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 02_STAR_Bloc/02_Examples/cases/01_c4_b2_bloc-star-2-seats.yaml
```

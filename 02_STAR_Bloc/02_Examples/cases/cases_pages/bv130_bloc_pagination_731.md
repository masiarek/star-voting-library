...
**Method:** [Bloc STAR (multi-winner, majoritarian)](../../../01_Learn/README.md) · **3 seats** · **Expected winners:** Someone I Like, Santa Claus, The Lesser Evil
...
[Condorcet Loser]
  Condorcet Loser: Apocalypse Now — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 02_STAR_Bloc/02_Examples/cases/bv130_bloc_pagination_731.yaml
```

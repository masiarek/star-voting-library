...
# Two officers, three candidates — Allocated Score

*Generated from [`two_officers_allocated.yaml`](../two_officers_allocated.yaml) — do not edit by hand. Regenerate: `python STARVote_LH_tabulation_engine/tools_adam/scripts/build_yaml_pages.py`.*

**Method:** [Allocated Score (proportional STAR)](../../../../01_Learn/README.md) · **2 seats** · **Expected winners:** Dana, Finn
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/two_officers_allocated_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 03_STAR_PR/02_Examples/method_divergences/cases/two_officers_allocated.yaml
```

...
**Method:** [Reweighted Range Voting (proportional STAR)](../../../01_Learn/README.md) · **4 seats** · **Expected winners:** A, B, C, F
...
../../02_STAR_Bloc/02_Examples/lackner_skowron_shadow_bloc_star_c7_b12.yaml. Approval
original: ../../04_Approval/02_Examples/multiwinner/approval_bloc_4seats_c7_b12_lackner_skowron.yaml.
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 03_STAR_PR/02_Examples/cases/lackner_skowron_shadow_star_pr_rrv_c7_b12.yaml
```

...
**Method:** [STAR (single winner)](../../../../01_STAR/01_Learn/README.md) · **1 seat** · **Expected winner:** Orange5
...
[Condorcet Loser]
  No strict Condorcet loser; weak Condorcet loser: Purple2 (never wins a matchup)
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 03_STAR_PR/02_Examples/cases/rrv_sample_c15_b13_three-parties.yaml
```

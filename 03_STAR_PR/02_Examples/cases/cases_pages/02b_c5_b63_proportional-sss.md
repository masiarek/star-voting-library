...
**Method:** [Sequentially Spent Score (proportional STAR)](../../../01_Learn/README.md) · **3 seats** · **Expected winners:** Alice, Ben, Dan
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 03_STAR_PR/02_Examples/cases/02b_c5_b63_proportional-sss.yaml
```

...
[Condorcet Loser]
  Condorcet Loser: TaxCuts — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 03_STAR_PR/02_Examples/cases/03b_star_pr_3seats.yaml
```

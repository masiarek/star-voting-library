...
**Method:** [Reweighted Range Voting (proportional STAR)](../../../concepts) · **3 seats** · **Expected winners:** Alice, Ben, Dan
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 03_STAR_PR/_main/cases/02c_c5_b63_proportional-rrv.yaml
```

...
**Method:** [Reweighted Range Voting (proportional STAR)](../../../concepts) · **4 seats** · **Expected winners:** A, B, C, F
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 03_STAR_PR/_main/cases/lackner_skowron_shadow_star_pr_rrv_c7_b12.yaml
```

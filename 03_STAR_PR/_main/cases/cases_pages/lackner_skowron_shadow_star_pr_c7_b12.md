...
**Method:** [Allocated Score (proportional STAR)](../../../concepts) · **4 seats** · **Expected winners:** A, B, C, D
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 03_STAR_PR/_main/cases/lackner_skowron_shadow_star_pr_c7_b12.yaml
```

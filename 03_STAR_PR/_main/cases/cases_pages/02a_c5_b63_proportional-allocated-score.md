...
**Method:** [Allocated Score (proportional STAR)](../../../concepts) · **3 seats** · **Expected winners:** Alice, Ben, Dan
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 03_STAR_PR/_main/cases/02a_c5_b63_proportional-allocated-score.yaml
```

...
# A full quota rates Dinah 5 and prefers her to everyone — and she wins no seat

*Generated from [`solid_coalition_quota_gets_nothing.yaml`](../solid_coalition_quota_gets_nothing.yaml) — do not edit by hand. Regenerate: `python STARVote_LH_tabulation_engine/tools_adam/scripts/build_yaml_pages.py`.*

**Method:** [Allocated Score (proportional STAR)](../../../../01_Learn/README.md) · **3 seats** · **Expected winners:** Arun, Bela, Curtis
...
Legend: For - Equal Support - Against
        ...
        so no Top-2 finalists are marked.
               |     Arun   |    Bela   |   Curtis  |   Dinah   |
-----------------------------------------------------------------
        Arun > |    ---     |6 - 0 - 3  |5 - 2 - 2  |4 - 2 - 3  |
        Bela > | 3 - 0 - 6  |   ---     |3 - 3 - 3  |5 - 1 - 3  |
      Curtis > | 2 - 2 - 5  |3 - 3 - 3  |   ---     |5 - 0 - 4  |
       Dinah > | 3 - 2 - 4  |3 - 1 - 5  |4 - 0 - 5  |   ---     |

[Condorcet Winner]
  Condorcet Winner: Arun — matches the STAR winner

[Condorcet Loser]
  Condorcet Loser: Dinah — loses every head-to-head matchup

[Score Distribution] (how many ballots gave each star rating)
                Score
Candidate  5  4  3  2  1  0  | Total   Avg
Arun       1  3  3  1  0  1  |    28   3.1
Bela       1  2  2  0  2  2  |    21   2.3
Curtis     1  2  0  3  0  3  |    19   2.1
Dinah      3  0  1  0  2  3  |    20   2.2
 Hare quota is 3.
...
Dinah      3  0  1  0  2  3  |    20   2.2
 The highest-scoring candidate wins a seat.
   Curtis        -- 6+2/3 -- First place
   Dinah         -- 4+2/3
 Curtis wins a seat.
```

Everything in one file: the [`_tabulated` mirror](../cases_tabulated/solid_coalition_quota_gets_nothing_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 03_STAR_PR/03_Criteria/solid_coalitions/cases/solid_coalition_quota_gets_nothing.yaml
```

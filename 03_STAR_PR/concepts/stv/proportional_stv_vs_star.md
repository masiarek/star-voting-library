...
→ Glossary: [`STV`](../../../00_start_here/GLOSSARY.md), [`Proportional STAR`](../../../00_start_here/GLOSSARY.md) · Curriculum: [`301.1`](../../../00_start_here/CURRICULUM.md) · Level: **Voting 301** · STAR-PR methods explained: [STAR_PR](../STAR_PR/)
...
→ Run them: [`03a_stv_3seats.yaml`](../../../06_Other/STV/cases/03a_stv_3seats.yaml) (ranked, STV) · [`03b_star_pr_3seats.yaml`](../../_main/cases/03b_star_pr_3seats.yaml) (scored, STAR-PR)
...
The honest answer is that **there's no settled way to measure it.** Single-winner methods have a standard yardstick — [VSE](../../../00_start_here/topics/what_makes_a_good_winner.md#measuring-it-empirically-vse-bayesian-regret) for accuracy, [PVSI](../../../00_start_here/topics/pvsi_strategic_incentive.md) for strategy resistance. Multi-winner has no accepted equivalent.

The most serious attempt is **AVEC** (Average Voter Effective Choice) by [Jameson Quinn](../../../00_start_here/topics/in_memoriam_jameson_quinn.md) — the same person who built VSE. It multiplies two factors: **AVE** (how much of the electorate's voting power actually elected *someone* — votes wasted below a [party threshold](../../../00_start_here/GLOSSARY.md) drag it down) and **AVC** (how much real choice voters had). Scored examples: Israel's April 2019 election ≈ **84%** (91.5% AVE × 92% AVC — 8.5% of votes fell below the threshold and were simply discarded), versus single-seat plurality districts at roughly **44%**.
...
**What follows for this library.** When someone asks "is STAR-PR better than STV?", the defensible comparisons are *mechanical and administrative* — [summability](../../../00_start_here/topics/summability/), ballot expressiveness (scores capture strength, ranks capture order), how easily a voter can check the count, and whether the jurisdiction can run it — **not** a satisfaction score. Anyone quoting a precise "proportional accuracy" figure is ahead of the evidence. That applies to STAR-PR exactly as much as to STV.

## STV is not IRV

**STV = the proportional, multi-winner cousin of IRV.** Same ranked ballot and transfer idea, but it fills several seats against a quota instead of one. Reserve "IRV" for the single-winner case. (See [Tips — Terminology: RCV vs IRV vs RCV-IRV (and friends)](../../../00_start_here/tips/TIPS_terminology.md).)

...
- [Allocated Score](../../_main/cases/cases_pages/02a_c5_b63_proportional-allocated-score.md) — the same 63 ballots, seat by seat ([yaml](../../_main/cases/02a_c5_b63_proportional-allocated-score.yaml))
- [SSS](../../_main/cases/cases_pages/02b_c5_b63_proportional-sss.md) — same ballots, budget-spending reweight ([yaml](../../_main/cases/02b_c5_b63_proportional-sss.yaml))
- [RRV](../../_main/cases/cases_pages/02c_c5_b63_proportional-rrv.md) — same ballots, D'Hondt divisor ([yaml](../../_main/cases/02c_c5_b63_proportional-rrv.yaml))
- [STAR-PR, 3 seats](../../_main/cases/cases_pages/03b_star_pr_3seats.md) — the same race as the STV file ([yaml](../../_main/cases/03b_star_pr_3seats.yaml))

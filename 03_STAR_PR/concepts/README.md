...
Both proportional families are **Voting 301** material — see [Voting 301](../../07_Concepts/curriculum/CURRICULUM_301.md) (301.1), or the [curriculum hub](../../07_Concepts/CURRICULUM.md) for the whole map. For the single-winner methods, stay in [STAR](../../01_STAR/concepts) and [RCV-IRV](../../06_Other/RCV_IRV/concepts).

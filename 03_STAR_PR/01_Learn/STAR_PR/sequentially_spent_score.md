...
**Coverage here is thinner than Allocated Score's, and that is worth saying plainly.** Six case files use `sss`, against twenty for Allocated Score. Nothing about the method makes it hard to test — the gap is this library's, not SSS's.

...
**8. Disclose the lean.** Both authors are the Center for Election Science — Hamlin co-founded it and was its executive director, Hua its director of research. CES is the Approval Voting advocacy organisation. This is advocates presenting their own method, exactly as [Wolk, Quinn & Ogren](../../01_STAR/concepts/reference/wolk_quinn_ogren_2023.md) are advocates presenting theirs, and both should be read the same way.

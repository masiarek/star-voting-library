...
*This `av` rule is exactly the LH engine's `Approval_Multi_Winner` (bloc Approval) — see [the approval original](../../multiwinner/cases/approval_bloc_4seats_c7_b12_lackner_skowron.yaml).*
...
Reading the same approval ballots as STAR ballots (approve = 5, else 0) and running STAR's committee rules (see [the shadow-STAR page](../../multiwinner/lackner_skowron_shadow_star.md)) maps the STAR family onto the *same* axis:
...
- Companion pages: [101 intro](abc_rules_intro.md) · [shadow STAR](../../multiwinner/lackner_skowron_shadow_star.md) · [Approval — multi-winner](approval_multiwinner.md).

...
Here's the instructive part. Suppose you tried to spare everyone the second trip by making the runoff **automatic** — advance the two most-approved, then re-count *the same approval ballots* head-to-head. Try it on the flagship Approval example, [`approval_101`](../_main/cases/cases_pages/approval_101_c3_b5.md) (5 voters, live on BetterVoting — [results ↗](https://bettervoting.com/ff6mk3/results)). The LH engine's report:

...
- Concept docs: [`../04_Approval/concepts/`](concepts) — the [method overview](concepts/approval_voting.md), its [honest limits](concepts/approval_honest_limits.md), and [multi-winner Approval](concepts/Multiwinner_Approval/approval_multiwinner.md)

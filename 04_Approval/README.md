...
**New to Approval?** The concept pages for this method live in [`concepts/`](concepts/README.md) — start with [Approval Voting](concepts/approval_voting.md) (the ballot and the count), then its [honest limits](concepts/approval_honest_limits.md). Everything below is the **runnable examples**.
...
- Multi-winner theory: [multi-winner Approval](concepts/Multiwinner_Approval/approval_multiwinner.md) and the [ABC rules](concepts/Multiwinner_Approval/abc_rules_intro.md)
...
**Conversation scripts:** the Larry ↔ Adam series (STAR + RCV-IRV) is indexed in [Conversation scripts — index](../07_Concepts/about_this_repo/06_conversation_scripts.md).

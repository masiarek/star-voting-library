...
Cases live in [`02_Examples/`](02_Examples), starting with [`approval_101_c3_b5.yaml`](02_Examples/cases/approval_101_c3_b5.yaml). Multi-winner (bloc) Approval has its own folder: [multi-winner Approval](02_Examples/multiwinner/) — the same ballot, top-`N` approved win, and a worked majority-sweep example.

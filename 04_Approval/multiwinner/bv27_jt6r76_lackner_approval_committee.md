...
- The education built on this election: [ABC rules — a gentle intro (101)](../concepts/Multiwinner_Approval/abc_rules_intro.md) · [ABC rules & the utilitarian–egalitarian spectrum (301)](../concepts/Multiwinner_Approval/abc_rules_spectrum.md).

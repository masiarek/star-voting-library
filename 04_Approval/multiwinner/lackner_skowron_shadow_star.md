...
- **The ABC-rules education built on this same example:** [committees & coverage — a gentle intro (101)](../../00_start_here/Approval_Voting/Multiwinner_Approval/abc_rules_intro.md) · [ABC rules & the utilitarian–egalitarian spectrum (301)](../../00_start_here/Approval_Voting/Multiwinner_Approval/abc_rules_spectrum.md).

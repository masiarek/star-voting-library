...
- **The ABC-rules education built on this same example:** [committees & coverage — a gentle intro (101)](../concepts/Multiwinner_Approval/abc_rules_intro.md) · [ABC rules & the utilitarian–egalitarian spectrum (301)](../concepts/Multiwinner_Approval/abc_rules_spectrum.md).
- [Bloc STAR vs proportional STAR](../../03_STAR_PR/concepts/) — the majoritarian/proportional split in the STAR family.
- [Approval multi-winner](../concepts/Multiwinner_Approval/approval_multiwinner.md).

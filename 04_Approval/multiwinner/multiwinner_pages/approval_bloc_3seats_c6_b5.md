...
Full report from the [`_tabulated` mirror](../multiwinner_tabulated/approval_bloc_3seats_c6_b5_tabulated.txt) (regenerated on every run; every analysis forced on):
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 04_Approval/multiwinner/approval_bloc_3seats_c6_b5.yaml
```

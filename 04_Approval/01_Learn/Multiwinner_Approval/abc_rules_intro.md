...
- The runnable files and a "shadow STAR" of this same election: [Lackner & Skowron — approval and its shadow STAR](../../02_Examples/multiwinner/lackner_skowron_shadow_star.md).

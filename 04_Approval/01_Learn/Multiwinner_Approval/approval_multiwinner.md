...
Sum the columns; the top 3 win — Adams, Brown, Clark (3 approvals each). Runnable: [`approval_bloc_3seats_c6_b5.yaml`](../../02_Examples/multiwinner/cases/approval_bloc_3seats_c6_b5.yaml).

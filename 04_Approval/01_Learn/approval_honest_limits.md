...
→ Overview: [**Approval Voting**](approval_voting.md) (how it works) · the same critiques as the academic literature states them, with the parts that don't survive scrutiny marked: [Approval in the theory literature](approval_in_the_literature.md) · the sharpest of them, worked in full: [is Approval's outcome arbitrary?](approval_indeterminacy.md) · Companion critical pages (parity across methods): [STAR's limits](../../01_STAR/01_Learn/properties_and_limits/STAR_honest_limits.md) · [Ranked Robin (RCV-RR) limits](../../05_Ranked_Robin/01_Learn/RCV_RR_honest_limits.md) · [RCV-IRV fails the Equal Vote](../../06_Other/RCV_IRV/concepts/RCV_IRV_equal_vote.md). Approval *does* pass the [Equal Vote](../../01_STAR/01_Learn/properties_and_limits/equally_weighted_vote.md). Curriculum: [301.5](../../07_Concepts/CURRICULUM.md).

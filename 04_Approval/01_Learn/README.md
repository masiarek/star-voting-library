...
- [The Majority Illusion — CES's plain-English piece, claim-checked (301)](../../07_Concepts/topics/majority_criterion/the_majority_illusion_claim_checked.md) — the same organisation writing for a general audience. Its taxonomy of "majority" is the best short one in advocacy writing; its centerpiece example turns out to contain an **absolute-majority winner** that Approval and Score reject and [STAR elects](../../method_comparisons/ces_majority_illusion/README.md). Also where this library's [false majorities](../../07_Concepts/topics/false_majorities.md) page came from

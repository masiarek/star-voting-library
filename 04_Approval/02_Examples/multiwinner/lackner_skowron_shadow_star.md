...
| Shadow **Bloc STAR** → A,B,C,D | [`../../02_STAR_Bloc/02_Examples/cases/lackner_skowron_shadow_bloc_star_c7_b12.yaml`](../../../02_STAR_Bloc/02_Examples/cases/lackner_skowron_shadow_bloc_star_c7_b12.yaml) |
| Shadow **Allocated Score** (STAR-PR) → A,B,C,D | [`../../03_STAR_PR/02_Examples/cases/lackner_skowron_shadow_star_pr_c7_b12.yaml`](../../../03_STAR_PR/02_Examples/cases/lackner_skowron_shadow_star_pr_c7_b12.yaml) |
| Shadow **RRV** → A,B,C,F (matches PAV) | [`../../03_STAR_PR/02_Examples/cases/lackner_skowron_shadow_star_pr_rrv_c7_b12.yaml`](../../../03_STAR_PR/02_Examples/cases/lackner_skowron_shadow_star_pr_rrv_c7_b12.yaml) |

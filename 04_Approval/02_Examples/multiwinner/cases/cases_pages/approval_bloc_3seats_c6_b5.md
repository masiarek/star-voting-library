...
(04_Approval/01_Learn/img/approval_ballot_multiwinner_3seats.png):
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 04_Approval/02_Examples/multiwinner/cases/approval_bloc_3seats_c6_b5.yaml
```

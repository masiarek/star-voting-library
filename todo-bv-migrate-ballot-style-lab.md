...
- ~~**Minor:** `07_Concepts/about_this_repo/05_website_build.md` hardcodes the "5 build warnings" count~~ DONE (2026-07-29, commit `49651cc`) — the count is gone; the nit now records that the build is warning-free and what a returning `REPLACE_*` warning would mean.

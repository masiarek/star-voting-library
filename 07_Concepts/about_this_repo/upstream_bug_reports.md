...
| [#1480](https://github.com/Equal-Vote/bettervoting/issues/1480) | 2026-08-04 | open | Winner highlighting is positional — the star and the gold row mark the first rows of `summaryData.candidates`, not `elected`, so a runoff-broken Copeland tie decorates a candidate that did not win (live: [`8h4bvh`](https://bettervoting.com/8h4bvh/results)) |

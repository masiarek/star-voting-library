...
**Totals:** 423 elections, 589 races. Full drill-down: [`races.csv`](races.csv) · [`elections.csv`](elections.csv). Related: [BV registry](BV_registry.md) · [multi-race index](multirace_elections.md) · [by method](README.md).
...
| mayor_c4_b100_streamlined_irv | The mayor's race (RCV-IRV, full rounds) — Cora comes | 1 | single-race | 100 | IRV | LH-only |
| mayor_c4_b100_streamlined_rr | The mayor's race (Ranked Robin) — Cora beats everyon | 1 | single-race | 100 | RankedRobin | LH-only |
| mayor_c4_b100_streamlined_star | The mayor's race (STAR) — one grid, and Cora wins th | 1 | single-race | 100 | STAR | LH-only |
...
|---|--:|---|
| single-race | 344 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c4_b2_bloc-star-2-seats, 01_condorcet_winner |
| contested (multi-race) | 245 | 2jrfpg, 2p33qq, 38b7fg, 3grpbb |
...
|---|--:|---|
| single-winner | 520 | 00_plurality_vs_majority, 01_condorcet_winner, 01_political_left_split, 01a_c2_b1_two-candidates |
...
|---|--:|---|
| score | 323 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c4_b2_bloc-star-2-seats, 01_political_left_split |
...
|---|--:|---|
| majoritarian | 454 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c4_b2_bloc-star-2-seats, 01_political_left_split |
...
|---|--:|---|
| STAR | 302 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c4_b2_bloc-star-2-seats, 01_political_left_split |
...
|---|--:|---|
| LH-only | 253 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c4_b2_bloc-star-2-seats, 01_condorcet_winner |
| BV | 251 | 24b623, 26khr3, 2gvwr9, 2hqmrd |

...
**Totals:** 421 elections, 593 races. Full drill-down: [`races.csv`](races.csv) · [`elections.csv`](elections.csv). Related: [BV registry](BV_registry.md) · [multi-race index](multirace_elections.md) · [by method](README.md).
...
| 38b7fg | BV2274 — The cost of districting — the best candidat | 3 | contested (multi-race) | 9 | STAR | BV |
...
| 3xgkck | BV2227 — Favorite Betrayal — honest ballots (STAR &  | 3 | contested (multi-race) | 34 | IRV, RankedRobin, STAR | BV |
| 4hfwqd | BV2271 — Satisfaction Approval Voting, Proposition 2 | 3 | contested (multi-race) | 10 | Approval, RankedRobin, STAR | BV |
| 4htk44 | BV2162 — Nurmi's truncation electorate (1 of 2) — ev | 3 | contested (multi-race) | 103 | IRV, RankedRobin, STAR | BV |
| 4w96tr | BV2253 — Where should the committee meet? — the sinc | 3 | contested (multi-race) | 7 | Plurality, RankedRobin, STAR | BV |
...
| 6mcgkq | BV2275 — One Electorate, Six Ballots — what is your  | 6 | contested (multi-race) | 36 | Approval, RankedRobin, STAR | BV |
...
| 82gg36 | BV2226 — Preference vs Support — the center SUPPORTE | 3 | contested (multi-race) | 36 | IRV, RankedRobin, STAR | BV |
| 89wwvr | BV2199 — Two Seats, One Neighborhood — Bloc STAR swe | 2 | contested (multi-race) | 10 | STAR, STAR_PR | BV |
| 8cdkkc | BV2278 — Five-Way Race — the moderate who beats both | 4 | contested (multi-race) | 1000 | IRV, Plurality, RankedRobin, STAR | BV |
...
| 9kffcv | BV2273 — Same ranks, different utilities — two elect | 3 | contested (multi-race) | 3 | RankedRobin, STAR | BV |
...
| c73pfw | BV2249 — Weak Condorcet loser — when both STAR final | 3 | contested (multi-race) | 5 | Approval, RankedRobin, STAR | BV |
...
| d3b9wc | BV2188 — Two Districts, One Mayor (I of III) — West  | 2 | contested (multi-race) | 9 | RankedRobin, STAR | BV |
| d4v2dh | BV2258 — Read the ballot, name the method: 35 voters | 2 | contested (multi-race) | 35 | Approval, STAR | BV |
| dr6fmg | BV2272 — Satisfaction Approval Voting, Proposition 5 | 3 | contested (multi-race) | 17 | Approval, RankedRobin, STAR | BV |
| dxg8pb | BV2150 — Felsenthal's No-Show paradox (1 of 2) — eve | 3 | contested (multi-race) | 11 | IRV, RankedRobin, STAR | BV |
| dyh93j | BV2223 — STAR vs strategy — 5-1-0 min-max, real mode | 2 | contested (multi-race) | 100 | IRV, STAR | BV |
...
| kdjjkq | BV2251 — Margins matter — one electorate, four diffe | 4 | contested (multi-race) | 12 | IRV, Plurality, RankedRobin, STAR | BV |
| khcwm4 | BV2250 — Condorcet's 1788 rebuttal to Borda — where  | 3 | contested (multi-race) | 11 | IRV, RankedRobin, STAR | BV |
...
| rfyk46 | BV2222 — STAR vs strategy — 5-1-0 min-max squeezes t | 2 | contested (multi-race) | 100 | IRV, STAR | BV |
| rhbfj7 | BV2189 — Two Districts, One Mayor (II of III) — East | 2 | contested (multi-race) | 9 | RankedRobin, STAR | BV |
| t4by6x | BV2254 — Reinforcement paradox: two towns pick Ada,  | 2 | contested (multi-race) | 9 | RankedRobin, STAR | BV |
| tqfdbg | BV2277 — The Mayor's Race — the third-place candidat | 4 | contested (multi-race) | 100 | IRV, Plurality, RankedRobin, STAR | BV |
...
| x4dkfd | BV2193 — Bullet Voting Backfires (1 of 2) — the hone | 3 | contested (multi-race) | 9 | IRV, RankedRobin, STAR | BV |
| xbqq8t | BV2164 — Coombs deletes the Condorcet winner first — | 3 | contested (multi-race) | 33 | Plurality, RankedRobin, STAR | BV |
| y2fbpc | BV2261 — A three-way Ranked Robin tie: the random ti | 2 | contested (multi-race) | 6 | RankedRobin | BV |
...
| 2gvwr9 | BV2262 — Nine candidates, a nine-way dead heat: does | 1 | single-race | 9 | RankedRobin | BV |
...
| 484mbm | BV2263 — Bloc STAR — a three-way tie no rung can bre | 1 | single-race | 3 | STAR | BV |
...
| 4jmgrd | BV2234 — The Graders' Divide — a harsh 0-2 camp meet | 1 | single-race | 31 | STAR | BV |
| 6hv7jf | BV1570 - deactivate selection - plurality voting - C | 1 | single-race | 3 | Plurality | BV |
| 6m3gxq | BV2268 — Two-seat board by Bloc STAR: a fourth candi | 1 | single-race | 7 | STAR | BV |
| 6tthfv | BV2252 — Goodberry's Frozen Custard, Cary NC — Best  | 1 | single-race | 0 | STAR | BV |
| 6xhfp8 | BV11 - Valid Ballot - Full and Equal Support (2 Cand | 1 | single-race | 3 | STAR | BV |
| 74pbyg | BV2237 — Noise Soup — weak factions, cross-winds, fl | 1 | single-race | 47 | STAR | BV |
...
| 8h3yrx | BV1835 — Committee election, 100 voters, 4 seats: th | 1 | single-race | 100 | STAR | BV |
| 8h4bvh | BV2270 — Ranked Robin: two candidates tie on pairwis | 1 | single-race | 9 | RankedRobin | BV |
...
| 9dx494 | BV2244 — The Herb Garden Council — Bloc STAR, 3 seat | 1 | single-race | 36 | STAR | BV |
...
| tilted_cycle_c3_b5_irv | Minimal tilted cycle — 5 voters, margins 3–1–1 (RCV- | 1 | single-race | 5 | RCV-IRV | LH-only |
...
| c8h3tb | BV2256 — Traditional voting style: one mark each | 1 | single-race | 3 | STAR | BV |
...
| fm8cbv | BV2235 — Cliff City food trucks — everyone scores 0  | 1 | single-race | 40 | STAR | BV |
...
| hckrf7 | Copy of BV210 - View / report - Distribution of Equa | 1 | single-race | 3 | STAR | BV |
| j3hqvb | BV2264 — Two-seat board by Bloc STAR: the council si | 1 | single-race | 6 | STAR | BV |
...
| k7pfqt | BV2266 — Two-seat board by Bloc STAR: the candidate  | 1 | single-race | 7 | STAR | BV |
...
| my9jd9 | BV2267 — Two-seat board by Bloc STAR: three candidat | 1 | single-race | 7 | STAR | BV |
...
| qhjyr2 | BV2276 — Tied for the second finalist — the runoff p | 1 | single-race | 5 | STAR | BV |
...
| t488h9 | BV2269 — Three candidates, three seats — a race nobo | 1 | single-race | 7 | STAR | BV |
| td7jfy | BV2238 — Does the squeeze survive noise? Two poles,  | 1 | single-race | 38 | STAR | BV |
| tf73v9 | Runoff_07 (WIP) — flat ballot exposes the BV abstent | 1 | single-race | 4 | STAR | BV |
| tfm64p | BV2259 — Read the ballot, name the method: four vote | 1 | single-race | 4 | STAR | BV |
| tg4779 | BV2182 — Why STAR Has an Automatic Runoff — a Runoff | 1 | single-race | 10 | STAR | BV |
| th3pbp | BV2265 — Two-seat board by Bloc STAR: one more hones | 1 | single-race | 7 | STAR | BV |
...
|---|--:|---|
| single-race | 340 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c4_b2_bloc-star-2-seats, 01_condorcet_winner |
| contested (multi-race) | 253 | 2jrfpg, 2p33qq, 38b7fg, 3grpbb |
...
|---|--:|---|
| single-winner | 524 | 00_plurality_vs_majority, 01_condorcet_winner, 01_political_left_split, 01a_c2_b1_two-candidates |
...
|---|--:|---|
| score | 325 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c4_b2_bloc-star-2-seats, 01_political_left_split |
| ranked | 187 | 01_condorcet_winner, 02_cycle_no_condorcet, 03_real_record0_c6_b5, 03a_stv_3seats |
| choose-one | 44 | 2p33qq, 3x4vrv, 4h89vj, 4w96tr |
| approval | 34 | 4hfwqd, 6mcgkq, BV_Library_approval_single_winner, Black_Curtain_01a_c3_b5_approval |
...
|---|--:|---|
| majoritarian | 458 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c4_b2_bloc-star-2-seats, 01_political_left_split |
| Condorcet | 104 | 01_condorcet_winner, 02_cycle_no_condorcet, 03_real_record0_c6_b5, 04_smith_set_c4_b7 |
...
|---|--:|---|
| bloc / at-large | 47 | 00_c3_b3_bloc-baseline-2-seats, 01_c4_b2_bloc-star-2-seats, 3494cb, 3x4vrv |
...
|---|--:|---|
| STAR | 304 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c4_b2_bloc-star-2-seats, 01_political_left_split |
| RankedRobin | 104 | 01_condorcet_winner, 02_cycle_no_condorcet, 03_real_record0_c6_b5, 04_smith_set_c4_b7 |
| IRV | 70 | 2jrfpg, 3xgkck, 4htk44, 6bry7c |
| Plurality | 44 | 2p33qq, 3x4vrv, 4h89vj, 4w96tr |
| Approval | 34 | 4hfwqd, 6mcgkq, BV_Library_approval_single_winner, Black_Curtain_01a_c3_b5_approval |
...
| RCV-IRV | 1 | tilted_cycle_c3_b5_irv |
...
|---|--:|---|
| BV | 260 | 24b623, 26khr3, 2gvwr9, 2hqmrd |
| LH-only | 248 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c4_b2_bloc-star-2-seats, 01_condorcet_winner |

...
**Companion:** read this beside **[STAR — start here](../../01_STAR/01_Learn/STAR_start_here.md)** — that page tells the story; this page is the map with the runnable files. · Up: [Curriculum hub](../CURRICULUM.md) · Next level: [Voting 201](CURRICULUM_201.md).
...
**See it:** the team-lunch story in [STAR — start here](../../01_STAR/01_Learn/STAR_start_here.md) — five friends, and "pick one" buries the option everyone was happy with. Background: [Choose-One / plurality](../topics/plurality.md).
...
**See it (the running example):** [The team lunch vote](../../01_STAR/02_Examples/cases/cases_pages/bv2184_fyy886_lunch_vote.md) — the two rounds turn once, with real BetterVoting results. The one-ballot-through-both-rounds diagram lives in [start here](../../01_STAR/01_Learn/STAR_start_here.md).
...
**See it:** [three candidates, one ballot](../../01_STAR/02_Examples/cases/cases_pages/02a_c3_b1_three-candidates.md) · [two ballots](../../01_STAR/02_Examples/cases/cases_pages/02b_c3_b2_three-candidates.md). The classic at scale: [Tennessee capital](../../01_STAR/02_Examples/cases/cases_pages/09_c4_b100_tennessee-capital.md).
...
**See it:** [the eight-style gallery](../../01_STAR/02_Examples/cases/cases_pages/03c_c6_b8_style-gallery.md) (bullet vote, backup, "anyone but…", protest — all valid) · a [bullet vote](../../01_STAR/02_Examples/cases/cases_pages/03a_c3_b3_style-bullet-vote.md) · [low-score ballots](../../01_STAR/02_Examples/cases/cases_pages/03b_c3_b3_1_style-protest-vote.md). Concept page: [the STAR ballot & voting styles](../../01_STAR/01_Learn/STAR_ballot_voting_styles.md).

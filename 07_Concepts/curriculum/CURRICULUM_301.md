...
- **Read as a pair with 301.16:** *majority rule is uniquely right for two alternatives (May), and cannot be coherently extended to three ([Condorcet's paradox](../topics/condorcet/README.md), then [Arrow](../topics/arrow_theorem_and_star.md)).* Every method in this library is a proposal for what to do about that gap.

...
- **Approval's strategy is the most *actionable*.** Its one genuine dilemma — the **approval threshold**: do you approve only your favorite (bullet voting) or also the tolerable front-runner (tactical maximization)? — is easy to reason about, which cuts both ways: simple to use, but also simple to game. Approval never asks you to betray your favorite, which is its real strength. See [Approval's honest limits](../../04_Approval/01_Learn/approval_honest_limits.md).
- **Ranked Robin's exposure is burial.** Because it's purely ordinal (order, not strength), a faction can in principle *bury* a strong rival below weaker candidates. In practice sincere ranking is usually optimal and Condorcet methods are considered strongly strategy-resistant — but burial is the named risk. See [Ranked Robin's honest limits](../../05_Ranked_Robin/01_Learn/RCV_RR_honest_limits.md), and — because burial is a *cross-method* strategy, not Ranked Robin's alone — the [Burial topic hub](burial/README.md), which runs it against Copeland, Borda, STAR and IRV side by side.
- **STAR's exposure is the bottom two, softened by the runoff.** Because scores are summed in round one but treated only as *order* in the runoff, exaggeration has limited upside and real downside (below). STAR does **fail Later-No-Harm** — honestly scoring a second choice *can*, in constructions, help them beat your favorite — which is a genuine, admitted property. See [STAR's honest limits](../../01_STAR/01_Learn/properties_and_limits/STAR_honest_limits.md).
...
**See also:** [The strategic pathologies — five Molochs, and where STAR stands](strategic_pathologies.md) · [Choosing among the Equal Vote methods](choosing_among_evc_methods.md) · [Favorite Betrayal — Voting 301](../../01_STAR/01_Learn/properties_and_limits/favorite_betrayal_voting_301.md) · [Residual vote-splitting](../../01_STAR/01_Learn/properties_and_limits/residual_vote_splitting.md) · [Scores vs. ranks (cardinal vs ordinal)](../scores_and_ranks/scores_vs_ranks.md) · [STAR FAQ](../../01_STAR/01_Learn/getting_started/STAR_FAQ.md) · [Glossary](../GLOSSARY.md)

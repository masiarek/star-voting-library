...
**Yes/No** — approve each candidate, or don't. One bit per candidate. *(Deep dive: [Approval voting](../../04_Approval/01_Learn/approval_voting.md) — including its **two ballot designs**: a single bubble per candidate, or an explicit Yes/No pair, which distinguishes a deliberate "No" from a blank.)*
...
|---|:--:|---|
| Ranking | ordinal | [RCV-IRV](../../06_Other/RCV_IRV/concepts/RCV-IRV-Hare.md), STV, Condorcet ([Ranked Robin](../../05_Ranked_Robin/01_Learn/ranked_robin.md)), Borda, Bucklin |
| Yes/No | cardinal (1-bit) | [Approval](../../04_Approval/01_Learn/approval_voting.md) |
| Scoring | cardinal (graded, e.g. 0–5) | [Score / Range](../../06_Other/Range/concepts/range_voting.md), [STAR](../../01_STAR/01_Learn/STAR_start_here.md) (a [hybrid](../../01_STAR/01_Learn/the_count/STAR_hybrid_nature.md) — score ballot **+ runoff**) |

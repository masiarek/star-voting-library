...
What the engines in this library actually did with that menu — the four floors they landed on, drawn as one picture, and the one of them that is not on Zwicker's list at all: [the four floors](../../tabulation_engines/tiebreak_ladders.md#the-four-floors-what-each-one-spends).

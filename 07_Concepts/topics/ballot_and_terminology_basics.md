...
**1. [RCV vs. IRV vs. RCV-IRV — a note on terminology](../../06_Other/RCV_IRV/concepts/RCV-IRV-confusing-name.md)** "Ranked Choice Voting" is an umbrella term, not one method. In the US it almost always means **RCV-IRV (Hare)**. Start here so the words mean the same thing for everyone.
...
|---|---|---|---|
| Terminology | "RCV = one method" | RCV is a family; US "RCV" = RCV-IRV (Hare) | [the naming problem](../../06_Other/RCV_IRV/concepts/RCV-IRV-confusing-name.md) |

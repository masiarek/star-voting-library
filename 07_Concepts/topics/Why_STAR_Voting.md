...
*Prefer it spoken or on slides? The narrated companion is [What's so good about STAR](../../01_STAR/01_Learn/reference/whats_so_good_about_STAR_Voting.md); the quick, positive hook is [The benefits of STAR Voting](../../01_STAR/01_Learn/getting_started/STAR_benefits.md).*
...
- [Favorite betrayal, untangled (301)](../../01_STAR/01_Learn/properties_and_limits/favorite_betrayal_voting_301.md) — the full FBC vs. later-no-harm treatment behind points 4 and 12.
- [STAR benefits](../../01_STAR/01_Learn/getting_started/STAR_benefits.md) · [What's so good about STAR](../../01_STAR/01_Learn/reference/whats_so_good_about_STAR_Voting.md) — the scannable and narrated companions.

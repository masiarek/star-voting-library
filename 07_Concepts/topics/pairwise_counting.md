...
You don't need the whole electorate to start a preference matrix — **a single ballot is one**. Take the first voter of the canonical [Ann, Bob, Cal election](../../01_STAR/02_Examples/cases/cases_pages/bv2187_qrw6wb_ann-bob-cal.md) (3 voters × 3 candidates, [registered canonical #1](../tips/TIPS_canonical_elections.md) — [live on BetterVoting](https://bettervoting.com/qrw6wb/results)). She scored **Ann 5, Bob 4, Cal 0**. Written as her own tiny matrix (For – Equal Support – Against, row vs column):

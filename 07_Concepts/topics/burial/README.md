...
| **RCV-IRV (Hare)** | ⚠️ harder, **not immune** | later-no-harm stops burial promoting *your own favourite* — your 3rd choice is never read while your 1st is alive, so if your favourite survives the burial changed nothing, and if they don't they couldn't have won. It does **not** stop a coalition with *different* favourites burying the Condorcet winner: each buried ballot bites when that voter's own favourite is eliminated, and the CW starves on transfers. Measured at 13–37% of structured-model elections | [Which RCV-IRV?](../../../06_Other/RCV_IRV/concepts/variants/RCV_IRV_variants.md) · [measured](../compliance_vs_strategic_preservation.md) |
...
How much of this survives measurement — and why a single "does the sincere winner still win" rate makes very different methods look alike: [formal compliance vs. strategic preservation](../compliance_vs_strategic_preservation.md).

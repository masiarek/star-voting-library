...
**People, orgs & learning paths:** [how to learn about voting methods](how_to_learn_about_voting_methods.md) · [the mathematics of social choice — what to study, in what order](math_for_social_choice.md) · [books on voting methods](../books/README.md) · [choosing among the EVC methods](choosing_among_evc_methods.md) · [advocacy organizations](advocacy_organizations.md) · [who's who in voting reform](whos_who_voting_reform.md) · [in memoriam: Jameson Quinn](in_memoriam_jameson_quinn.md)

...
| **[Handbook of Computational Social Choice](https://procaccia.info/wp-content/uploads/2020/03/comsoc.pdf)** (the complete book, free, hosted by co-editor Ariel Procaccia — CUP 2016, ISBN 9781107060432), ch. 3 "Tournament Solutions" — Brandt, Brill & Harrenstein | The modern restatement of the C1 tier, rigorous and self-contained. Where "tournament solution" is properly defined. **Read it here first:** [tournament solutions](../tournament_solutions.md) is the repo's map of the chapter, with two of its figures [turned back into runnable ballots](../../../method_comparisons/tournament_solutions/README.md). | **Neutral / academic.** Dense. |
...
| **[electowiki](https://electowiki.org/wiki/Condorcet_method)** | The only place many *branded* variants (Ranked Robin, Consensus Choice) are defined at all. Cite for definitions. | **Reform-advocacy-adjacent.** Weak for verdicts — never cite it for a criterion claim. |
...
Every book below is on the repo's [annotated shelf](../../books/README.md) or belongs beside it; leans are stated in the house style.

- **Duncan Black, *The Theory of Committees and Elections* (1958)** — the book that brought Condorcet back into modern analysis, and where the **median voter theorem** is proved: single-peaked preferences along one dimension guarantee a Condorcet winner at the median. Start here if you want to know *why* the pairwise criterion looks so natural to this camp — and notice that the guarantee needs one dimension, which is where the argument gets interesting. **The lean:** Condorcet-sympathetic, foundational. → [shelf entry](../../books/social_choice_theory.md).
...
- **Felix Brandt, Chris Dong & Dominik Peters, ["Condorcet-Consistent Choice Among Three Candidates"](https://arxiv.org/abs/2411.19857)** (arXiv:2411.19857, 2024) — the rigorous case that for *exactly three candidates*, **maximin and its refinements (leximin, Nanson)** are uniquely the best-defended Condorcet extensions against the no-show and reinforcement paradoxes, with clean axiomatic characterizations. **The lean:** neutral academic social-choice theory (no campaign affiliation), pro-*maximin* by result rather than by advocacy. The repo's [runnable-and-caveated summary](three_candidate_maximin.md) marks the fine print (3-candidate-only; it's the tie-broken refinements that are characterized; STAR is out of scope as a non-Condorcet rule).

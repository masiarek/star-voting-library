...
- **The theorem's axis is one axis.** It says nothing about [center squeeze](../center_squeeze/README.md), [distortion](../distortion.md), expressiveness, or [strategic incentive](../pvsi_strategic_incentive.md) in the full-domain world elections actually inhabit. STAR's case has never rested on Condorcet efficiency, and this theorem doesn't move it.

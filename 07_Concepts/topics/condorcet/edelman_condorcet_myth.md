...
- **This critique reaches STAR too.** STAR's runoff step makes it fail the Participation criterion in rare constructed cases — the same family of pathology, documented openly in [RCV-IRV vs STAR](../rcv_irv_vs_star.md) and [STAR's honest limits](../../../01_STAR/concepts/properties_and_limits/STAR_honest_limits.md). No method escapes Gibbard–Satterthwaite; the choice is which failures, how often, and how visibly.
...
Related: [Condorcet topic hub](README.md) · [FairVote claim check](fairvote_condorcet_claim_check.md) · [What makes a "good" winner?](../what_makes_a_good_winner.md) · [STAR's honest limits](../../../01_STAR/concepts/properties_and_limits/STAR_honest_limits.md) · [cycle resolution](../../../05_Ranked_Robin/concepts/cycle_resolution.md) · [the math behind Condorcet](../../../05_Ranked_Robin/concepts/the_math_behind_condorcet.md)

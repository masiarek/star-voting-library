...
- **Pairs with:** the [spoiler effect](spoiler_effect.md) and the [`split_voting/`](../../method_comparisons/split_voting/) demos — this page argues *that* the system is broken; those show *how*. Then [What's so good about STAR](../../01_STAR/concepts/reference/whats_so_good_about_STAR_Voting.md) delivers the fix.
...
- [What's so good about STAR](../../01_STAR/concepts/reference/whats_so_good_about_STAR_Voting.md) — Segment 1 (the spoiler).

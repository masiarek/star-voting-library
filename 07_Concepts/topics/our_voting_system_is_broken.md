...
*Prefer it spoken? The narrated pitch is [What's so good about STAR](../../01_STAR/01_Learn/reference/whats_so_good_about_STAR_Voting.md); the slide version is the [Why STAR Voting deck](Why_STAR_Voting.md).*
...
- [What's so good about STAR](../../01_STAR/01_Learn/reference/whats_so_good_about_STAR_Voting.md) — Segment 1 (the spoiler).

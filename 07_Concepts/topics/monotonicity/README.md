...
|--------|:---:|-----|-----------|
| **STAR** | ✅ | scores are added, not eliminated — raising a candidate only helps them | [STAR monotonicity](../../../01_STAR/concepts/properties_and_limits/STAR_monotonicity.md) |
| **Ranked Robin / Condorcet** | ✅ | pairwise wins only improve when you rank someone higher | [Ranked Robin](../../../05_Ranked_Robin/concepts/ranked_robin.md) |

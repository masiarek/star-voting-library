...
| **RCV-IRV / plurality-runoff / Coombs** | ❌ readily | the elimination machinery — same root as [non-monotonicity](../monotonicity/README.md) | [no-show paradox](../../voting_paradoxes/no_show.md) |
...
*This is a **topic hub** (cross-method index). The authoritative write-ups live in the per-method folders and the paradox catalog linked above. See [the topics index](../README.md) for the other topic hubs.*

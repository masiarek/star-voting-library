...
> **The founding idea:** [Why YAML? One file a person reads and a computer runs](../about_this_repo/01_why_yaml_test_cases.md) — how each case is human-readable and machine-runnable at once, so it can be taught, run, and audited from the same source.

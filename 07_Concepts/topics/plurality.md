...
→ The problems it creates: [the spoiler effect](spoiler_effect.md) · [vote splitting & the equally-weighted vote](../../01_STAR/01_Learn/properties_and_limits/equally_weighted_vote.md) · is IRV just plurality in sequence? [RCV-IRV and plurality](../../06_Other/RCV_IRV/concepts/RCV_IRV_and_plurality.md)
...
- **Minority winners.** With three or more candidates, the winner routinely has **less than half** the vote — a [*plurality/minority winner*](../../method_comparisons/minority_winner/README.md) a majority actively voted against. "Routinely" is measurable: **11.9% of all 5,662 US national primaries in 2022** had multiple candidates and a sub-majority winner ([how to read that number honestly](../../method_comparisons/split_voting/how_often_does_vote_splitting_happen.md)).
- **Lesser-evil voting & favorite betrayal.** Because backing your true favorite can ["waste" your vote](wasted_votes.md) or help your worst choice, voters are pressured to abandon their favorite for a viable front-runner — the [favorite-betrayal](../../01_STAR/01_Learn/properties_and_limits/favorite_betrayal_voting_301.md) incentive.
...
- **Two-party entrenchment.** These pressures push the field toward two viable candidates over time (**[Duverger's law](two_party_dominance.md)**).
...
|---|---|
| [Approval](../../04_Approval/01_Learn/approval_voting.md) | Mark **as many** candidates as you like — similar candidates stop splitting. |
| [RCV-IRV](../../06_Other/RCV_IRV/concepts/RCV-IRV-Hare.md) | **Rank** candidates; eliminate-and-transfer instead of one round. (In fact **plurality is just IRV with a ranking limit of 1** — see [RCV-IRV and plurality](../../06_Other/RCV_IRV/concepts/RCV_IRV_and_plurality.md).) |
| [Ranked Robin](../../05_Ranked_Robin/01_Learn/ranked_robin.md) | Rank, then compare **every pair head-to-head** — elects the majority-preferred candidate. |
| [Score / Range](../../06_Other/Range/concepts/range_voting.md) · [STAR](../../01_STAR/01_Learn/STAR_start_here.md) | **Rate** each candidate 0–5 — captures order *and* strength; STAR adds a runoff. |

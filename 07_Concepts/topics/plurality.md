...
→ The problems it creates: [the spoiler effect](spoiler_effect.md) · [vote splitting & the equally-weighted vote](../../01_STAR/concepts/properties_and_limits/equally_weighted_vote.md) · is IRV just plurality in sequence? [RCV-IRV and plurality](../../06_Other/RCV_IRV/concepts/RCV_IRV_and_plurality.md)
...
- **Lesser-evil voting & favorite betrayal.** Because backing your true favorite can ["waste" your vote](wasted_votes.md) or help your worst choice, voters are pressured to abandon their favorite for a viable front-runner — the [favorite-betrayal](../../01_STAR/concepts/properties_and_limits/favorite_betrayal_voting_301.md) incentive.
...
|---|---|
| [Approval](../../04_Approval/concepts/approval_voting.md) | Mark **as many** candidates as you like — similar candidates stop splitting. |
...
| [Ranked Robin](../../05_Ranked_Robin/concepts/ranked_robin.md) | Rank, then compare **every pair head-to-head** — elects the majority-preferred candidate. |
| [Score / Range](../../06_Other/Range/concepts/range_voting.md) · [STAR](../../01_STAR/concepts/STAR_start_here.md) | **Rate** each candidate 0–5 — captures order *and* strength; STAR adds a runoff. |

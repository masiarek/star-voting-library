...
- **Underrepresentation.** Third parties and independents can win substantial vote shares yet almost no seats — a persistent votes-to-seats gap (e.g. Australia's Greens under the [Alternative Vote](../../06_Other/RCV_IRV/concepts/case_studies/RCV_IRV_australia.md)).
...
- [Proportional representation: STV vs STAR-PR](../../method_comparisons/stv_vs_star_pr/README.md) · [Proportional STAR](../../03_STAR_PR/01_Learn/STAR_PR/README.md) — what actually yields multiparty legislatures

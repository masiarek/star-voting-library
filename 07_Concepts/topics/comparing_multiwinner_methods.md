...
- **The approval half in full:** [Multiwinner Approval](../../04_Approval/01_Learn/Multiwinner_Approval/README.md) — where PAV, seqPAV and seq-Phragmén are explained (this library spells it both "multiwinner" and "multi-winner"; they are the same thing)

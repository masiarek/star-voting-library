...
Concept backbone: [Abstention vs. a zero vs. "None of the Above"](../../../01_STAR/concepts/properties_and_limits/abstention_vs_zero_vs_nota.md).
...
- **Concept lesson:** [abstention_vs_zero_vs_nota.md](../../../01_STAR/concepts/properties_and_limits/abstention_vs_zero_vs_nota.md) — the 0 / null / NOTA distinction, and the LH marker vocabulary (`- ~ & ? %`) BV lacks.
- **Reproduced cases:**

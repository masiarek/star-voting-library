...
1. **A mandate vs. a resignation.** A candidate can win by *preference* while having almost no *support* — the "least-bad" pick of a field nobody liked. Ranks can't tell "won a race everyone wanted" from "won a race everyone wanted to leave." Scores can: the [scoring round](../../01_STAR/01_Learn/the_count/STAR_Scoring_Round.md) shows a winner averaging 4.5/5 versus 1.2/5 — same order, very different mandates.
...
- [The equally weighted vote](../../01_STAR/01_Learn/properties_and_limits/equally_weighted_vote.md) — equal *scores* say "preference: none — support: whatever level you gave both" (5/5 full, 0/0 none: the glossary's Equal Support / Equal Opposition pair)

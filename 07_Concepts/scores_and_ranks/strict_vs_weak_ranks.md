...
- *"Ranked = good, so all ranked methods behave alike."* — They don't. A weak-ranked Condorcet method reliably finds the candidate closest to the center of opinion; strict-rank IRV can eliminate that very candidate ([center squeeze](../../06_Other/RCV_IRV/concepts/RCV_IRV_center_squeeze.md)).
...
- [Ranked Robin](../../05_Ranked_Robin/01_Learn/ranked_robin.md) — the Condorcet method that *does* allow equal ranks and compares pairwise

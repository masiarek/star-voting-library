...
| Ranked Robin | No | Elects the Condorcet winner by construction whenever one exists — [ranked_robin.md](../../05_Ranked_Robin/concepts/ranked_robin.md) |

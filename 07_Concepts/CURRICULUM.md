...
## 🟢 [Voting 101 — the basics](curriculum/CURRICULUM_101.md)
...
→ **[Start Voting 101](curriculum/CURRICULUM_101.md)**

<a id="voting-201"></a>

## 🟡 [Voting 201 — reading results & comparisons](curriculum/CURRICULUM_201.md)
...
→ **[Start Voting 201](curriculum/CURRICULUM_201.md)**
...
See [TIPS_choosing_voter_counts.md](tips/TIPS_choosing_voter_counts.md) (voter counts) and [ORGANIZATION.md](about_this_repo/03_ORGANIZATION.md) (where scenario text lives, clean-demo flags). Term definitions: [GLOSSARY.md](GLOSSARY.md).

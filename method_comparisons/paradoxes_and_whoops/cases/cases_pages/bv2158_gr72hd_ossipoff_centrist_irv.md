...
Full report from the [`_tabulated` mirror](../cases_tabulated/bv2158_gr72hd_ossipoff_centrist_irv_tabulated.txt) (regenerated on every run; every analysis forced on):

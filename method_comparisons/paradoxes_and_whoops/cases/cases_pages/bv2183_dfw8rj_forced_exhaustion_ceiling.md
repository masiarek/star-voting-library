...
**Method:** [RCV-IRV (Instant Runoff)](../../../../06_Other/RCV_IRV/concepts/README.md) · **1 seat** · **Expected winner:** Ada
...
<img src="../img/bv2183_dfw8rj_forced_exhaustion_ceiling_sankey.png" width="860" alt="Round-by-round Sankey diagram: each candidate's votes as a band, and where the votes of an eliminated candidate transferred to.">
...
ROUND 1 — 50 of 50 ballots still active; majority = 26
   Eli eliminated with 6:
      → Dev                       6

ROUND 2 — 50 of 50 ballots still active; majority = 26
   Cleo eliminated with 8:
      → (no continuing ranking)      8  ← these ballots go inactive

ROUND 3 — 42 of 50 ballots still active (8 inactive); majority = 22
   Dev eliminated with 13:
      → (no continuing ranking)     13  ← these ballots go inactive

FINAL ROUND — 29 of 50 ballots still active (21 inactive); majority = 15
   Ada                      15  (51.7% of the still-active)  ← elected
   Ben                      14  (48.3% of the still-active)
   Never exhausted, never transferred:
      14 ballots held by Ben carried a lower ranking that was never read
      (the count stopped here, so those preferences did nothing).

Inactive ballots at the final round: 21 of 50 (42.0%).
   Ada's 15 is a majority of the 29 still active but only 30.0% of all 50 cast —

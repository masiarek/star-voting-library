...
[Divergence from STAR]
  ...
  RCV-RR round-robin: cases_tabulated/bv2156_3grpbb_star_misses_condorcet_RCV-RR_tabulated.txt
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/bv2156_3grpbb_star_misses_condorcet_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/paradoxes_and_whoops/cases/bv2156_3grpbb_star_misses_condorcet.yaml
```

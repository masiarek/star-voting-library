...
→ the three "winners" STAR can name: [`STAR_three_winner_notions`](../../01_STAR/01_Learn/properties_and_limits/STAR_three_winner_notions.md) · STAR's limits: [AR hub](../../01_STAR/01_Learn/the_count/STAR_Automatic_Runoff.md#what-the-runoff-buys-you-and-its-limits) · the ranked cousin: [center squeeze](../../06_Other/RCV_IRV/concepts/RCV_IRV_center_squeeze.md) · fairness test: [Reading these fairly — the test for an honest "whoops"](reading_these_fairly.md). ↔ BV QA tracker: **BV149** (STAR fails to elect the Condorcet winner).

...
**Method:** [STAR (single winner)](../../01_STAR/01_Learn/README.md) · **1 seat** · **Expected winner:** Rock · [full count →](cases/cases_pages/bv2157_mmcmpy_condorcet_cycle_rps.md)
<!-- case-meta:end -->
...
→ fairness test: [Reading these fairly — the test for an honest "whoops"](reading_these_fairly.md) · [`GLOSSARY` (Condorcet cycle)](../../07_Concepts/GLOSSARY.md) · the set: [`README`](README.md) · how Condorcet methods break cycles: [Cycle resolution](../../05_Ranked_Robin/01_Learn/cycle_resolution.md). ↔ BV QA tracker: **BV147 / BV188** (Condorcet cycle / paradox — BV: [w7y3wv](https://bettervoting.com/w7y3wv/results), [6mbvhg](https://bettervoting.com/6mbvhg/results)).

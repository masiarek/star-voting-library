...
→ fairness test: [Reading these fairly — the test for an honest "whoops"](reading_these_fairly.md) · [`GLOSSARY` (Condorcet cycle)](../../07_Concepts/GLOSSARY.md) · the set: [`README`](README.md) · how Condorcet methods break cycles: [Cycle resolution](../../05_Ranked_Robin/concepts/cycle_resolution.md). ↔ BV QA tracker: **BV147 / BV188** (Condorcet cycle / paradox — BV: [w7y3wv](https://bettervoting.com/w7y3wv/results), [6mbvhg](https://bettervoting.com/6mbvhg/results)).

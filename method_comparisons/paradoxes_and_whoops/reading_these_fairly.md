...
→ Standing house policy on terminology and not-being-a-purist: [Tips — Terminology: RCV vs IRV vs RCV-IRV (and friends)](../../07_Concepts/tips/TIPS_terminology.md). The even-handedness duty is also why STAR's own limits are documented as peers, not footnotes: [STAR's limits](../../01_STAR/concepts/the_count/STAR_Automatic_Runoff.md#what-the-runoff-buys-you-and-its-limits) · [three winner notions](../../01_STAR/concepts/properties_and_limits/STAR_three_winner_notions.md).

...
→ Related: [Favorite Betrayal (LNH vs FBC)](../../01_STAR/01_Learn/properties_and_limits/favorite_betrayal_voting_301.md) · [the 5-1-0 challenge](../star_5_1_0_challenge/README.md) · [STAR's honest limits](../../01_STAR/01_Learn/properties_and_limits/STAR_honest_limits.md) · [are equal-score votes discounted?](../../01_STAR/01_Learn/reference/are_equal_score_votes_discounted.md).
...
- **"STAR has no track record."** True in 2018; dated now. STAR has run binding public elections since the 2020 Independent Party of Oregon primary ([history](../../01_STAR/01_Learn/STAR_history.md)).

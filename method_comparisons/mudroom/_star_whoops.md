...
- **STAR's limits are real, and STAR concedes them out loud** — that candor is a strength, not a weakness. The whole [honest-limits page](../../01_STAR/01_Learn/properties_and_limits/STAR_honest_limits.md) exists so nobody has to compile this reel in secret.
...
There. We threw mud at ourselves as hard as at anyone else — which is the only way the fair pages earn the right to be believed. For the version you'd actually cite, use [STAR's honest limits](../../01_STAR/01_Learn/properties_and_limits/STAR_honest_limits.md).

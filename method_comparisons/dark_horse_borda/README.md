...
A is the honest winner every sensible way you count: the utilitarian favorite *and* the [Condorcet winner](../../07_Concepts/topics/condorcet/README.md) (A beats B, C, and D head-to-head).
...
- **STAR isn't strategy-proof** in general ([Gibbard](../../07_Concepts/topics/gibbard_satterthwaite_theorem.md) forbids that) — see its own [chicken/Burr seam](../chicken_dilemma/README.md) and [honest limits](../../01_STAR/01_Learn/properties_and_limits/STAR_honest_limits.md). The claim here is narrow and true: STAR has **no Dark Horse**.

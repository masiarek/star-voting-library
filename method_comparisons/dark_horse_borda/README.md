...
*A strategic pathology of the [Borda count](../../07_Concepts/GLOSSARY.md) (and any strictly-ranked point method): a candidate every voter honestly ranks **last** can **win**, because each faction is tempted to bury its rivals behind the harmless nobody — and if they all do, the nobody backs into victory. It's a **prisoner's dilemma** in ballot form. **Neither STAR nor Ranked Robin rewards this trap** — a score (or a pairwise comparison) lets you oppose a rival without being forced to prop anyone up. (Condorcet methods like RR have a *separate*, sincere dark-horse seam that STAR's support-reading also avoids — see [Keep it fair](#keep-it-fair).)*

→ Part of the strategic-pathology set: [The strategic pathologies — five Molochs, and where STAR stands](../../07_Concepts/topics/strategic_pathologies.md). Framing from Jameson Quinn (Center for Election Science). Related: [strategic voting](../../07_Concepts/topics/strategic_voting.md) · [what makes a good winner?](../../07_Concepts/topics/what_makes_a_good_winner.md).
...
A is the honest winner every sensible way you count: the utilitarian favorite *and* the [Condorcet winner](../../07_Concepts/topics/condorcet/) (A beats B, C, and D head-to-head).
...
- **This is a Borda problem, not a "ranked ballot" problem** in general — [Ranked Robin](../../05_Ranked_Robin/01_Learn/README.md) uses the same ranked ballots and is immune to *this* dark horse, because it reads pairwise wins, not positional points. It's *positional point* methods (Borda and its kin) that are dark-horse-prone in the strategic sense above.
- **But Condorcet has its *own*, milder dark horse — and this is where STAR pulls ahead of Ranked Robin.** As Quinn notes, a Condorcet method can crown *"somebody 90% of everybody's never heard of"* — a bland unknown each side ranks second only because they rank them above the *other* side. That's not the strategic Borda trap; it's a **sincere** one, and it's a genuine [Ranked Robin limit](../../05_Ranked_Robin/01_Learn/RCV_RR_honest_limits.md): a ranked ballot sees *order, not strength*, so a thinly-supported compromise everyone tolerates can beat a candidate a majority loves. STAR reads that strength — the unknown scored a 1 by everyone never survives the scoring round — so **STAR resists both the strategic Borda dark horse and the sincere Condorcet one**, exactly the [preference-vs-support](../../07_Concepts/scores_and_ranks/preference_vs_support.md) distinction.
...
- **STAR isn't strategy-proof** in general ([Gibbard](../../07_Concepts/topics/gibbard_satterthwaite_theorem.md) forbids that) — see its own [chicken/Burr seam](../chicken_dilemma/) and [honest limits](../../01_STAR/01_Learn/properties_and_limits/STAR_honest_limits.md). The claim here is narrow and true: STAR has **no Dark Horse**.

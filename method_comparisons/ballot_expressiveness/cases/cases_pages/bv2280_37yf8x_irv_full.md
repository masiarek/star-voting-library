...
FINAL ROUND — 25 of 25 ballots still active; majority = 13
   Ben                      13  (52.0% of the still-active)  ← elected
   Hugo                     12  (48.0% of the still-active)
   Never exhausted, never transferred:
      12 ballots held by Hugo carried a lower ranking that was never read
      (the count stopped here, so those preferences did nothing).

Inactive ballots at the final round: 0 of 25 (0.0%).
   Ben's 13 is a majority of the 25 still active AND of all 25 cast (52.0%).
```
<!-- --8<-- [end:report] -->

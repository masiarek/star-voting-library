...
*Generated from [`districting_north.yaml`](../districting_north.yaml) — do not edit by hand. Regenerate: `python STARVote_LH_tabulation_engine/tools_adam/scripts/build_yaml_pages.py`.*
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/districting_north_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/districting_cost/cases/districting_north.yaml
```
...
More cases in this set: [districting_combined](districting_combined.md) · [districting_south](districting_south.md)

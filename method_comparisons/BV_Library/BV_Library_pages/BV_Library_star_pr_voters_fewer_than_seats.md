...
Full report from the [`_tabulated` mirror](../BV_Library_tabulated/BV_Library_star_pr_voters_fewer_than_seats_tabulated.txt) (regenerated on every run; every analysis forced on):

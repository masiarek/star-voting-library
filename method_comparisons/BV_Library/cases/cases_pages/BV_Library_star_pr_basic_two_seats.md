...
[Condorcet Loser]
  No strict Condorcet loser; jointly weak Condorcet losers: Bill, Carmen, Doug (winless — pairwise ties)
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/BV_Library/cases/BV_Library_star_pr_basic_two_seats.yaml
```

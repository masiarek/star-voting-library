...
Legend: For - Equal Support - Against
        * indicates Top 2 Finalist
        Note: Bill and Carmen tied at 32 in the Scoring Round, and the
              head-to-head rung advanced Bill. The * marks who advanced, not
              who scored highest.
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/BV_Library/cases/BV_Library_star_runnerup_tie.yaml
```

...
*Generated from [`BV_Library_star_condorcet_winner.yaml`](../BV_Library_star_condorcet_winner.yaml) — do not edit by hand. Regenerate: `python STARVote_LH_tabulation_engine/tools_adam/scripts/build_yaml_pages.py`.*

**Method:** [STAR (single winner)](../../../../01_STAR/01_Learn/README.md) · **1 seat** · **Expected winner:** Allison
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/BV_Library_star_condorcet_winner_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/BV_Library/cases/BV_Library_star_condorcet_winner.yaml
```

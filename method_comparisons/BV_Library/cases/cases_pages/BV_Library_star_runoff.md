...
*Generated from [`BV_Library_star_runoff.yaml`](../BV_Library_star_runoff.yaml) — do not edit by hand. Regenerate: `python STARVote_LH_tabulation_engine/tools_adam/scripts/build_yaml_pages.py`.*

**Method:** [STAR (single winner)](../../../../01_STAR/01_Learn/README.md) · **1 seat** · **Expected winner:** Bill
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/BV_Library_star_runoff_tabulated.txt) (regenerated on every run; every analysis forced on).

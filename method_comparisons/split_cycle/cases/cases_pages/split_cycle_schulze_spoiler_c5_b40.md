...
**Method:** [Ranked Robin (RCV-RR / Copeland)](../../../../05_Ranked_Robin/01_Learn) · **1 seat** · **Expected winner:** Cascade
...
Winner — Ranked Robin (RCV-RR): Cascade
   *** 2 candidates tie for the most wins (Denali, Cascade) — a Condorcet cycle (no candidate beats all others). Resolved by total margin, then lot order. (This is where Minimax / Ranked Pairs / Schulze differ — see 05_Ranked_Robin/01_Learn/cycle_resolution.md.)
```
<!-- --8<-- [end:report] -->
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/split_cycle_schulze_spoiler_c5_b40_tabulated.txt) (regenerated on every run; every analysis forced on).

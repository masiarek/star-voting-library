...
<img src="../img/bv2222_rfyk46_510_thin_irv_sankey.png" width="860" alt="Round-by-round Sankey diagram: each candidate's votes as a band, and where the votes of an eliminated candidate transferred to.">
...
ROUND 1 — 100 of 100 ballots still active; majority = 51
   Beth eliminated with 5:
      → Ana                       5

FINAL ROUND — 100 of 100 ballots still active; majority = 51
   Ana                      53  (53.0% of the still-active)  ← elected
   Cole                     47  (47.0% of the still-active)
   Never exhausted, never transferred:
      47 ballots held by Cole carried a lower ranking that was never read
      (the count stopped here, so those preferences did nothing).

Inactive ballots at the final round: 0 of 100 (0.0%).
   Ana's 53 is a majority of the 100 still active AND of all 100 cast (53.0%).
```
<!-- --8<-- [end:report] -->

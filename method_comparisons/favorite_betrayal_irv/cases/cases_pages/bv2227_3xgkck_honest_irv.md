...
**Method:** [RCV-IRV (Instant Runoff)](../../../../06_Other/RCV_IRV/concepts/README.md) · **1 seat** · **Expected winner:** Right
...
<img src="../img/bv2227_3xgkck_honest_irv_sankey.png" width="860" alt="Round-by-round Sankey diagram: each candidate's votes as a band, and where the votes of an eliminated candidate transferred to.">
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/bv2227_3xgkck_honest_irv_tabulated.txt) (regenerated on every run; every analysis forced on).

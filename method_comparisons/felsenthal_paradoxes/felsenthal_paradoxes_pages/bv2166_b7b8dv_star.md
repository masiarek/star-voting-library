...
Full report from the [`_tabulated` mirror](../felsenthal_paradoxes_tabulated/bv2166_b7b8dv_star_tabulated.txt) (regenerated on every run; every analysis forced on):

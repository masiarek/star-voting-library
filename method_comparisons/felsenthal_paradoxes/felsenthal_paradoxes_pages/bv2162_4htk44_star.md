...
Everything in one file: the [`_tabulated` mirror](../felsenthal_paradoxes_tabulated/bv2162_4htk44_star_tabulated.txt) (regenerated on every run; every analysis forced on).

...
[Divergence from STAR]
  ...
  Note: the Approval line converts score ballots with a 3+ stars approval
        ...
        candidate has 0 approvals — the printed Approval winner (Amy) is
...
Amy         0   0   0   0   4  11  |     4   0.3
Boone       0   0   0   0   4  11  |     4   0.3
Cass        0   0   0   0   7   8  |     7   0.5
```

</details>

Everything in one file: the [`_tabulated` mirror](../felsenthal_paradoxes_tabulated/bv2165_9vxcj7_plurality_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/felsenthal_paradoxes/bv2165_9vxcj7_plurality.yaml
```

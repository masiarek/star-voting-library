...
Full report from the [`_tabulated` mirror](../felsenthal_paradoxes_tabulated/bv2148_h87k6v_star_tabulated.txt) (regenerated on every run; every analysis forced on):

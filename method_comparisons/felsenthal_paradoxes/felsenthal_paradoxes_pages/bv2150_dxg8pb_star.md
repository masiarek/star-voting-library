...
Full report from the [`_tabulated` mirror](../felsenthal_paradoxes_tabulated/bv2150_dxg8pb_star_tabulated.txt) (regenerated on every run; every analysis forced on):

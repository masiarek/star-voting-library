...
<img src="../img/coombs_ex18_monotonicity_sankey.png" width="860" alt="Round-by-round Sankey diagram: each candidate's votes as a band, and where the votes of an eliminated candidate transferred to.">
...
ROUND 1 — 33 of 33 ballots still active; majority = 17
   Cole eliminated with 4:
      → Arlo                      4
   Dana eliminated with 4:
      → Arlo                      4

FINAL ROUND — 33 of 33 ballots still active; majority = 17
   Arlo                     19  (57.6% of the still-active)  ← elected
   Bree                     14  (42.4% of the still-active)
   Never exhausted, never transferred:
      14 ballots held by Bree carried a lower ranking that was never read
      (the count stopped here, so those preferences did nothing).

Inactive ballots at the final round: 0 of 33 (0.0%).
   Arlo's 19 is a majority of the 33 still active AND of all 33 cast (57.6%).
```
<!-- --8<-- [end:report] -->

...
**Method:** [Approval Voting](../../../../04_Approval/concepts) · **1 seat** · **Expected winner:** Beau

**Official tie-break (lot) order:** Beau > Aria > Cole > Dean — consulted only if every deterministic tiebreaker stays tied ([how the ladder works](../../../../01_STAR/concepts/Tie_Breaking_STAR/tie_breaking.md)).

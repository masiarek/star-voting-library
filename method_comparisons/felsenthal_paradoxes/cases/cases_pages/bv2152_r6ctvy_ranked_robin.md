...
# Felsenthal Ex.5 — Ranked Robin: the Condorcet winner Bert

*Generated from [`bv2152_r6ctvy_ranked_robin.yaml`](../bv2152_r6ctvy_ranked_robin.yaml) — do not edit by hand. Regenerate: `python STARVote_LH_tabulation_engine/tools_adam/scripts/build_yaml_pages.py`.*

**Method:** [Ranked Robin (RCV-RR / Copeland)](../../../../05_Ranked_Robin/01_Learn/README.md) · **1 seat** · **Expected winner:** Bert
...
--- Ranked Robin (RCV-RR / Copeland) Method (single winner) ---
 Tabulating 47 ballots (ranked ballots).
...
Round-Robin — every pair, head-to-head (For – Against):
   Bert   beats Anna    27 – 20
   Anna   beats Carla   26 – 21
   Bert   beats Carla   32 – 15
...
Winner — Ranked Robin (RCV-RR): Bert
...
the honest answer to "who is even in contention?".
   Smith set (1 of 3): Bert
   Outside (2):        Anna, Carla
   One member ⇒ Bert is the Condorcet winner, beating every rival head-to-head.
   Ranked Robin (RCV-RR) winner Bert is INSIDE the Smith set. ✓
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/bv2152_r6ctvy_ranked_robin_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/felsenthal_paradoxes/cases/bv2152_r6ctvy_ranked_robin.yaml
```

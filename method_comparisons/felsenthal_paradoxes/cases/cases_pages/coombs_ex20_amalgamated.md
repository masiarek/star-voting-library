...
Tabulated as RCV-IRV, the mirror-image count. IRV elects B in all three files — District I, District II and this amalgamation — so on this profile IRV shows no reinforcement failure at all and the paradox is Coombs' alone. That contrast is why the three files are worth having separately.

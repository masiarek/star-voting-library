...
<img src="../img/bv2162_4htk44_irv_sankey.png" width="860" alt="Round-by-round Sankey diagram: each candidate's votes as a band, and where the votes of an eliminated candidate transferred to.">
...
ROUND 2 — 103 of 103 ballots still active; majority = 52
   B eliminated with 29:
      → A                        29

FINAL ROUND — 103 of 103 ballots still active; majority = 52
   A                        62  (60.2% of the still-active)  ← elected
   C                        41  (39.8% of the still-active)
   Never exhausted, never transferred:
      41 ballots held by C carried a lower ranking that was never read
      (the count stopped here, so those preferences did nothing).

Inactive ballots at the final round: 0 of 103 (0.0%).
   A's 62 is a majority of the 103 still active AND of all 103 cast (60.2%).
```
<!-- --8<-- [end:report] -->
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/felsenthal_paradoxes/cases/bv2162_4htk44_irv.yaml
```

...
**Method:** [Ranked Robin (RCV-RR / Copeland)](../../../../05_Ranked_Robin/01_Learn/README.md) · **1 seat** · **Expected winner:** Amos
...
the honest answer to "who is even in contention?".
   ...
   Ranked Robin (RCV-RR) winner Amos is INSIDE the Smith set. ✓
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/bv2153_pcttmr_ranked_robin_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/felsenthal_paradoxes/cases/bv2153_pcttmr_ranked_robin.yaml
```

...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/bv2162_4htk44_star_RCV-IRV_tabulated.txt
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/bv2162_4htk44_star_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/felsenthal_paradoxes/cases/bv2162_4htk44_star.yaml
```

## See also

- [Methods disagree on this election](../../../divergence_review/cases/IRV_OUTLIER_RR_WITH_STAR/bv2162_4htk44_star.md) — its entry in the divergence review ledger

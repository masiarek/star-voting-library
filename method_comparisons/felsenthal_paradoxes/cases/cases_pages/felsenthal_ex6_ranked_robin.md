...
**Method:** [Ranked Robin (RCV-RR / Copeland)](../../../../05_Ranked_Robin/01_Learn/README.md) · **1 seat** · **Expected winner:** Aria
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/felsenthal_ex6_ranked_robin_tabulated.txt) (regenerated on every run; every analysis forced on).

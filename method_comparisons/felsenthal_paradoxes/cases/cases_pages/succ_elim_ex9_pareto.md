...
Winner — Ranked Robin (RCV-RR): A
   *** 2 candidates tie for the most wins (A, D) — tied on the tally, not a cycle (some of them beat others head-to-head, but no loop closes). Resolved by total margin, then lot order.
```
<!-- --8<-- [end:report] -->

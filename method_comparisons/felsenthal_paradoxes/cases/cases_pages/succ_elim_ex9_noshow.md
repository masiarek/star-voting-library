...
# Successive elimination Ex.9 — two D voters stay home and get a better result

*Generated from [`succ_elim_ex9_noshow.yaml`](../succ_elim_ex9_noshow.yaml) — do not edit by hand. Regenerate: `python STARVote_LH_tabulation_engine/tools_adam/scripts/build_yaml_pages.py`.*
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/succ_elim_ex9_noshow_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/felsenthal_paradoxes/cases/succ_elim_ex9_noshow.yaml
```

...
**Method:** [RCV-IRV (Instant Runoff)](../../../../06_Other/RCV_IRV/concepts/README.md) · **1 seat** · **Expected winner:** Alma
...
<img src="../img/bv2149_byk9v2_irv_sankey.png" width="860" alt="Round-by-round Sankey diagram: each candidate's votes as a band, and where the votes of an eliminated candidate transferred to.">
...
ROUND 1 — 32 of 32 ballots still active; majority = 17
   Cora eliminated with 8:
      → Alma                      7
      → Bruno                     1

FINAL ROUND — 32 of 32 ballots still active; majority = 17
   Alma                     17  (53.1% of the still-active)  ← elected
   Bruno                    15  (46.9% of the still-active)
   Never exhausted, never transferred:
      15 ballots held by Bruno carried a lower ranking that was never read
      (the count stopped here, so those preferences did nothing).

Inactive ballots at the final round: 0 of 32 (0.0%).
   Alma's 17 is a majority of the 32 still active AND of all 32 cast (53.1%).
```
<!-- --8<-- [end:report] -->
...
the honest answer to "who is even in contention?".
   Smith set (3 of 3): Alma, Bruno, Cora
   Outside (0):        —
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/bv2149_byk9v2_irv_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/felsenthal_paradoxes/cases/bv2149_byk9v2_irv.yaml
```

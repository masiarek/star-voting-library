...
<img src="../img/coombs_ex22_scc_sankey.png" width="860" alt="Round-by-round Sankey diagram: each candidate's votes as a band, and where the votes of an eliminated candidate transferred to.">
...
ROUND 1 — 29 of 29 ballots still active; majority = 15
   D eliminated with 0:
      → (held no ballots)
   C eliminated with 4:
      → A                         4

FINAL ROUND — 29 of 29 ballots still active; majority = 15
   A                        15  (51.7% of the still-active)  ← elected
   B                        14  (48.3% of the still-active)
   Never exhausted, never transferred:
      14 ballots held by B carried a lower ranking that was never read
      (the count stopped here, so those preferences did nothing).

Inactive ballots at the final round: 0 of 29 (0.0%).
   A's 15 is a majority of the 29 still active AND of all 29 cast (51.7%).
```
<!-- --8<-- [end:report] -->

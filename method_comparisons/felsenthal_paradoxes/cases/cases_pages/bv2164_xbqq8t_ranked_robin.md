...
**Method:** [Ranked Robin (RCV-RR / Copeland)](../../../../05_Ranked_Robin/01_Learn/README.md) · **1 seat** · **Expected winner:** Arlo
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/bv2164_xbqq8t_ranked_robin_tabulated.txt) (regenerated on every run; every analysis forced on).

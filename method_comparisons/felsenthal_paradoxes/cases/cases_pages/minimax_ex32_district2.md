...
*Generated from [`minimax_ex32_district2.yaml`](../minimax_ex32_district2.yaml) — do not edit by hand. Regenerate: `python STARVote_LH_tabulation_engine/tools_adam/scripts/build_yaml_pages.py`.*
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/minimax_ex32_district2_tabulated.txt) (regenerated on every run; every analysis forced on).

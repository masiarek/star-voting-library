...
Mirrors: [approval](cases/cases_tabulated/felsenthal_ex6_pareto_approval_tabulated.txt) · [rr](cases/cases_tabulated/felsenthal_ex6_ranked_robin_tabulated.txt). Tag: `pareto` in the [paradox registry](../../07_Concepts/YAML_test_case_index/PARADOX_index.md).

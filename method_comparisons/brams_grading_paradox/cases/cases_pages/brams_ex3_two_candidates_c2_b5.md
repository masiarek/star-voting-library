...
[Condorcet Loser]
  Condorcet Loser: Alan — loses every head-to-head matchup — elected by Approval!
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/brams_grading_paradox/cases/brams_ex3_two_candidates_c2_b5.yaml
```

...
**Method:** [STAR (single winner)](../../../../01_STAR/01_Learn/README.md) · **1 seat** · **Expected winner:** Cole
...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/brams_ex6_three_winners_c3_b9_RCV-IRV_tabulated.txt
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/brams_grading_paradox/cases/brams_ex6_three_winners_c3_b9.yaml
```

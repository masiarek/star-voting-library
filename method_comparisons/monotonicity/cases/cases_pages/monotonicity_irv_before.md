...
**Method:** [RCV-IRV (Instant Runoff)](../../../../06_Other/RCV_IRV/concepts/README.md) · **1 seat** · **Expected winner:** X
...
<img src="../img/monotonicity_irv_before_sankey.png" width="860" alt="Round-by-round Sankey diagram: each candidate's votes as a band, and where the votes of an eliminated candidate transferred to.">
...
ROUND 1 — 34 of 34 ballots still active; majority = 18
   Z eliminated with 10:
      → X                        10

FINAL ROUND — 34 of 34 ballots still active; majority = 18
   X                        22  (64.7% of the still-active)  ← elected
   Y                        12  (35.3% of the still-active)
   Never exhausted, never transferred:
      12 ballots held by Y carried a lower ranking that was never read
      (the count stopped here, so those preferences did nothing).

Inactive ballots at the final round: 0 of 34 (0.0%).
   X's 22 is a majority of the 34 still active AND of all 34 cast (64.7%).
```
<!-- --8<-- [end:report] -->

...
<img src="../img/alaska_upward_after_sankey.png" width="860" alt="Round-by-round Sankey diagram: each candidate's votes as a band, and where the votes of an eliminated candidate transferred to.">
...
ROUND 1 — 200 of 200 ballots still active; majority = 101
   Palin eliminated with 56:
      → Begich                   36
      → (no continuing ranking)     16  ← these ballots go inactive
      → Peltola                   4

FINAL ROUND — 184 of 200 ballots still active (16 inactive); majority = 93
   Begich                   93  (50.5% of the still-active)  ← elected
   Peltola                  91  (49.5% of the still-active)
   Never exhausted, never transferred:
      66 ballots held by Peltola carried a lower ranking that was never read
      (the count stopped here, so those preferences did nothing).

Inactive ballots at the final round: 16 of 200 (8.0%).
   Begich's 93 is a majority of the 184 still active but only 46.5% of all 200 cast —

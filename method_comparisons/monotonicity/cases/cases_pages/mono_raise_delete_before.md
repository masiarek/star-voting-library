...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/mono_raise_delete_before_RCV-IRV_tabulated.txt
  RCV-RR round-robin: cases_tabulated/mono_raise_delete_before_RCV-RR_tabulated.txt
...
[Condorcet Loser]
  Condorcet Loser: Y — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/monotonicity/cases/mono_raise_delete_before.yaml
```

...
Everything in one file: the [`_tabulated` mirror](../monotonicity_tabulated/monotonicity_star_after_tabulated.txt) (regenerated on every run; every analysis forced on).

...
**Method:** [STAR (single winner)](../../../../01_STAR/01_Learn/README.md) · **1 seat** · **Expected winner:** Anderson
...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/bv2137_ywckmg_star_RCV-IRV_tabulated.txt
...
[Condorcet Loser]
  Condorcet Loser: Reagan — loses every head-to-head matchup — elected by Choose-One (Plurality)!
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/center_squeeze_bv2137/cases/bv2137_ywckmg_star.yaml
```

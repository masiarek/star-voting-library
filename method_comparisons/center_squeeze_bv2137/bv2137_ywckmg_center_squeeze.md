...
→ **Level: Voting 301** — Curriculum [301.10](../../07_Concepts/CURRICULUM.md). See also: [the ranked-ballot method zoo](../../07_Concepts/topics/ranked_ballot_methods_zoo.md) · [center squeeze topic hub](../../07_Concepts/topics/center_squeeze/) · [what makes a good winner?](../../07_Concepts/topics/what_makes_a_good_winner.md).

...
Everything in one file: the [`_tabulated` mirror](../black_curtain_tabulated/Black_Curtain_03_c3_b5_polarized-on-cal_tabulated.txt) (regenerated on every run; every analysis forced on).

...
Everything in one file: the [`_tabulated` mirror](../black_curtain_tabulated/Black_Curtain_02_c3_b5_near-clones_tabulated.txt) (regenerated on every run; every analysis forced on).

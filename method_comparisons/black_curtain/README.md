...
- [`../../07_Concepts/scores_and_ranks/`](../../07_Concepts/scores_and_ranks) — scores vs ranks, the fidelity ladder
- [RCV-IRV vs. STAR — A Side-by-Side](../../07_Concepts/topics/rcv_irv_vs_star.md) — method comparison
- [`../runoff_overturns_leader/`](../../01_STAR/02_Examples/runoff_overturns_leader) — when STAR's runoff agrees/disagrees with the score leader

...
*A worked case study from the video ["The Black Curtain"](https://www.youtube.com/watch?v=5_ZMruwOZgw) by Common Sense for Uniting America (Ted Getschman / [MaxVoting.org](https://maxvoting.org)). BetterVoting template: <https://bettervoting.com/p9gwc3/vote>. Adam's notes doc: [The Black Curtain (Google Doc)](https://docs.google.com/document/d/1ntOS5PQ_kkPnaZpDeqLShGv2pz_k6Zom9LnTEdjjd4o). This folder on GitHub: <https://github.com/masiarek/YAML/tree/master/method_comparisons/black_curtain>. This folder re-creates all four elections as runnable YAML cases for this repo's engine.*
...
- [Scores and ranks](../../07_Concepts/scores_and_ranks/README.md) — scores vs ranks, the fidelity ladder
- [RCV-IRV vs. STAR — A Side-by-Side](../../07_Concepts/topics/rcv_irv_vs_star.md) — method comparison
- [When the runoff overturns the score leader](../../01_STAR/02_Examples/runoff_overturns_leader/README.md) — when STAR's runoff agrees/disagrees with the score leader

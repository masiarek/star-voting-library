...
- [**Read as Range / Score voting**](black_curtain_range.md) — the same four elections tabulated by the [range engine](../../06_Other/Range/Range_tabulation_engine/README_range_tabulation_engine.md) (pref_voting); Range and STAR part ways in elections 1 and 3

...
the honest answer to "who is even in contention?".
   Smith set (4 of 4): Ana, Bruno, Chloe, Diego
   Outside (0):        —
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/cycle_schulze_vs_ranked_pairs_c4_b40_tabulated.txt) (regenerated on every run; every analysis forced on).
...
More cases in this set: [cycle_copeland_ties_c4_b21](cycle_copeland_ties_c4_b21.md) · [cycle_family_splits_c5_b77](cycle_family_splits_c5_b77.md) · [cycle_vote_on_the_rule_irv_c5_b999](cycle_vote_on_the_rule_irv_c5_b999.md) · [cycle_vote_on_the_rule_rr_c5_b999](cycle_vote_on_the_rule_rr_c5_b999.md)

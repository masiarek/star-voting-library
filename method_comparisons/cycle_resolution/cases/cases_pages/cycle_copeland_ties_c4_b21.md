...
**Method:** [Ranked Robin (RCV-RR / Copeland)](../../../../05_Ranked_Robin/01_Learn/README.md) · **1 seat** · **Expected winner:** Alder
...
Win–loss record — Copeland score = wins + ½·ties (highest score wins; ties broken by the Ranked Robin degrees, then lot order):
    ...
    1  Alder      2–1–0         2     +29            +8  Birch, Dogwood
    2  Birch      2–1–0         2     +23            +2  Cedar, Dogwood
    3  Cedar      2–1–0         2     +11           -10  Alder, Dogwood
    4  Dogwood    0–3–0         0     -63             —  —

Winner — Ranked Robin (RCV-RR): Alder
   *** 3 candidates tie for the most wins (Alder, Birch, Cedar) — a Condorcet cycle (no candidate beats all others). Resolved by the 1st Degree tiebreaker: Alder has the greatest sum of win margins over the other finalists (+8). (This is where Minimax / Ranked Pairs / Schulze differ — see 05_Ranked_Robin/01_Learn/cycle_resolution.md.)
```
<!-- --8<-- [end:report] -->
...
More cases in this set: [cycle_family_splits_c5_b77](cycle_family_splits_c5_b77.md) · [cycle_schulze_vs_ranked_pairs_c4_b40](cycle_schulze_vs_ranked_pairs_c4_b40.md) · [cycle_vote_on_the_rule_irv_c5_b999](cycle_vote_on_the_rule_irv_c5_b999.md) · [cycle_vote_on_the_rule_rr_c5_b999](cycle_vote_on_the_rule_rr_c5_b999.md)

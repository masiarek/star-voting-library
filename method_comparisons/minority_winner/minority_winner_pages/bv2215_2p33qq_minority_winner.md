...
Everything in one file: the [`_tabulated` mirror](../minority_winner_tabulated/bv2215_2p33qq_minority_winner_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/minority_winner/bv2215_2p33qq_minority_winner.yaml
```

...
The point isn't "STAR wins the argument." It's that **support is real information, and only a score ballot carries it** — the same claim the [Preference vs. Support](../../07_Concepts/scores_and_ranks/preference_vs_support.md) page makes with `1,0,1,0` vs `5,4,5,4`, now as 36 real ballots you can re-run.

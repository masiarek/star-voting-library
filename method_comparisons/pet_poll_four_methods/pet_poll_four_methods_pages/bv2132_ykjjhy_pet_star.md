...
Everything in one file: the [`_tabulated` mirror](../pet_poll_four_methods_tabulated/bv2132_ykjjhy_pet_star_tabulated.txt) (regenerated on every run; every analysis forced on).

...
<img src="../img/bv2132_ykjjhy_pet_irv_sankey.png" width="860" alt="Round-by-round Sankey diagram: each candidate's votes as a band, and where the votes of an eliminated candidate transferred to.">
...
ROUND 1 — 22 of 22 ballots still active; majority = 12
   Cat eliminated with 6:
      → Fish                      6

FINAL ROUND — 22 of 22 ballots still active; majority = 12
   Fish                     13  (59.1% of the still-active)  ← elected
   Dog                       9  (40.9% of the still-active)
   Never exhausted, never transferred:
      9 ballots held by Dog carried a lower ranking that was never read
      (the count stopped here, so those preferences did nothing).

Inactive ballots at the final round: 0 of 22 (0.0%).
   Fish's 13 is a majority of the 22 still active AND of all 22 cast (59.1%).
```
<!-- --8<-- [end:report] -->

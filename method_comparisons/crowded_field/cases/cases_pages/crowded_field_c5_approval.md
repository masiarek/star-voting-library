...
*Generated from [`crowded_field_c5_approval.yaml`](../crowded_field_c5_approval.yaml) — do not edit by hand. Regenerate: `python STARVote_LH_tabulation_engine/tools_adam/scripts/build_yaml_pages.py`.*
...
Full report from the [`_tabulated` mirror](../cases_tabulated/crowded_field_c5_approval_tabulated.txt) (regenerated on every run; every analysis forced on):
...
Ballots:
   columns = Ana, Bruno, Diego, Elsa, Greta      (1 = approve; 0 / blank / marker = not approved)
    16 × 1,1,0,0,0
    13 × 0,1,1,0,0
    21 × 0,0,1,1,0
     8 × 0,0,0,1,1

...
Concept hubs: [majority criterion](../../07_Concepts/topics/majority_criterion/README.md) · [Approval Voting](../../04_Approval/01_Learn/README.md) · [Approval in the theory literature](../../04_Approval/01_Learn/approval_in_the_literature.md) · [Black Curtain — the same compression, five ballots](../black_curtain/README.md) · up: [method_comparisons — same ballots, different methods](../README.md)

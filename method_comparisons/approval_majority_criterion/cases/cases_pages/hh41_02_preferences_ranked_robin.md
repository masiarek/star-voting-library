...
Full report from the [`_tabulated` mirror](../cases_tabulated/hh41_02_preferences_ranked_robin_tabulated.txt) (regenerated on every run; every analysis forced on):

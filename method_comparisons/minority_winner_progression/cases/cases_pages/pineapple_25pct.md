...
**Method:** [STAR (single winner)](../../../../01_STAR/01_Learn/README.md) · **1 seat** · **Expected winner:** Cheese
...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/pineapple_25pct_RCV-IRV_tabulated.txt
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/minority_winner_progression/cases/pineapple_25pct.yaml
```

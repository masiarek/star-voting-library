...
[Divergence from STAR]
  ...
  RCV-IRV rounds: minority_winner_progression_tabulated/pineapple_34pct_RCV-IRV_tabulated.txt
...
Everything in one file: the [`_tabulated` mirror](../minority_winner_progression_tabulated/pineapple_34pct_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/minority_winner_progression/pineapple_34pct.yaml
```

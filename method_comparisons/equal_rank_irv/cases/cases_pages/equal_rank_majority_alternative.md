...
*Generated from [`equal_rank_majority_alternative.yaml`](../equal_rank_majority_alternative.yaml) — do not edit by hand. Regenerate: `python STARVote_LH_tabulation_engine/tools_adam/scripts/build_yaml_pages.py`.*

**Method:** [STAR (single winner)](../../../../01_STAR/01_Learn/README.md) · **1 seat** · **Expected winner:** Basil
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/equal_rank_majority_alternative_tabulated.txt) (regenerated on every run; every analysis forced on).
...
- [Methods disagree on this election](../../../divergence_review/cases/IRV_DIFFERS_ARTIFACT/equal_rank_majority_alternative.md) — its entry in the divergence review ledger
...
More cases in this set: [equal_rank_clone_with](equal_rank_clone_with.md) · [equal_rank_clone_without](equal_rank_clone_without.md) · [equal_rank_cohesive_consecutive](equal_rank_cohesive_consecutive.md) · [equal_rank_cohesive_wide_gaps](equal_rank_cohesive_wide_gaps.md) · [equal_rank_five_voters](equal_rank_five_voters.md)

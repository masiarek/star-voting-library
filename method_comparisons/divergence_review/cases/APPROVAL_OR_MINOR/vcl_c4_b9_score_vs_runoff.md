...
STAR, RCV-IRV and Ranked Robin all agree on **Ben**. Only **Approval** differs, electing **Amy**: Approval counts every score of 3–5 as one equal 'approve' and ignores intensity, rewarding Amy's *breadth* of acceptability over Ben's stronger but more concentrated support. A **threshold story about Approval**, not a STAR-vs-IRV teaching case.

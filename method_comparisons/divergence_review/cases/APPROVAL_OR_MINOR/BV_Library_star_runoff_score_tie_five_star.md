...
Winner — Ranked Robin (RCV-RR): Allison
   *** 2 candidates tie on the highest Copeland score (0.5): Allison, Bill — a dead heat (they draw head-to-head, not a cycle). Resolved by total margin, then lot order.

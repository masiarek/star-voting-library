...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/bfjqmg) · **[results ↗](https://bettervoting.com/bfjqmg/results)** (election `bfjqmg`) — an independent tabulator to check the winners below against.
...
**Source election:** [`01_STAR/04_Real_Elections/runoff_reversal_bv_cases/cases/Runoff_04_reversal_at_scale_bfjqmg.yaml`](../../../../01_STAR/04_Real_Elections/runoff_reversal_bv_cases/cases/Runoff_04_reversal_at_scale_bfjqmg.yaml)  ·  **STAR tabulated mirror:** [`Runoff_04_reversal_at_scale_bfjqmg_tabulated.txt`](../../../../01_STAR/04_Real_Elections/runoff_reversal_bv_cases/cases/cases_tabulated/Runoff_04_reversal_at_scale_bfjqmg_tabulated.txt)
...
the honest answer to "who is even in contention?".
   Smith set (1 of 3): Olive
   Outside (2):        Maple, Pine
   One member ⇒ Olive is the Condorcet winner, beating every rival head-to-head.
   RCV-IRV winner Olive is INSIDE the Smith set. ✓
...
the honest answer to "who is even in contention?".
   ...
   Outside (2):        Maple, Pine
   One member ⇒ Olive is the Condorcet winner, beating every rival head-to-head.
   Ranked Robin (RCV-RR) winner Olive is INSIDE the Smith set. ✓

...
Winner — Ranked Robin (RCV-RR): Rock
   *** 3 candidates tie for the most wins (Rock, Paper, Scissors) — a Condorcet cycle (no candidate beats all others). Resolved by total margin, then lot order. (This is where Minimax / Ranked Pairs / Schulze differ — see 05_Ranked_Robin/concepts/cycle_resolution.md.)
...
the honest answer to "who is even in contention?".
   ...
   the set should win is exactly what Minimax / Ranked Pairs / Schulze disagree
   about — see 05_Ranked_Robin/concepts/cycle_resolution.md.
   Ranked Robin (RCV-RR) winner Rock is INSIDE the Smith set. ✓

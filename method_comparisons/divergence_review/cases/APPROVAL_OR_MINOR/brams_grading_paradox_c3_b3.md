...
STAR, RCV-IRV and Ranked Robin all agree on **Baker**. Only **Approval** reports **Adams** — but that line is a **conversion artifact**, not an Approval verdict: the comparison converts score ballots with a 3+ stars approval threshold, and on this profile 3 candidates tie for the most approvals (1 each) — the printed winner is just the candidate-priority tie-break. A caution about applying a fixed approval cut to low-scoring ballots, not an Approval-vs-STAR difference.
...
**Flags:** 2 tied-score ballot(s); IRV winner flips under reversed priority (fragile tie); Approval winner decided by priority tie-break (3+ stars conversion artifact)

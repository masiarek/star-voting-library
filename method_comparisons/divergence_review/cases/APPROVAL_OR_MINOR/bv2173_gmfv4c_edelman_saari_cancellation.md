...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/gmfv4c) · **[results ↗](https://bettervoting.com/gmfv4c/results)** (election `gmfv4c` · test `BV2173`) — an independent tabulator to check the winners below against.

...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/xgkw3w) · **[results ↗](https://bettervoting.com/xgkw3w/results)** (election `xgkw3w`) — an independent tabulator to check the winners below against.
...
**Source election:** [`01_STAR/04_Real_Elections/runoff_reversal_bv_cases/cases/Runoff_05_reversal_with_equal_support_xgkw3w.yaml`](../../../../01_STAR/04_Real_Elections/runoff_reversal_bv_cases/cases/Runoff_05_reversal_with_equal_support_xgkw3w.yaml)  ·  **STAR tabulated mirror:** [`Runoff_05_reversal_with_equal_support_xgkw3w_tabulated.txt`](../../../../01_STAR/04_Real_Elections/runoff_reversal_bv_cases/cases/cases_tabulated/Runoff_05_reversal_with_equal_support_xgkw3w_tabulated.txt)
...
the honest answer to "who is even in contention?".
   Smith set (1 of 3): Sage
   Outside (2):        Rosa, Tulip
   One member ⇒ Sage is the Condorcet winner, beating every rival head-to-head.
   RCV-IRV winner Sage is INSIDE the Smith set. ✓
...
the honest answer to "who is even in contention?".
   ...
   Outside (2):        Rosa, Tulip
   One member ⇒ Sage is the Condorcet winner, beating every rival head-to-head.
   Ranked Robin (RCV-RR) winner Sage is INSIDE the Smith set. ✓

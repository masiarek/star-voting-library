...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/c73pfw) · **[results ↗](https://bettervoting.com/c73pfw/results)** (election `c73pfw` · test `BV2249`) — an independent tabulator to check the winners below against.

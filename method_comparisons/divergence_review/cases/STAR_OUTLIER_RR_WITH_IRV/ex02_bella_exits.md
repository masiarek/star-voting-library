...
**Source election:** [`01_STAR/05_Practice/cases/ex02_bella_exits.yaml`](../../../../01_STAR/05_Practice/cases/ex02_bella_exits.yaml)  ·  **STAR tabulated mirror:** [`ex02_bella_exits_tabulated.txt`](../../../../01_STAR/05_Practice/cases/cases_tabulated/ex02_bella_exits_tabulated.txt)
...
the honest answer to "who is even in contention?".
   Smith set (1 of 4): Eli
   Outside (3):        Alex, Chris, Dana
   One member ⇒ Eli is the Condorcet winner, beating every rival head-to-head.
   RCV-IRV winner Eli is INSIDE the Smith set. ✓

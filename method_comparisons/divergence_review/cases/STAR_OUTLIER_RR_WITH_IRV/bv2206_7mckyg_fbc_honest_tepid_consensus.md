...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/7mckyg) · **[results ↗](https://bettervoting.com/7mckyg/results)** (election `7mckyg` · test `BV2206`) — an independent tabulator to check the winners below against.

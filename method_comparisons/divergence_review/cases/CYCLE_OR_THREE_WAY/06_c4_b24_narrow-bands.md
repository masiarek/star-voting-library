...
Win–loss record — Copeland score = wins + ½·ties (highest score wins; ties broken by the Ranked Robin degrees, then lot order):
    ...
    1  Coral      2–1–0         2      +4            +3  Azure, Dune
    2  Beige      2–1–0         2      +1             0  Coral, Dune
    3  Azure      2–1–0         2      -1            -3  Beige, Dune
    4  Dune       0–3–0         0      -4             —  —

Winner — Ranked Robin (RCV-RR): Coral
   *** 3 candidates tie for the most wins (Azure, Beige, Coral) — a Condorcet cycle (no candidate beats all others). Resolved by the 1st Degree tiebreaker: Coral has the greatest sum of win margins over the other finalists (+3). (This is where Minimax / Ranked Pairs / Schulze differ — see 05_Ranked_Robin/01_Learn/cycle_resolution.md.)

...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/3grpbb) · **[results ↗](https://bettervoting.com/3grpbb/results)** (election `3grpbb` · test `BV2156`) — an independent tabulator to check the winners below against.
...
**Source election:** [`method_comparisons/paradoxes_and_whoops/cases/bv2156_3grpbb_star_misses_condorcet.yaml`](../../../../method_comparisons/paradoxes_and_whoops/cases/bv2156_3grpbb_star_misses_condorcet.yaml)  ·  **STAR tabulated mirror:** [`bv2156_3grpbb_star_misses_condorcet_tabulated.txt`](../../../../method_comparisons/paradoxes_and_whoops/cases/cases_tabulated/bv2156_3grpbb_star_misses_condorcet_tabulated.txt)
...
Automatic Runoff Round
 The candidate preferred in the most head-to-head matchups wins.
   ...
   Equal Support -- 25
 Ada wins.
   Voters with a preference: 75 of 100 (25 Equal Support).
   Ada 40 (53%) vs Bruno 35 (47%); majority = 38.
...
the honest answer to "who is even in contention?".
   Smith set (1 of 3): Cleo
   Outside (2):        Ada, Bruno
   One member ⇒ Cleo is the Condorcet winner, beating every rival head-to-head.
   RCV-IRV winner Ada is OUTSIDE the Smith set. ✗
      Every member of the set (Cleo) beats Ada head-to-head, yet
...
the honest answer to "who is even in contention?".
   ...
   Outside (2):        Ada, Bruno
   One member ⇒ Cleo is the Condorcet winner, beating every rival head-to-head.
   Ranked Robin (RCV-RR) winner Cleo is INSIDE the Smith set. ✓

...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/g3f7r2) · **[results ↗](https://bettervoting.com/g3f7r2/results)** (election `g3f7r2` · test `BV2212`) — an independent tabulator to check the winners below against.
...
the honest answer to "who is even in contention?".
   Smith set (3 of 3): Alice, Ben, Carla
   Outside (0):        —

...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/p8dp28) · **[results ↗](https://bettervoting.com/p8dp28/results)** (election `p8dp28` · test `BV2176`) — an independent tabulator to check the winners below against.

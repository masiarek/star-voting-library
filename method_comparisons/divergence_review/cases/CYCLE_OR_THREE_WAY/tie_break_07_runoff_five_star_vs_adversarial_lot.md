...
**Source election:** [`01_STAR/03_Criteria/tie_break_dead_rung/cases/tie_break_07_runoff_five_star_vs_adversarial_lot.yaml`](../../../../01_STAR/03_Criteria/tie_break_dead_rung/cases/tie_break_07_runoff_five_star_vs_adversarial_lot.yaml)  ·  **STAR tabulated mirror:** [`tie_break_07_runoff_five_star_vs_adversarial_lot_tabulated.txt`](../../../../01_STAR/03_Criteria/tie_break_dead_rung/cases/cases_tabulated/tie_break_07_runoff_five_star_vs_adversarial_lot_tabulated.txt)
...
Winner — Ranked Robin (RCV-RR): Ben
   *** 2 candidates tie on the highest Copeland score (0.5): Ann, Ben — a dead heat (they draw head-to-head, not a cycle). Neither the 1st nor the 2nd Degree tiebreaker separates them — resolved by lot order.

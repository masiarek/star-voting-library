...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/w9f4vd) · **[results ↗](https://bettervoting.com/w9f4vd/results)** (election `w9f4vd` · test `BV2236`) — an independent tabulator to check the winners below against.

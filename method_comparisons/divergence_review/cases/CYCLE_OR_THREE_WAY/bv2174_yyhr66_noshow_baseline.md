...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/yyhr66) · **[results ↗](https://bettervoting.com/yyhr66/results)** (election `yyhr66` · test `BV2174`) — an independent tabulator to check the winners below against.

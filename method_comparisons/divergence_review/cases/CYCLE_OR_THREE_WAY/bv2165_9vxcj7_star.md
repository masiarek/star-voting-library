...
Winner — Ranked Robin (RCV-RR): Cass
   *** 3 candidates tie for the most wins (Amy, Boone, Cass) — a Condorcet cycle (no candidate beats all others). Resolved by total margin, then lot order. (This is where Minimax / Ranked Pairs / Schulze differ — see 05_Ranked_Robin/concepts/cycle_resolution.md.)

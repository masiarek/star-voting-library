...
**Source election:** [`01_STAR/03_Criteria/tie_break_dead_rung/cases/tie_break_04_runoff_five_star_breaks.yaml`](../../../../01_STAR/03_Criteria/tie_break_dead_rung/cases/tie_break_04_runoff_five_star_breaks.yaml)  ·  **STAR tabulated mirror:** [`tie_break_04_runoff_five_star_breaks_tabulated.txt`](../../../../01_STAR/03_Criteria/tie_break_dead_rung/cases/cases_tabulated/tie_break_04_runoff_five_star_breaks_tabulated.txt)
...
Win–loss record — Copeland score = wins + ½·ties (highest score wins; ties broken by the Ranked Robin degrees, then lot order):
    ...
    1  Alice      0–0–1       0.5      +0             0  —
    2  Ben        0–0–1       0.5      +0             0  —

Winner — Ranked Robin (RCV-RR): Alice
   *** 2 candidates tie on the highest Copeland score (0.5): Alice, Ben — a dead heat (they draw head-to-head, not a cycle). Neither the 1st nor the 2nd Degree tiebreaker separates them — resolved by lot order.

...
**Source election:** [`01_STAR/05_Practice/cases/ex02_tenth_ballot.yaml`](../../../../01_STAR/05_Practice/cases/ex02_tenth_ballot.yaml)  ·  **STAR tabulated mirror:** [`ex02_tenth_ballot_tabulated.txt`](../../../../01_STAR/05_Practice/cases/cases_tabulated/ex02_tenth_ballot_tabulated.txt)
...
Winner — Ranked Robin (RCV-RR): Chris
   *** 2 candidates tie on the highest Copeland score (2.5): Alex, Chris — a Condorcet cycle (no candidate beats all others). Resolved by total margin, then lot order. (This is where Minimax / Ranked Pairs / Schulze differ — see 05_Ranked_Robin/01_Learn/cycle_resolution.md.)

...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/4jmgrd) · **[results ↗](https://bettervoting.com/4jmgrd/results)** (election `4jmgrd` · test `BV2234`) — an independent tabulator to check the winners below against.

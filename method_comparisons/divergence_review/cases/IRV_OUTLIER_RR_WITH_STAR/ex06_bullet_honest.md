...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/x4dkfd) · **[results ↗](https://bettervoting.com/x4dkfd/results)** (election `x4dkfd` · test `BV2193`) — an independent tabulator to check the winners below against.
...
**Source election:** [`01_STAR/05_Practice/cases/ex06_bullet_honest.yaml`](../../../../01_STAR/05_Practice/cases/ex06_bullet_honest.yaml)  ·  **STAR tabulated mirror:** [`ex06_bullet_honest_tabulated.txt`](../../../../01_STAR/05_Practice/cases/cases_tabulated/ex06_bullet_honest_tabulated.txt)

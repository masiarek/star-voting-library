...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/cphxpt) · **[results ↗](https://bettervoting.com/cphxpt/results)** (election `cphxpt` · test `BV2155`) — an independent tabulator to check the winners below against.
...
the honest answer to "who is even in contention?".
   ...
   RCV-IRV winner Knoxville is OUTSIDE the Smith set. ✗
      Every member of the set (Nashville) beats Knoxville head-to-head, yet
      RCV-IRV elected Knoxville anyway. RCV-IRV is not Smith-efficient (nor

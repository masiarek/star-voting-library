...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/bkwfjr) · **[results ↗](https://bettervoting.com/bkwfjr/results)** (election `bkwfjr` · test `BV2172`) — an independent tabulator to check the winners below against.
...
**Automatic runoff:** Casey 53 vs Avery 47
...
Automatic Runoff Round
 ...
 Casey wins.
   ...
   Casey 53 (53%) vs Avery 47 (47%); majority = 51.

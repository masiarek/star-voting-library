...
the honest answer to "who is even in contention?".
   Smith set (1 of 3): Green
   Outside (2):        Red, Yellow
   One member ⇒ Green is the Condorcet winner, beating every rival head-to-head.
   RCV-IRV winner Yellow is OUTSIDE the Smith set. ✗
      Every member of the set (Green) beats Yellow head-to-head, yet
      RCV-IRV elected Yellow anyway. RCV-IRV is not Smith-efficient (nor

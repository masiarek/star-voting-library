...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/k3fmwv) · **[results ↗](https://bettervoting.com/k3fmwv/results)** (election `k3fmwv` · test `BV2213`) — an independent tabulator to check the winners below against.
...
the honest answer to "who is even in contention?".
   ...
   Outside (2):        Peltola, Palin
   One member ⇒ Begich is the Condorcet winner, beating every rival head-to-head.
   Ranked Robin (RCV-RR) winner Begich is INSIDE the Smith set. ✓

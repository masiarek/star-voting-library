...
**▶ Live on BetterVoting:** [vote](https://bettervoting.com/4htk44) · **[results ↗](https://bettervoting.com/4htk44/results)** (election `4htk44` · test `BV2162`) — an independent tabulator to check the winners below against.

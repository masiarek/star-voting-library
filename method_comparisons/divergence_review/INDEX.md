...
_Generated 2026-07-15 19:58 by `STARVote_LH_tabulation_engine/tools_adam/scripts/build_divergence_index.py` — do not hand-edit; rebuild._
...
- **`appr_artifact`** = the Approval column (a 3+ stars conversion of the score ballots) approved nobody at all, or several candidates tie for most approvals — the named Approval winner is just the candidate-priority tie-break, not an Approval verdict.
...
- **[09_c4_b100_tennessee-capital](cases/IRV_OUTLIER_RR_WITH_STAR/09_c4_b100_tennessee-capital.md)** — `01_STAR/_main/09_c4_b100_tennessee-capital.yaml` (4c/100b)  
    ...
    _flags: Approval = priority tie-break (conversion artifact)_
...
- **[display_options_demo](cases/IRV_DIFFERS_ARTIFACT/display_options_demo.md)** — `01_STAR/_main/display_options_demo.yaml` (4c/4b)  
    ...
    _flags: 2 tied-score ballot(s); IRV flips on reversed priority; RR conv-sensitive (weak=Don, strict=Bob); Approval = priority tie-break (conversion artifact)_
- **[star_ala_approval](cases/IRV_DIFFERS_ARTIFACT/star_ala_approval.md)** — `01_STAR/_main/star_ala_approval.yaml` (4c/8b)  
    ...
    _flags: 4 tied-score ballot(s); IRV flips on reversed priority; RR conv-sensitive (weak=D, strict=A); Approval = priority tie-break (conversion artifact)_
- **[bv95b_7pdq3r_favorite_loses_two_rivals](cases/IRV_DIFFERS_ARTIFACT/bv95b_7pdq3r_favorite_loses_two_rivals.md)** — `01_STAR/majority_criterion/bv95b_7pdq3r_favorite_loses_two_rivals.yaml` (3c/5b)  
    ...
    _flags: 2 tied-score ballot(s); Approval = priority tie-break (conversion artifact)_
...
- **[brams_ex6_three_winners_c3_b9](cases/IRV_DIFFERS_ARTIFACT/brams_ex6_three_winners_c3_b9.md)** — `method_comparisons/brams_grading_paradox/brams_ex6_three_winners_c3_b9.yaml` (3c/9b)  
    ...
    _flags: 9 tied-score ballot(s); IRV flips on reversed priority; RR conv-sensitive (weak=Cole, strict=Amos); Approval = priority tie-break (conversion artifact)_
...
- **[brams_grading_paradox_c3_b3](cases/APPROVAL_OR_MINOR/brams_grading_paradox_c3_b3.md)** — `method_comparisons/brams_grading_paradox/brams_grading_paradox_c3_b3.yaml` (3c/3b)  
    ...
    _flags: 2 tied-score ballot(s); IRV flips on reversed priority; Approval = priority tie-break (conversion artifact)_

...
_Generated 2026-07-14 18:15 by `STARVote_LH_tabulation_engine/tools_adam/scripts/build_divergence_index.py` — do not hand-edit; rebuild._
...
- Scanned **148** single-winner STAR elections (skipped 86 non-eligible files: multi-winner / Approval / RR / RCV / ranked-ballot / unparseable).
- **76** (51%) diverge from STAR under at least one method; **72** agree across the board.

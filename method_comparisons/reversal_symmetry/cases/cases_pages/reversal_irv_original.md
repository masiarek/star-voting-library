...
<img src="../img/reversal_irv_original_sankey.png" width="860" alt="Round-by-round Sankey diagram: each candidate's votes as a band, and where the votes of an eliminated candidate transferred to.">
...
FINAL ROUND — 24 of 24 ballots still active; majority = 13
   A                        15  (62.5% of the still-active)  ← elected
   B                         9  (37.5% of the still-active)
   Never exhausted, never transferred:
      9 ballots held by B carried a lower ranking that was never read
      (the count stopped here, so those preferences did nothing).

Inactive ballots at the final round: 0 of 24 (0.0%).
   A's 15 is a majority of the 24 still active AND of all 24 cast (62.5%).
```
<!-- --8<-- [end:report] -->

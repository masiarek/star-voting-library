...
- **The failure is real and IRV-specific** — worth knowing, and a clean symptom of the same root cause as [center squeeze](../../07_Concepts/topics/center_squeeze/) and [non-monotonicity](../../06_Other/RCV_IRV/concepts/RCV_IRV_non_monotonicity.md): IRV eliminates on *first-choice counts*, so reversing preferences doesn't cleanly reverse the outcome.

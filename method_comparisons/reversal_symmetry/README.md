...
→ Related: [IRV non-monotonicity](../../00_start_here/RCV_IRV/RCV_IRV_non_monotonicity.md) · [the participation / no-show paradox](../participation_no_show/) · [Condorcet cycles](../../05_Ranked_Robin/concepts/cycle_resolution.md) · glossary [`reversal symmetry`](../../00_start_here/GLOSSARY.md).

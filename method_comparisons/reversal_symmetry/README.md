...
→ Related: [IRV non-monotonicity](../../06_Other/RCV_IRV/concepts/RCV_IRV_non_monotonicity.md) · [the participation / no-show paradox](../participation_no_show/) · [Condorcet cycles](../../05_Ranked_Robin/concepts/cycle_resolution.md) · glossary [`reversal symmetry`](../../00_start_here/GLOSSARY.md).
...
- **The failure is real and IRV-specific** — worth knowing, and a clean symptom of the same root cause as [center squeeze](../../00_start_here/topics/center_squeeze/) and [non-monotonicity](../../06_Other/RCV_IRV/concepts/RCV_IRV_non_monotonicity.md): IRV eliminates on *first-choice counts*, so reversing preferences doesn't cleanly reverse the outcome.
...
- **Two of the source's other "disasters" are things we already cover.** The page's "strategic reversal" twist (raising A from bottom to top makes A *lose*) is plain [non-monotonicity](../../06_Other/RCV_IRV/concepts/RCV_IRV_non_monotonicity.md); its "no-show" twist is the [participation paradox](../participation_no_show/). Nothing new there.

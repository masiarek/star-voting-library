...
**2. [Spoiler effect](../../07_Concepts/topics/spoiler_effect.md).** Remove the *losing* candidate Palin from the ballots entirely, and **Begich wins** (his voters plus Palin's transfers beat Peltola). Palin could not win — but her *presence* changed who did. That is the textbook definition of a spoiler, and RCV-IRV is marketed as the method that *ends* spoilers.

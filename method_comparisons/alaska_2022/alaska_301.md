...
Every one of these traces to the **same** mechanism: **eliminating candidates on first-choice counts.** Methods that read the whole ballot — Ranked Robin, any [Condorcet method](../../07_Concepts/topics/condorcet/README.md), and STAR through its runoff — avoid all five, because none of them gate survival on first choices.

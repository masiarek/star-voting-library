...
- **[Ranked Robin](../../05_Ranked_Robin/01_Learn/ranked_robin.md)** (a different way to count the *same* ranked ballots) checks every one-on-one matchup directly. It sees Begich beat both → **Begich wins.**
- **[STAR](../../01_STAR/01_Learn/STAR_start_here.md)** (a scored ballot) adds up how highly everyone rated each candidate. Begich's pile of "2nd-choice" support shows up as lots of 4s → he reaches the final → **Begich wins.**

...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/same_matrix_p3_ranked_robin_tabulated.txt) (regenerated on every run; every analysis forced on).

...
**Method:** [Ranked Robin (RCV-RR / Copeland)](../../../../05_Ranked_Robin/01_Learn/README.md) · **1 seat** · **Expected winner:** Berry
...
Win–loss record — Copeland score = wins + ½·ties (highest score wins; ties broken by the Ranked Robin degrees, then lot order):
    ...
    1  Berry      1–1–0         1      +2            +2  Cocoa
    2  Almond     1–1–0         1      +0             0  Berry
    3  Cocoa      1–1–0         1      -2            -2  Almond

Winner — Ranked Robin (RCV-RR): Berry
   *** 3 candidates tie for the most wins (Almond, Berry, Cocoa) — a Condorcet cycle (no candidate beats all others). Resolved by the 1st Degree tiebreaker: Berry has the greatest sum of win margins over the other finalists (+2). (This is where Minimax / Ranked Pairs / Schulze differ — see 05_Ranked_Robin/01_Learn/cycle_resolution.md.)
```
<!-- --8<-- [end:report] -->

...
Everything in one file: the [`_tabulated` mirror](../food_truck_row_tabulated/bv2210_fvg8y8_star_pr_share_tabulated.txt) (regenerated on every run; every analysis forced on).

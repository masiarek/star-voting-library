...
Full report from the [`_tabulated` mirror](../postit_rcv_example_tabulated/bv2176_p8dp28_ranked_robin_tabulated.txt) (regenerated on every run; every analysis forced on):
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/postit_rcv_example/bv2176_p8dp28_ranked_robin.yaml
```
...
More cases in this set: [bv2176_p8dp28_irv](bv2176_p8dp28_irv.md) · [bv2176_p8dp28_star](bv2176_p8dp28_star.md)

...
One of five races in the Pets Governance demo (LH-only). Same 22 voters, same
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/pets_governance/pets_gov_star_pr.yaml
```
...
More cases in this set: [pets_gov_approval](pets_gov_approval.md) · [pets_gov_bloc_star](pets_gov_bloc_star.md) · [pets_gov_ranked_robin](pets_gov_ranked_robin.md) · [pets_gov_stv](pets_gov_stv.md)

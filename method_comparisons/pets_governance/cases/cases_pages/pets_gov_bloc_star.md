...
**Method:** [Bloc STAR (multi-winner, majoritarian)](../../../../02_STAR_Bloc/01_Learn/README.md) · **3 seats** · **Expected winners:** Dog, Fish, Cat
...
[Condorcet Loser]
  No strict Condorcet loser; jointly weak Condorcet losers: Rabbit, Hamster (winless — pairwise ties)
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/pets_governance/cases/pets_gov_bloc_star.yaml
```

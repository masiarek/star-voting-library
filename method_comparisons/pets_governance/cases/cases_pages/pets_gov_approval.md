...
**Method:** [Approval Voting](../../../../04_Approval/concepts) · **2 seats** · **Expected winners:** Dog, Cat
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/pets_governance/cases/pets_gov_approval.yaml
```

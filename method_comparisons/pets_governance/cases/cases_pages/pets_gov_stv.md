...
**Method:** [STV (proportional, ranked ballots)](../../../../03_STAR_PR/01_Learn/README.md) · **3 seats** · **Expected winners:** Dog, Bird, Cat
...
Hamster), voting ranked ballots. This 3-seat Delegates race uses STV
(hand-count Droop quota = floor(22/4)+1 = 6; the report below applies the other
standard form, the exact 22/4 = 5.50 — same seats). The majority (13) meets two quotas and the minority

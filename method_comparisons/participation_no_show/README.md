...
Concept hubs: [Participation](../../07_Concepts/topics/participation/README.md) · [monotonicity](../../07_Concepts/topics/monotonicity/README.md) (same elimination machinery) · the paradox-catalog page: [no-show](../../07_Concepts/voting_paradoxes/no_show.md) · up: [method_comparisons — same ballots, different methods](../README.md)

...
Concept hubs: [Participation](../../07_Concepts/topics/participation/) · [monotonicity](../../07_Concepts/topics/monotonicity/) (same elimination machinery) · the paradox-catalog page: [no-show](../../07_Concepts/voting_paradoxes/no_show.md) · up: [method_comparisons — same ballots, different methods](../)

...
**Method:** [STAR (single winner)](../../../../01_STAR/01_Learn/README.md) · **1 seat** · **Expected winner:** April
...
(see 07_Concepts/topics/participation/). Identical to
...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/bv2175_9dhv8y_noshow_showup_RCV-IRV_tabulated.txt
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/bv2175_9dhv8y_noshow_showup_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/participation_no_show/cases/bv2175_9dhv8y_noshow_showup.yaml
```

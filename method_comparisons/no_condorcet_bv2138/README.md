...
Full field (Cora, Erin also win under other methods): see the lesson page. Up: [method_comparisons](../) · sibling: [center_squeeze_bv2137](../center_squeeze_bv2137/) · field guide: [ranked-ballot method zoo](../../07_Concepts/topics/ranked_ballot_methods_zoo.md)

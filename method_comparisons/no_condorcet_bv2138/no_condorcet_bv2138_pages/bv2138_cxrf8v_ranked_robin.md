...
Full report from the [`_tabulated` mirror](../no_condorcet_bv2138_tabulated/bv2138_cxrf8v_ranked_robin_tabulated.txt) (regenerated on every run; every analysis forced on):
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py method_comparisons/no_condorcet_bv2138/bv2138_cxrf8v_ranked_robin.yaml
```

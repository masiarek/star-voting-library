...
Everything in one file: the [`_tabulated` mirror](../summability_demo_tabulated/star_district_B_tabulated.txt) (regenerated on every run; every analysis forced on).

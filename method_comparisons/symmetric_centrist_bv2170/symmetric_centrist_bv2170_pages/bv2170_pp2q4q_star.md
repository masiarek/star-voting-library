...
Everything in one file: the [`_tabulated` mirror](../symmetric_centrist_bv2170_tabulated/bv2170_pp2q4q_star_tabulated.txt) (regenerated on every run; every analysis forced on).

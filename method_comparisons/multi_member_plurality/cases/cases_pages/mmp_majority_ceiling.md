...
**Method:** [plurality](../../../../00_start_here) · **3 seats** · **Expected winners:** Alice, Bruno, Cleo

**Official tie-break (lot) order:** Alice > Bruno > Cleo > Dev > Esme — consulted only if every deterministic tiebreaker stays tied ([how the ladder works](../../../../00_start_here/STAR_Voting/Tie_Breaking_STAR/tie_breaking.md)).

...
More cases in this set: [mmp_block_approval](mmp_block_approval.md) · [mmp_block_voting](mmp_block_voting.md) · [mmp_limited_voting](mmp_limited_voting.md) · [mmp_majority_block_runoff](mmp_majority_block_runoff.md) · [mmp_minority_sweep](mmp_minority_sweep.md) · [mmp_sntv](mmp_sntv.md) · [mmp_sweep_floor](mmp_sweep_floor.md)

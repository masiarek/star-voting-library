...
| [`00_start_here/YAML_test_case_index/`](00_start_here/YAML_test_case_index/README_YAML_test_case_index.md) | **Auto-generated catalog of every election YAML, grouped by voting method** (`scripts/build_yaml_index.py`; a pytest keeps it current). Browse cases by method without moving files. |
| `*_tabulated/` | Generated plain-text tabulation copies (regenerated by re-running the YAMLs). |
| [`00_start_here/`](00_start_here/00_START_HERE.md) | The docs hub — curriculum, concept pages, glossary, terminology, organization. |
| [`00_start_here/conversation_scripts.md`](00_start_here/conversation_scripts.md) | Larry ↔ Adam debate / teaching scripts — index; episodes live beside their topics. |

...
**Method:** [STAR (single winner)](../../../concepts) · **1 seat** · **Expected winner:** None of the Above
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/none_of_the_above/cases/bv215_26khr3_nota_wins.yaml
```

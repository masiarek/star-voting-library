...
Run it yourself: [`bv2184_fyy886_lunch_vote.yaml`](../_main/cases/bv2184_fyy886_lunch_vote.yaml) · [reader page](../_main/cases/cases_pages/bv2184_fyy886_lunch_vote.md) · **[see it live on BetterVoting ↗](https://bettervoting.com/fyy886/results)**.
...
|---|---|---|
| **Three candidates** | [one ballot](../_main/cases/cases_pages/02a_c3_b1_three-candidates.md) · [two ballots](../_main/cases/cases_pages/02b_c3_b2_three-candidates.md) | A third option, and the winner becomes the broad compromise — the lunch, formalized in the smallest possible way. |
| **Ways to vote** | [the eight-style gallery](../_main/cases/cases_pages/03c_c6_b8_style-gallery.md) | Bullet votes, equal scores, "anyone but…" — all the honest ways to fill it out. |

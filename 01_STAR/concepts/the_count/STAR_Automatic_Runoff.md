...
It also keeps the ballot **honest**. Without a runoff, the smart way to vote in a pure scoring election is to give your favorite a 5 and everyone else a 0 — any in-between score only helps a rival catch up. If everyone does that, the 0–5 ballot collapses to just 0s and 5s, which is **[Approval voting](../../../07_Concepts/GLOSSARY.md)**: strategic score voting *degenerates into Approval*, and the expressive scale stops meaning anything. STAR's runoff removes that incentive — because it only asks which finalist you scored higher, your honest 3s and 4s still do real work, so you never have to exaggerate. **The runoff is what lets STAR keep an expressive ballot people can use honestly.**

...
- **Pure majority / ranked methods** respect numbers, but a bare ranking throws away *how much* you prefer one candidate to the next, and (in the case of RCV-IRV) the elimination machinery brings its own [pathologies](../../../06_Other/RCV_IRV/concepts/RCV_IRV_non_monotonicity.md).
...
→ run [`runoff_overturns_leader/01a_c3_b3_more-stars-fewer-voters.yaml`](../../runoff_overturns_leader/cases/01a_c3_b3_more-stars-fewer-voters.yaml)

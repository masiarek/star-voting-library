...
→ Related: the simpler two-way case, [Runoff Reversal](../../runoff_overturns_leader/) (score leader ≠ STAR winner). Glossary: [`Condorcet winner`](../../../00_start_here/GLOSSARY.md).
...
→ [`three_winners_cw_score_runoff.yaml`](../../_main/cases/three_winners_cw_score_runoff.yaml) — five voters, three candidates:

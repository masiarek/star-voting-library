...
Same root cause as STAR's [favorite-betrayal](favorite_betrayal_voting_301.md) and [center-squeeze](../../../06_Other/RCV_IRV/concepts/RCV_IRV_center_squeeze.md) edge cases: all three come from "only the top two advance."

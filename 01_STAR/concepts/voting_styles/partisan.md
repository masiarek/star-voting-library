...
In the runnable [style-gallery election](../../_main/cases/cases_pages/03c_c6_b8_style-gallery.md), the partisan row is `5,5,0,0,0,5` — a three-candidate slate. Two of the slate's own 5s (Bianca and Frank) became the finalists, so this ballot sat the runoff out as Equal Support — precisely the "teammates in the final" edge case above, caught live in a six-candidate race.

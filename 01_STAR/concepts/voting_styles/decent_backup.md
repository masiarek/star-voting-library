...
In the runnable [style-gallery election](../../_main/cases/cases_pages/03c_c6_b8_style-gallery.md), the decent-backup row is `0,5,0,0,0,4` — Bianca 5, Frank 4. Both of this voter's picks became the finalists: the 4 helped Frank get there, the 5-vs-4 gap sent the ballot's full runoff vote to Bianca, and Bianca won. One ballot, both jobs done, nothing sacrificed.

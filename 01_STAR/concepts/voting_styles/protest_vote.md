...
In the runnable [style-gallery election](../../_main/cases/cases_pages/03c_c6_b8_style-gallery.md), the protest row is `0,0,0,0,0,1` — one star for Frank, nothing for anyone else. Frank made the final, so this near-silent ballot cast a full runoff vote for him (he lost the runoff 4–2, but the vote was heard). The dedicated small demo of a protest ballot deciding a race outright: [reader page](../../_main/cases/cases_pages/03b_c3_b3_1_style-protest-vote.md) · [`03b_c3_b3_1_style-protest-vote.yaml`](../../_main/cases/03b_c3_b3_1_style-protest-vote.yaml).

...
→ Companions: [Equal Support in both rounds (the demo)](../../_main/cases/cases_pages/equal_support_runoff_demo.md) · [the Automatic Runoff](../the_count/STAR_Automatic_Runoff.md) · ["exhausted ballots," untangled](../../../06_Other/RCV_IRV/concepts/exhausted_ballots_301.md) · [common misunderstandings](../getting_started/common_misunderstandings.md) · Glossary: [`Equal Support`](glossary_STAR.md)
...
One is missing data; the other is present data that happens to be neutral. Treating "I am equally happy with either winner" as a *failure to be counted* is the part of the criticism that doesn't survive contact. The full taxonomy of what "exhausted" hides is its own page: [exhausted ballots, untangled](../../../06_Other/RCV_IRV/concepts/exhausted_ballots_301.md).

## Proof they're counted: an election where equal-score ballots pick the finalists

Run [`equal_support_runoff_demo.yaml`](../../_main/cases/equal_support_runoff_demo.yaml) ([reader page](../../_main/cases/cases_pages/equal_support_runoff_demo.md)). 100 voters: 40 score **both A and B a 5** (love both, C = 0), 35 prefer A over B (5 vs 3), 25 want only C.

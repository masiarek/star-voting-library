...
**One line:** the LH `starvote` engine prints a **full text audit report** — every number that produced the winner, in order — and saves a maximal `_tabulated.txt` copy of it. This page is the reporting-lens summary; the section-by-section walk is [Reading a STAR report](../../../../00_start_here/tabulation_engines/LH_starvote/reading_a_star_report.md).

→ Hub: [STAR Reporting](../) · the engine itself: [BetterVoting and the LH engine](../../../../00_start_here/tabulation_engines/bettervoting_and_the_engine.md) · [`GLOSSARY`](../../../../00_start_here/GLOSSARY.md).
...
It names the decided count *against the total* with the Equal Support gap inline, so the denominator never has to be inferred. (→ the two-denominator idea: [Runoff percentages](../../the_count/runoff_percentages.md).)
...
See it on a real election: [the pet race report](../../../pet_real_bv_election/).

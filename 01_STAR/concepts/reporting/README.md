...
1. **Counts / scores** — add every star; each candidate gets a total. (STAR is *summable*: precinct totals add up. → [STAR summability](../properties_and_limits/STAR_summability.md))
...
|---|---|---|
| Pet race, 461 ballots | **`pet`** → [bettervoting.com/pet/results](https://bettervoting.com/pet/results) | [`best_pet_c7_b461_tabulated.txt`](../../pet_real_bv_election/cases/cases_tabulated/best_pet_c7_b461_tabulated.txt) · [lesson](../../pet_real_bv_election/) |
| 3-candidate flat-scores | **`dq2dmm`** | [`flat_scores_abstention_c3_b8_tabulated.txt`](../../pet_real_bv_election/cases/cases_tabulated/flat_scores_abstention_c3_b8_tabulated.txt) · [lesson](../../pet_real_bv_election/small_case_abstention_lesson.md) |
| 2-candidate minimal | **`3w6v4b`** | [`small_abstention_c2_b5_tabulated.txt`](../../pet_real_bv_election/cases/cases_tabulated/small_abstention_c2_b5_tabulated.txt) · [lesson](../../pet_real_bv_election/small_abstention_c2_b5_lesson.md) |
| Runoff tie | *(create one — see [ties](reporting_ties.md))* | [`02b_c3_b2_three-candidates_tabulated.txt`](../../_main/cases/cases_tabulated/02b_c3_b2_three-candidates_tabulated.txt) |

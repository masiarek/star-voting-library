...
→ Hub: [STAR Reporting](../) · the mapping in full: [BetterVoting and the LH engine](../../../../00_start_here/tabulation_engines/bettervoting_and_the_engine.md) · the percentages: [Runoff percentages](../../the_count/runoff_percentages.md).

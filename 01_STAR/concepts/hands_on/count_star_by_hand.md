...
A stack of ballots. Each ballot has a **0–5 score for every candidate** (blank counts as 0). That's it. We'll use the [team-lunch election](../../_main/cases/cases_pages/bv2184_fyy886_lunch_vote.md) — 5 voters choosing **Sushi, Tacos, or Pizza**:

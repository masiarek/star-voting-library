...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/tie_break_06_scoring_dead_rung_adversarial_lot_RCV-IRV_tabulated.txt
  RCV-RR round-robin: cases_tabulated/tie_break_06_scoring_dead_rung_adversarial_lot_RCV-RR_tabulated.txt
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/tie_break_06_scoring_dead_rung_adversarial_lot_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/03_Criteria/tie_break_dead_rung/cases/tie_break_06_scoring_dead_rung_adversarial_lot.yaml
```

...
Legend: For - Equal Support - Against
        * indicates Top 2 Finalist
        Note: A, B and C tied at 4 in the Scoring Round, and the lot rung (the
              ballots could not separate them) advanced A and B. The * marks
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/03_Criteria/tie_break_dead_rung/three_way_dead_rung_tie/three_way_dead_rung_A.yaml
```

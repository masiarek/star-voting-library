...
python STARVote_LH_tabulation_engine/tools_adam/two_way_import.py \
  01_STAR/03_Criteria/tie_break_dead_rung/lot_random_vs_published_jfk7pd/lot_random_vs_published_jfk7pd_bv_export.json
...
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py \
  01_STAR/03_Criteria/tie_break_dead_rung/lot_random_vs_published_jfk7pd/lot_random_vs_published_jfk7pd_bv_order.yaml
```
...
- STAR's tie-break ladder and the **dead rung** (why five-star counts only 5s, never steps down to 4s): [The "dead rung"](../README.md) · [STAR Tie-Breaking — The Full Chain](../../../01_Learn/Tie_Breaking_STAR/tie_breaking.md).

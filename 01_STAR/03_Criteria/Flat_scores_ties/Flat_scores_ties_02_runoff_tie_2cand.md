...
→ [STAR Tie-Breaking](../../01_Learn/Tie_Breaking_STAR/tie_breaking.md) · [reporting true ties](../../01_Learn/reporting/reporting_ties.md) · [`GLOSSARY` (Equal Support)](../../../07_Concepts/GLOSSARY.md) · [Flat scores, ties & tie-breaking (all cases)](README.md).

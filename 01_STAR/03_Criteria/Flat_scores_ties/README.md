...
```
uv run python STARVote_LH_tabulation_engine/starvote_larry_hastings.py "01_STAR/03_Criteria/Flat_scores_ties/cases/Flat_scores_ties_05_scoring_tie_3way_xmyf7k.yaml"
```

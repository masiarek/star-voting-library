...
→ the cascade: [STAR Tie-Breaking](../../01_Learn/Tie_Breaking_STAR/tie_breaking.md) · [reporting true ties](../../01_Learn/reporting/reporting_ties.md) · the RR analog: [rr_tiebreak_lh_vs_bv.md](../../../05_Ranked_Robin/01_Learn/rr_tiebreak_lh_vs_bv.md) · [Flat scores, ties & tie-breaking (all cases)](README.md).

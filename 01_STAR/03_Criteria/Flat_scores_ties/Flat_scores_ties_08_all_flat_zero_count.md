...
→ Equal Support vs abstention: [`GLOSSARY`](../../../07_Concepts/GLOSSARY.md) · the same bug worked end-to-end: [`Runoff_07`](../../04_Real_Elections/runoff_reversal_bv_cases/Runoff_07_flat_ballot_bv_bug_tf73v9.md), [`small_case_abstention_lesson`](../../04_Real_Elections/pet_real_bv_election/small_case_abstention_lesson.md) · [STAR Tie-Breaking](../../01_Learn/Tie_Breaking_STAR/tie_breaking.md) · [Flat scores, ties & tie-breaking (all cases)](README.md).

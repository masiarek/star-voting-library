...
[Condorcet Loser]
  Condorcet Loser: Flux — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/03_Criteria/equal_and_opposite/cases/bv2220_q8q9m7_equal_opposite_plus_cancel.yaml
```

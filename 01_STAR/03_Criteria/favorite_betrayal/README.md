...
The [301 page](../../01_Learn/properties_and_limits/favorite_betrayal_voting_301.md) claims STAR's FBC failures are "fragile and unactionable." This case *demonstrates* the fragility rather than asserting it:
...
```
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/03_Criteria/favorite_betrayal/cases/bv2206_7mckyg_fbc_honest_tepid_consensus.yaml
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/03_Criteria/favorite_betrayal/cases/bv2207_b6xrdr_fbc_betrayal_pays.yaml
```
...
**Where this comes from.** Ballots and cast are this repo's own, built to instantiate the finalist-pairing mechanism described in [favorite_betrayal_voting_301.md §5](../../01_Learn/properties_and_limits/favorite_betrayal_voting_301.md) ("your scores can change *which two candidates are finalists*"). Related: [runoff reversal](../../02_Examples/runoff_overturns_leader/README.md) (the benign face of the same score-vs-runoff two-step) · [residual vote splitting](../../01_Learn/properties_and_limits/residual_vote_splitting.md) (the other runoff-born edge case) · [monotonicity](../../../method_comparisons/monotonicity/README.md) (STAR's clean bill on the *raise* direction).

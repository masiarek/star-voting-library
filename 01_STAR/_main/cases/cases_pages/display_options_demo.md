...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/display_options_demo_RCV-IRV_tabulated.txt
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/_main/cases/display_options_demo.yaml
```

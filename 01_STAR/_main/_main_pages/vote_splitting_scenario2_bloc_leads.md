...
Everything in one file: the [`_tabulated` mirror](../_main_tabulated/vote_splitting_scenario2_bloc_leads_tabulated.txt) (regenerated on every run; every analysis forced on).

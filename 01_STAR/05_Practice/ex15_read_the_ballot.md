...
The giveaway that it isn't [STAR](../01_Learn/STAR_start_here.md), by the way, is that nothing in the prompt mentions a runoff — the ballots are identical. **A ballot alone never fully identifies the method**; Score and STAR share this one, which is the whole point of [exercise 3](ex03_five_verdicts.md).
...
- [Approval Voting](../../04_Approval/01_Learn/approval_voting.md) · [Approval in the theory literature](../../04_Approval/01_Learn/approval_in_the_literature.md)

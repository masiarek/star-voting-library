...
Approve = 3+: the ×4 bloc approves {Apple, Cherry}, the ×3 bloc {Banana, Cherry}, the ×2 bloc {Cherry}. Totals: **Cherry 9 of 9**, Apple 4, Banana 3. The candidate with the *fewest* first choices carries *every single voter* — that's the information Choose-One throws away. (More on the bridge rule and its lean: [Approval Voting](../../04_Approval/01_Learn/README.md).)
...
```
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/05_Practice/cases/ex03_five_verdicts.yaml
```

...
**Method:** [STAR (single winner)](../01_Learn/README.md) · **1 seat** · **Expected winner:** Baiul · [full count →](cases/cases_pages/ex04_olympics_1994.md)
<!-- case-meta:end -->
...
```
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/05_Practice/cases/ex04_olympics_1994.yaml
```

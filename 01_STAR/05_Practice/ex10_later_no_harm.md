...
**You practice:** the **[later-no-harm](../../07_Concepts/GLOSSARY.md)** criterion — the one RCV-IRV keeps and STAR deliberately gives up — run live in both directions, and the discipline of keeping it distinct from [favorite betrayal](../01_Learn/properties_and_limits/favorite_betrayal_voting_301.md).
...
- **STAR fails later-no-harm** (this exercise) — knowingly: [equal.vote's own materials concede it](../01_Learn/properties_and_limits/STAR_honest_limits.md), because honoring compromise support is the design goal.
- **RCV-IRV keeps later-no-harm but fails [favorite betrayal](../01_Learn/properties_and_limits/favorite_betrayal_voting_301.md)** structurally (center squeeze pushes lesser-evil ranking), plus the squeeze itself — the price of not counting lower preferences until eliminations force it.
...
**Where this comes from.** Original to this repo (ballots and cast). Concept homes: the glossary's [later-no-harm entry](../../07_Concepts/GLOSSARY.md), [favorite betrayal 301](../01_Learn/properties_and_limits/favorite_betrayal_voting_301.md) (why the two criteria must not be conflated), and [STAR's honest limits](../01_Learn/properties_and_limits/STAR_honest_limits.md).

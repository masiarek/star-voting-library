...
**Method:** [STAR (single winner)](../../../concepts) · **1 seat** · **Expected winner:** Eden
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/runoff_reversal_bv_cases/cases/Runoff_03_enthusiasts_vs_majority_rkgtpk.yaml
```

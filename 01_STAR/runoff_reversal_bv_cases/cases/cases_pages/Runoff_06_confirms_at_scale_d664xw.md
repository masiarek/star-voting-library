...
**Method:** [STAR (single winner)](../../../concepts) · **1 seat** · **Expected winner:** Wren
...
[Condorcet Loser]
  Condorcet Loser: Zinnia — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/runoff_reversal_bv_cases/cases/Runoff_06_confirms_at_scale_d664xw.yaml
```

...
**Method:** [STAR (single winner)](../../../concepts) · **1 seat** · **Expected winner:** Sage
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/runoff_reversal_bv_cases/cases/Runoff_05_reversal_with_equal_support_xgkw3w.yaml
```

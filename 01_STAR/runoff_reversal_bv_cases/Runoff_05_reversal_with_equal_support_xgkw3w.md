...
Watch the Runoff Table here: **% Between Finalists** is out of 3 (67% / 33%), but **% Runoff Votes** is out of all 5 — the two denominators side by side. ([Runoff percentages](../concepts/the_count/runoff_percentages.md).)
...
> **BV ↔ LH wording.** `3 of 5 (2 Equal Support). Sage 2 (67%) vs Rosa 1 (33%)` packs BetterVoting's *Runoff Votes* (2 / 1), *% Between Finalists* (67% / 33%), and the Equal-Support count (2) into one line that names its denominator. [Why the words differ →](../concepts/reporting/reporting_diff_BV_LH.md#same-numbers-different-words)

...
- **The vote-splitting / center-squeeze critique of IRV is correct and load-bearing** — and it has actually happened: [Burlington 2009](../../../method_comparisons/burlington_2009/README.md), [Alaska 2022](../../../method_comparisons/alaska_2022/README.md).
...
| IRV's center-squeeze spoiler, on real ballots | [Center squeeze](../../../06_Other/RCV_IRV/concepts/RCV_IRV_center_squeeze.md) · [Alaska 2022](../../../method_comparisons/alaska_2022/README.md) · [Burlington 2009](../../../method_comparisons/burlington_2009/README.md) |
...
| STAR ≈ Smith/Minimax at the top → so where do they *disagree*? | [Ranked Robin](../../../05_Ranked_Robin/01_Learn/README.md) · [30 STAR≠RR divergence samples](../../../05_Ranked_Robin/02_Examples/star_vs_rr_divergence/README.md) |
...
> **The companion article.** The next ten pages of the same issue — *Constitutional Political Economy* **34(3): 335–345** — are the Approval camp's parallel case: **Hamlin & Hua, "The case for approval voting."** Same journal, same issue, the rival cardinal method, argued by its own advocacy organisation. It gets [the same treatment](../../../04_Approval/01_Learn/hamlin_hua_2023.md), and its §4.1 example is [runnable here](../../../method_comparisons/approval_majority_criterion/README.md).

...
For **multi-winner** elections the equal-vote idea extends to **Vote Unitarity** (Keith Edmonds) — an equal vote *plus* proportionate spending — which motivates proportional score methods like **Sequentially Spent Score (SSS)**. See [proportional: STV vs STAR-PR](../../../method_comparisons/stv_vs_star_pr/README.md) for that thread, and [the two bullet voters](../../../03_STAR_PR/03_Criteria/vote_unitarity/README.md) for the seven-voter election where the principle visibly decides a seat.

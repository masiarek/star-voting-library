...
→ Companion critical pages so every method gets the same treatment: [Approval's limits](../../../04_Approval/01_Learn/approval_honest_limits.md) · [Ranked Robin (RCV-RR) limits](../../../05_Ranked_Robin/01_Learn/RCV_RR_honest_limits.md) · [RCV-IRV fails the Equal Vote](../../../06_Other/RCV_IRV/concepts/RCV_IRV_equal_vote.md). Curriculum: [301.4 — honest limits](../../../07_Concepts/CURRICULUM.md).

---

## 1. Not Condorcet-compliant

STAR can fail to elect the **[Condorcet winner](../../../07_Concepts/topics/condorcet/README.md)** (the candidate who beats every other one head-to-head). Its runoff is between the *top two by score*, and the Condorcet winner can be a close third on score and never reach the runoff. **How much it matters:** simulations put STAR's Condorcet-efficiency high but not uniform — [measured](../../../07_Concepts/topics/condorcet/condorcet_efficiency_measured.md) at 92–99% with three candidates and 74–92% as the field grows, so "very high" is fair for a small field and overstated for a crowded one. When it diverges the STAR winner is someone with very broad support who lost one pairing narrowly. It's a **tradeoff**, not a clean loss — Condorcet methods buy compliance by sometimes electing a weakly-supported compromise nobody is enthusiastic about. See [three notions of "winner"](STAR_three_winner_notions.md). A sharper, mechanical instance: when the electorate has a genuine Condorcet **cycle** (no Condorcet winner at all), STAR's runoff is even **[IIA](../../../07_Concepts/topics/what_makes_a_voting_method_good.md)-sensitive** — a candidate who cannot win can flip the result by changing which two candidates reach the runoff. Worked, BV-backed, on fully sincere ballots: [the cycle spoiler](../../03_Criteria/iia_cycle_spoiler/bv2212_g3f7r2_cycle_spoiler.md).
...
**The defenders' reply.** Equal Vote argues the *strict* criterion over-weights a bare 50.1%-first-choice while ignoring how strongly the other half feels, and proposes a weaker **[Relaxed Majority Criterion](https://www.equal.vote/rmc)** — which STAR *does* satisfy, because its automatic runoff guarantees the winner is the majority-preferred of the two finalists. Whether the strict or relaxed version is the better yardstick is a value judgment, not a settled fact — and the strict criterion is provably incompatible with some other desirable properties, so *some* method must fail it. Full plain-language explainer (with the two-tiny-elections demo, the RMC definition, the Later-No-Harm link, and references): the **[Majority Criterion topic hub](../../../07_Concepts/topics/majority_criterion/README.md)**. Worked demonstration of the polarizing-favorite-vs-consensus case: the [Black Curtain set](../../../method_comparisons/black_curtain/README.md) (esp. "a polarizing winner" and "a hidden consensus"). Comparison context: [RCV-IRV vs STAR](../../../07_Concepts/topics/rcv_irv_vs_star.md).

## Keep it in perspective

Every method trades something away — that's [Arrow](../../../07_Concepts/topics/what_makes_a_good_winner.md) and Gibbard, not a STAR-specific flaw. The honest comparison is *which* tradeoffs, and how often they bite. STAR's limits are mostly rare edge cases or deliberate, well-motivated choices; its opponents' (and peers') limits are laid out just as plainly on the companion pages above, so you can judge the whole board rather than one square.

...
→ Up: [How the LH engine reports](README.md) · hub: [STAR Reporting](../README.md) · house defaults: [CLAUDE.md — working guidance for this repo](../../../../CLAUDE.md).

---

## The block, option by option

This is the block from the 3-candidate demo ([`flat_scores_abstention_c3_b8.yaml`](../../../04_Real_Elections/pet_real_bv_election/cases/flat_scores_abstention_c3_b8.yaml)):

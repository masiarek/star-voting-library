...
**Method:** [STAR (single winner)](../../../concepts) · **1 seat** · **Expected winner:** C

**Official tie-break (lot) order:** C > A > B — consulted only if every deterministic tiebreaker stays tied ([how the ladder works](../../../concepts/Tie_Breaking_STAR/tie_breaking.md)).

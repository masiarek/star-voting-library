...
Full report from the [`_tabulated` mirror](../tie_break_dead_rung_tabulated/dead_rung_scoring_dead_cap4_tabulated.txt) (regenerated on every run; every analysis forced on):

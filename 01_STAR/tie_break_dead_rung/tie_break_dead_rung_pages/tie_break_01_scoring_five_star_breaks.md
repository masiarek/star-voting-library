...
Everything in one file: the [`_tabulated` mirror](../tie_break_dead_rung_tabulated/tie_break_01_scoring_five_star_breaks_tabulated.txt) (regenerated on every run; every analysis forced on).

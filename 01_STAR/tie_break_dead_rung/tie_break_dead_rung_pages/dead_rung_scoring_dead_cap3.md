...
Everything in one file: the [`_tabulated` mirror](../tie_break_dead_rung_tabulated/dead_rung_scoring_dead_cap3_tabulated.txt) (regenerated on every run; every analysis forced on).

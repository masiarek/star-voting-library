...
**Method:** [STAR (single winner)](../../../concepts) · **1 seat** · **Expected winner:** Ben

**Official tie-break (lot) order:** Ben > Ann — consulted only if every deterministic tiebreaker stays tied ([how the ladder works](../../../concepts/Tie_Breaking_STAR/tie_breaking.md)).
...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/tie_break_08_runoff_dead_rung_adversarial_lot_RCV-IRV_tabulated.txt
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/tie_break_08_runoff_dead_rung_adversarial_lot_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/tie_break_dead_rung/cases/tie_break_08_runoff_dead_rung_adversarial_lot.yaml
```

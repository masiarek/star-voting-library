...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/tie_break_09_five_star_tied_nonzero_RCV-IRV_tabulated.txt
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/tie_break_dead_rung/cases/tie_break_09_five_star_tied_nonzero.yaml
```

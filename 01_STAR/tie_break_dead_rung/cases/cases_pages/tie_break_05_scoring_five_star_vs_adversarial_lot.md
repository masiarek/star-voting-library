...
[Divergence from STAR]
  ...
  RCV-IRV rounds: cases_tabulated/tie_break_05_scoring_five_star_vs_adversarial_lot_RCV-IRV_tabulated.txt
  RCV-RR round-robin: cases_tabulated/tie_break_05_scoring_five_star_vs_adversarial_lot_RCV-RR_tabulated.txt
...
[Condorcet Loser]
  No strict Condorcet loser; weak Condorcet loser: Cara (never wins a matchup) — elected by Choose-One (Plurality)!
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/tie_break_dead_rung/cases/tie_break_05_scoring_five_star_vs_adversarial_lot.yaml
```

## See also

- [Methods disagree on this election](../../../../method_comparisons/divergence_review/cases/CYCLE_OR_THREE_WAY/tie_break_05_scoring_five_star_vs_adversarial_lot.md) — its entry in the divergence review ledger

...
Full context and the wider ticket map: [BV abstain / blank / zero — issue index](../../00_start_here/tabulation_engines/BV/abstain_issues_index.md) · concept: [abstention vs a zero vs None of the Above](../concepts/properties_and_limits/abstention_vs_zero_vs_nota.md).

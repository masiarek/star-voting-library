...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/02b_c3_b2_three-candidates_tabulated.txt) (regenerated on every run; every analysis forced on).

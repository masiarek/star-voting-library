...
[Condorcet Loser]
  Condorcet Loser: Ira — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/02_Examples/cases/06a_c9_b3_large-field-equal-support.yaml
```

...
|:--|:--:|:--:|:--:|
| <img src="../img/vote_splitting3_ballot_1.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — 8 voters — love dark, like milk, vanilla is OK: DarkChoco 5, MilkChoco 4, Vanilla 3."> | 5 | 4 | 3 |
| <img src="../img/vote_splitting3_ballot_2.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — 7 voters — love milk, like dark, no vanilla: DarkChoco 4, MilkChoco 5, Vanilla 0."> | 4 | 5 | 0 |
| <img src="../img/vote_splitting3_ballot_3.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — 6 voters — love vanilla, mild on chocolate: DarkChoco 2, MilkChoco 1, Vanilla 5."> | 2 | 1 | 5 |

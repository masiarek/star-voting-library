...
**Method:** [STAR (single winner)](../../../01_Learn/README.md) · **1 seat** · **Expected winner:** Bob
...
|:--:|:--|:--:|:--:|:--:|
| 1 | <img src="../img/three_winners_cw_score_runoff_ballot_1.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — Voter 1: Ann 5, Bob 4, Carl 3."> | 5 | 4 | 3 |
| 2 | <img src="../img/three_winners_cw_score_runoff_ballot_2.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — Voter 2: Ann 5, Bob 4, Carl 3."> | 5 | 4 | 3 |
| 3 | <img src="../img/three_winners_cw_score_runoff_ballot_3.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — Voter 3: Ann 5, Bob 4, Carl 3."> | 5 | 4 | 3 |
| 4 | <img src="../img/three_winners_cw_score_runoff_ballot_4.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — Voter 4: Ann 0, Bob 3, Carl 5."> | 0 | 3 | 5 |
| 5 | <img src="../img/three_winners_cw_score_runoff_ballot_5.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — Voter 5: Ann 0, Bob 3, Carl 5."> | 0 | 3 | 5 |
...
[Condorcet Loser]
  Condorcet Loser: Carl — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/02_Examples/cases/three_winners_cw_score_runoff.yaml
```

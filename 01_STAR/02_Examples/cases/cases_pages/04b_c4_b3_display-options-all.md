...
[Condorcet Loser]
  Condorcet Loser: Choco — loses every head-to-head matchup
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/04b_c4_b3_display-options-all_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/02_Examples/cases/04b_c4_b3_display-options-all.yaml
```

...
**Method:** [STAR (single winner)](../../../01_Learn) · **1 seat** · **Expected winner:** Don
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/02_Examples/cases/display_options_demo.yaml
```

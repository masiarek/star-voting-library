...
**Method:** [STAR (single winner)](../../../../01_Learn) · **1 seat** · **Expected winner:** Boston
...
[Condorcet Loser]
  No strict Condorcet loser; jointly weak Condorcet losers: Chicago, Denver (winless — pairwise ties)
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/02_Examples/runoff_overturns_leader/cases/02_c5_b5_leader-overturned.yaml
```

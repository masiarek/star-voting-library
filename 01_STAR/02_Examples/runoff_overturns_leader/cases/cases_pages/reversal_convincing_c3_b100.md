...
**Method:** [STAR (single winner)](../../../../01_Learn/README.md) · **1 seat** · **Expected winner:** Nora
...
| # | Ballot as marked | Max | Nora | Cal |
|:--:|:--|:--:|:--:|:--:|
| 1 | <img src="../img/reversal_convincing_c3_b100_ballot_1.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — 45 voters — Max's intense base — love Max, mildly prefer Nora to Cal: Max 5, Nora 2, Cal 0."> | 5 | 2 | 0 |
| 2 | <img src="../img/reversal_convincing_c3_b100_ballot_2.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — 55 voters — the majority — mildly prefer Nora: Max 2, Nora 3, Cal 1."> | 2 | 3 | 1 |
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/02_Examples/runoff_overturns_leader/cases/reversal_convincing_c3_b100.yaml
```

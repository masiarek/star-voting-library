...
**Method:** [STAR (single winner)](../../../../01_Learn/README.md) · **1 seat** · **Expected winner:** ChocoAlm
...
[Condorcet Loser]
  No strict Condorcet loser; jointly weak Condorcet losers: VanillaClssc, Peach (winless — pairwise ties)
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/02_Examples/runoff_overturns_leader/cases/03_c7_b3_ice-cream-live.yaml
```

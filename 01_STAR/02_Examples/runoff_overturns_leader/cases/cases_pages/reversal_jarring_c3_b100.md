...
**Method:** [STAR (single winner)](../../../../01_Learn/README.md) · **1 seat** · **Expected winner:** Rye
...
Lesson: 01_STAR/01_Learn/the_count/STAR_second_round_FAQ.md

## Ballots

The ballots as marked — the filled bubble is the score given, and the score is the number in its column:

| # | Ballot as marked | Uma | Rye | Tao |
|:--:|:--|:--:|:--:|:--:|
| 1 | <img src="../img/reversal_jarring_c3_b100_ballot_1.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — 51 voters — love Rye, but Uma is a strong 4: Uma 4, Rye 5, Tao 0."> | 4 | 5 | 0 |
| 2 | <img src="../img/reversal_jarring_c3_b100_ballot_2.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — 49 voters — love Uma, reject Rye: Uma 5, Rye 0, Tao 1."> | 5 | 0 | 1 |
...
[Condorcet Loser]
  Condorcet Loser: Tao — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/02_Examples/runoff_overturns_leader/cases/reversal_jarring_c3_b100.yaml
```

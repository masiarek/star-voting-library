...
**Method:** [STAR (single winner)](../../../../01_Learn/README.md) · **1 seat** · **Expected winner:** Blue
...
[Condorcet Loser]
  No strict Condorcet loser; jointly weak Condorcet losers: Coral, Dune (winless — pairwise ties)
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/02_Examples/runoff_overturns_leader/cases/04_c4_b3_runoff-confirms-leader.yaml
```

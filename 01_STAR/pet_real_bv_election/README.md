...
When the score leader, the runoff winner, and the Condorcet winner are the *same* candidate (as here), the result is about as uncontroversial as it gets. (For the case where they *differ*, see [three notions of "winner"](../concepts/properties_and_limits/STAR_three_winner_notions.md) and the [Runoff Reversal](../runoff_overturns_leader/) walkthrough.)

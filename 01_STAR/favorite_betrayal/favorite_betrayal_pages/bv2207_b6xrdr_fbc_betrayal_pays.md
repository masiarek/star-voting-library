...
Everything in one file: the [`_tabulated` mirror](../favorite_betrayal_tabulated/bv2207_b6xrdr_fbc_betrayal_pays_tabulated.txt) (regenerated on every run; every analysis forced on).

...
[Divergence from STAR]
  ...
  RCV-IRV rounds: favorite_betrayal_tabulated/bv2206_7mckyg_fbc_honest_tepid_consensus_RCV-IRV_tabulated.txt
  RCV-RR round-robin: favorite_betrayal_tabulated/bv2206_7mckyg_fbc_honest_tepid_consensus_RCV-RR_tabulated.txt
...
Everything in one file: the [`_tabulated` mirror](../favorite_betrayal_tabulated/bv2206_7mckyg_fbc_honest_tepid_consensus_tabulated.txt) (regenerated on every run; every analysis forced on).

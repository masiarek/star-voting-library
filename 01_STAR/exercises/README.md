...
| **[5 — The squeezed bridge-builder](ex05_center_squeeze.md)** | Every voter scores Brook 3+. Does RCV-IRV ever find that out? | [center squeeze](../../00_start_here/RCV_IRV/RCV_IRV_center_squeeze.md) · Condorcet winner · first-choice bottleneck | [yaml](cases/ex05_center_squeeze.yaml) · live: [↗](https://bettervoting.com/6bry7c/results) |
...
| **[7 — The vanishing votes](ex07_vanishing_votes.md)** | "3 of 9 voters had a preference." Did six votes vanish? | [Equal Support](../../00_start_here/STAR_Voting/the_count/runoff_percentages.md) · the two denominators · zero vs blank | [yaml](cases/ex07_vanishing_votes.yaml) |

...
Everything in one file: the [`_tabulated` mirror](../exercises_tabulated/ex10_reticent_tabulated.txt) (regenerated on every run; every analysis forced on).

...
Everything in one file: the [`_tabulated` mirror](../exercises_tabulated/ex12_proportional_share_tabulated.txt) (regenerated on every run; every analysis forced on).

...
Everything in one file: the [`_tabulated` mirror](../exercises_tabulated/ex11_spoiler_added_tabulated.txt) (regenerated on every run; every analysis forced on).

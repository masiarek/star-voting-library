...
[Divergence from STAR]
  ...
  RCV-IRV rounds: exercises_tabulated/ex05_center_squeeze_RCV-IRV_tabulated.txt
...
Everything in one file: the [`_tabulated` mirror](../exercises_tabulated/ex05_center_squeeze_tabulated.txt) (regenerated on every run; every analysis forced on).

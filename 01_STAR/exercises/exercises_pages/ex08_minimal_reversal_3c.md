...
Everything in one file: the [`_tabulated` mirror](../exercises_tabulated/ex08_minimal_reversal_3c_tabulated.txt) (regenerated on every run; every analysis forced on).

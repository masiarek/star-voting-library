...
[Divergence from STAR]
  ...
  RCV-IRV rounds: exercises_tabulated/ex02_nine_ballots_RCV-IRV_tabulated.txt
  RCV-RR round-robin: exercises_tabulated/ex02_nine_ballots_RCV-RR_tabulated.txt
...
Everything in one file: the [`_tabulated` mirror](../exercises_tabulated/ex02_nine_ballots_tabulated.txt) (regenerated on every run; every analysis forced on).

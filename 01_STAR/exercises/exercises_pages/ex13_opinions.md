...
[Divergence from STAR]
  ...
  RCV-RR round-robin: exercises_tabulated/ex13_opinions_RCV-RR_tabulated.txt
...
Everything in one file: the [`_tabulated` mirror](../exercises_tabulated/ex13_opinions_tabulated.txt) (regenerated on every run; every analysis forced on).

...
**Method:** [STAR (single winner)](../../../concepts) · **1 seat** · **Expected winner:** Ararat
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/Flat_scores_ties/cases/Flat_scores_ties_07_fully_flat.yaml
```

...
→ [STAR Tie-Breaking](../concepts/Tie_Breaking_STAR/tie_breaking.md) · [`GLOSSARY` (Equal Support vs abstention)](../../07_Concepts/GLOSSARY.md) · [reporting true ties](../concepts/reporting/reporting_ties.md) · [Flat scores, ties & tie-breaking (all cases)](README.md).

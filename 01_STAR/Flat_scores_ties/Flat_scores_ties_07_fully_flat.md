...
→ [STAR Tie-Breaking](../concepts/Tie_Breaking_STAR/tie_breaking.md) · [`GLOSSARY` (Equal Support vs abstention)](../../00_start_here/GLOSSARY.md) · [reporting true ties](../concepts/reporting/reporting_ties.md) · [Flat scores, ties & tie-breaking (all cases)](README.md).

...
Lesson: 09_Parked/Flat_scores_ties/README.md#case-02  (BV id pending).

## Ballots

The ballots as marked — the filled bubble is the score given, and the score is the number in its column:

| # | Ballot as marked | Almond | Brownie |
|:--:|:--|:--:|:--:|
| 1 | <img src="../img/Flat_scores_ties_02_runoff_tie_2cand_ballot_1.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — Voter 1: Almond 5, Brownie 5."> | 5 | 5 |
| 2 | <img src="../img/Flat_scores_ties_02_runoff_tie_2cand_ballot_2.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — Voter 2: Almond 5, Brownie 5."> | 5 | 5 |
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/09_Parked/Flat_scores_ties/cases/Flat_scores_ties_02_runoff_tie_2cand.yaml
```

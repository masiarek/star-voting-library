...
**Method:** [STAR (single winner)](../../../../01_Learn/README.md) · **1 seat** · **Expected winner:** Ararat
...
Lesson: 09_Parked/Flat_scores_ties/README.md#case-07  (BV id pending).

## Ballots

The ballots as marked — the filled bubble is the score given, and the score is the number in its column:

| # | Ballot as marked | Ararat | Blanc | Cook |
|:--:|:--|:--:|:--:|:--:|
| 1 | <img src="../img/Flat_scores_ties_07_fully_flat_ballot_1.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — Voter 1: Ararat 5, Blanc 5, Cook 5."> | 5 | 5 | 5 |
| 2 | <img src="../img/Flat_scores_ties_07_fully_flat_ballot_2.png" width="330" style="min-width:330px" alt="A 0–5 STAR ballot — Voter 2: Ararat 5, Blanc 5, Cook 5."> | 5 | 5 | 5 |
...
Legend: For - Equal Support - Against
        * indicates Top 2 Finalist
        Note: Ararat, Blanc and Cook tied at 10 in the Scoring Round, and the
              lot rung (the ballots could not separate them) advanced Ararat
              and Blanc. The * marks who advanced, not who scored highest.
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/09_Parked/Flat_scores_ties/cases/Flat_scores_ties_07_fully_flat.yaml
```

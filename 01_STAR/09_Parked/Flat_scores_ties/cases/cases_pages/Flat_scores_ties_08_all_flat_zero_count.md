...
**Method:** [STAR (single winner)](../../../../01_Learn/README.md) · **1 seat** · **Expected winner:** Anchovy
...
Lesson: 09_Parked/Flat_scores_ties/README.md#case-08  (BV id pending).
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/09_Parked/Flat_scores_ties/cases/Flat_scores_ties_08_all_flat_zero_count.yaml
```

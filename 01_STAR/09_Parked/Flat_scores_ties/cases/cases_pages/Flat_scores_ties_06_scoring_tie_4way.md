...
Level 301. Lesson: 09_Parked/Flat_scores_ties/README.md#case-06  (BV id pending).
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/09_Parked/Flat_scores_ties/cases/Flat_scores_ties_06_scoring_tie_4way.yaml
```

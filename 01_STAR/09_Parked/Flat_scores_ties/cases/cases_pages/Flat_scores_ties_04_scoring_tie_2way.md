...
**Method:** [STAR (single winner)](../../../../01_Learn/README.md) · **1 seat** · **Expected winner:** Aral
...
Lesson: 09_Parked/Flat_scores_ties/README.md#case-04  (BV id pending).
...
[Condorcet Loser]
  No strict Condorcet loser; jointly weak Condorcet losers: Baikal, Crater (winless — pairwise ties)
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/09_Parked/Flat_scores_ties/cases/Flat_scores_ties_04_scoring_tie_2way.yaml
```

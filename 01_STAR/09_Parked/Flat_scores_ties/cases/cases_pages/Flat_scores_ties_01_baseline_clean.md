...
**Method:** [STAR (single winner)](../../../../01_Learn/README.md) · **1 seat** · **Expected winner:** Apple
...
Lesson: 09_Parked/Flat_scores_ties/README.md#case-01  (BV id pending).
...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/Flat_scores_ties_01_baseline_clean_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/09_Parked/Flat_scores_ties/cases/Flat_scores_ties_01_baseline_clean.yaml
```

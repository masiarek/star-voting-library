...
| [#1379 — BV555, scoring-round 3-way tie](https://github.com/Equal-Vote/bettervoting/issues/1379) ✅ WAI | the tie-break *logic* is working-as-intended: the protocol deliberately skips head-to-head for 3+ way ties | 05 |

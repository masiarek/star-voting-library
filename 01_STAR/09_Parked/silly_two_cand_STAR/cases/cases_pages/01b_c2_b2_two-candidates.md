...
Everything in one file: the [`_tabulated` mirror](../cases_tabulated/01b_c2_b2_two-candidates_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/09_Parked/silly_two_cand_STAR/cases/01b_c2_b2_two-candidates.yaml
```

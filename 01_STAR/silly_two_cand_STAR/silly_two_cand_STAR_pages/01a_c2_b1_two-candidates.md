...
Everything in one file: the [`_tabulated` mirror](../silly_two_cand_STAR_tabulated/01a_c2_b1_two-candidates_tabulated.txt) (regenerated on every run; every analysis forced on).

Run it yourself:

```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/silly_two_cand_STAR/01a_c2_b1_two-candidates.yaml
```

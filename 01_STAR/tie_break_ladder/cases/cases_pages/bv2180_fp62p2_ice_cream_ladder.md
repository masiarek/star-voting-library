...
[Condorcet Loser]
  No strict Condorcet loser; jointly weak Condorcet losers: Fudge Brownie, Mango (winless — pairwise ties)
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/tie_break_ladder/cases/bv2180_fp62p2_ice_cream_ladder.yaml
```

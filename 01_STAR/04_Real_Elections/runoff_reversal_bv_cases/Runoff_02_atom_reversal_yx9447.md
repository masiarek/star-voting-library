...
Two views of the **same election** (BV id [`yx9447`](https://bettervoting.com/yx9447/results)). → teaching guide: [Teaching Runoff Reversal — a step-by-step guide](../../02_Examples/runoff_overturns_leader/teaching_runoff_reversal.md) · concept: [The Automatic Runoff Round](../../01_Learn/the_count/STAR_Automatic_Runoff.md) · [`Runoff Reversal`](../../../07_Concepts/GLOSSARY.md).

...
→ the bug, in full: [When "no preference" gets called an "abstention"](../pet_real_bv_election/small_case_abstention_lesson.md) · why "Equal Support" ≠ "abstention": [`GLOSSARY`](../../../07_Concepts/GLOSSARY.md) · where the reports differ: [reporting_diff_BV_LH](../../01_Learn/reporting/reporting_diff_BV_LH.md) · concept: [The Automatic Runoff Round](../../01_Learn/the_count/STAR_Automatic_Runoff.md).

...
Watch the Runoff Table here: **% Between Finalists** is out of 3 (67% / 33%), but **% Runoff Votes** is out of all 5 — the two denominators side by side. ([Runoff percentages](../../01_Learn/the_count/runoff_percentages.md).)

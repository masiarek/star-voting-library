...
**Method:** [STAR (single winner)](../../../../01_Learn) · **1 seat** · **Expected winner:** Sage
...
[Condorcet Loser]
  Condorcet Loser: Tulip — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/04_Real_Elections/runoff_reversal_bv_cases/cases/Runoff_05_reversal_with_equal_support_xgkw3w.yaml
```

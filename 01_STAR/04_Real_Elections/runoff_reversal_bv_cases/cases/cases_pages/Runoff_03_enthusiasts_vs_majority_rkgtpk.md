...
**Method:** [STAR (single winner)](../../../../01_Learn) · **1 seat** · **Expected winner:** Eden
...
[Condorcet Loser]
  Condorcet Loser: Hazel — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/04_Real_Elections/runoff_reversal_bv_cases/cases/Runoff_03_enthusiasts_vs_majority_rkgtpk.yaml
```

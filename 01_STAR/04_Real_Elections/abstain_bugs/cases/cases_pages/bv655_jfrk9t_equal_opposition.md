...
**Method:** [STAR (single winner)](../../../../01_Learn/README.md) · **1 seat** · **Expected winner:** Option 1
...
[Condorcet Loser]
  Condorcet Loser: Option 2 — loses every head-to-head matchup
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/04_Real_Elections/abstain_bugs/cases/bv655_jfrk9t_equal_opposition.yaml
```
...
More cases in this set: [bhckrf7_range_of_scores](bhckrf7_range_of_scores.md) · [bv11_6xhfp8_full_equal_support](bv11_6xhfp8_full_equal_support.md) · [bv1570_6hv7jf_undecided_plurality](bv1570_6hv7jf_undecided_plurality.md)

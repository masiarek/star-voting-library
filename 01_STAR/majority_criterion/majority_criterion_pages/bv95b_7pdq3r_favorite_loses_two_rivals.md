...
Everything in one file: the [`_tabulated` mirror](../majority_criterion_tabulated/bv95b_7pdq3r_favorite_loses_two_rivals_tabulated.txt) (regenerated on every run; every analysis forced on).

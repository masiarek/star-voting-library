...
It's the standard argument *against* the majority criterion, made runnable — and it doubles as the verification behind [electowiki's cardinal-voting article, claim-checked](../../00_start_here/scores_and_ranks/cardinal_voting_claims_checked.md).

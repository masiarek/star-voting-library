...
**Method:** [STAR (single winner)](../../../concepts) · **1 seat** · **Expected winner:** Bruno
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/majority_criterion/cases/bv95b_7pdq3r_favorite_loses_two_rivals.yaml
```

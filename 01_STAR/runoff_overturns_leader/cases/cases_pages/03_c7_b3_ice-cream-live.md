...
**Method:** [STAR (single winner)](../../../concepts) · **1 seat** · **Expected winner:** ChocoAlm
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/runoff_overturns_leader/cases/03_c7_b3_ice-cream-live.yaml
```

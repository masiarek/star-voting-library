...
**Method:** [STAR (single winner)](../../../concepts) · **1 seat** · **Expected winner:** Nora
...
```bash
python STARVote_LH_tabulation_engine/starvote_larry_hastings.py 01_STAR/runoff_overturns_leader/cases/reversal_convincing_c3_b100.yaml
```

...
**The teaching set — `Runoff_01`–`Runoff_06`.** Six real BetterVoting elections, each a **two-view lesson** (BetterVoting screenshots beside the LH report) on the *how much vs how many* arc. Read them in order:

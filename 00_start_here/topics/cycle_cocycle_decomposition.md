...
- William S. Zwicker, "The voters' paradox, spoilers, and the Borda count," *Mathematical Social Sciences* 22(3), 1991, pp. 187–227 — the decomposition, built for voting from the start. **Lean:** neutral; peer-reviewed mathematics.
...
- [Cycle resolution](../RCV_Ranked_Robin/cycle_resolution.md) — what Condorcet methods *do* about the cycle part once it flips a sign · [the Smith set](smith_set.md) · [Ties are forced](ties/ties_are_forced.md) — pure-circulation electorates

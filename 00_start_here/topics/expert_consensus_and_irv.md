...
- [STAR vs RCV-IRV](rcv_irv_vs_star.md) · [STAR's honest limits](../../01_STAR/concepts/properties_and_limits/STAR_honest_limits.md) — where this repo turns the candor on STAR
- IRV-specific behavior: [non-monotonicity](../../06_Other/RCV_IRV/concepts/RCV_IRV_non_monotonicity.md) (concept) & the [worked before/after pair](../../method_comparisons/monotonicity) · [center squeeze](../../06_Other/RCV_IRV/concepts/RCV_IRV_center_squeeze.md) · [exhausted ballots](../../06_Other/RCV_IRV/concepts/RCV_IRV_exhausted_ballots.md) · how STAR differs: [STAR & monotonicity](../../01_STAR/concepts/properties_and_limits/STAR_monotonicity.md)

...
*Sometimes you're not picking a single winner — a board, a committee, a top-4. The instant there's more than one seat, a fork appears that trips almost everyone up: do you want the **N best** candidates, or a body that **mirrors** the whole electorate? Those are different goals, and they need different methods. This page is the plain-language fork; the machinery lives in [proportional representation](../../03_STAR_PR/concepts).*

**Level: 201.** Prerequisite: you know [single-winner STAR](../../01_STAR/concepts/STAR_start_here.md).
...
Neither is "better" — they answer different questions. The whole trick is knowing which question you're asking.
...
| a body that **mirrors** the electorate | **[Proportional STAR](../../03_STAR_PR/concepts/STAR_PR)** or **[STV](../../03_STAR_PR/concepts/stv/proportional_stv_vs_star.md)** | a 40% group deserves ~40% of the seats |
...
Proportional methods all rest on a **quota** — roughly "how many votes buys one seat" (for 3 seats, about a quarter of the voters each). When a candidate crosses the quota they're elected, and their *surplus* (or their voters' remaining weight) flows to the next choice, so no bloc is over-rewarded. STAR-PR and STV differ in the bookkeeping, not the goal. The full mechanics: [the math behind proportional STAR](../../03_STAR_PR/concepts/STAR_PR/the_math_behind_proportional_star.md).

## Go deeper

- **[Bloc STAR](../../02_STAR_Bloc)** — majoritarian multi-winner (the top-N extension of STAR)
- **[Proportional representation](../../03_STAR_PR/concepts)** — the proportional family (Allocated Score, SSS, RRV) and [STV vs STAR-PR](../../03_STAR_PR/concepts/stv/proportional_stv_vs_star.md) on the same electorate
- **[Electing a committee](../../04_Approval/concepts/Multiwinner_Approval/abc_rules_intro.md)** — the same fork on the *approval* side, counting-only (a gentle companion)

...
**See also:** [The strategic pathologies — five Molochs, and where STAR stands](strategic_pathologies.md) · [Choosing among the Equal Vote methods](choosing_among_evc_methods.md) · [Favorite Betrayal — Voting 301](../STAR_Voting/properties_and_limits/favorite_betrayal_voting_301.md) · [Residual vote-splitting](../STAR_Voting/properties_and_limits/residual_vote_splitting.md) · [Scores vs. ranks (cardinal vs ordinal)](../scores_and_ranks/scores_vs_ranks.md) · [STAR FAQ](../STAR_Voting/getting_started/STAR_FAQ.md) · [Glossary](../GLOSSARY.md)

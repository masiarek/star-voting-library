...
**Election A — Ada's majority backs only ONE other candidate** ([`mc_01`](../../../01_STAR/majority_criterion/mc_01_favorite_survives_one_rival.yaml)). They give Bruno a 4 and Cleo a 0:
...
**Election B — the same majority also backs a SECOND candidate** ([`mc_02`](../../../01_STAR/majority_criterion/mc_02_favorite_loses_two_rivals.yaml)). Everything identical except they now give Cleo a 3 instead of 0:

...
| Cycles, and what the tiers do about them | [cycle resolution](../../RCV_Ranked_Robin/cycle_resolution.md) · [the Condorcet-winner paradox](../../voting_paradoxes/condorcet_winner_paradox.md) · [runnable: the two profiles](../../../method_comparisons/cycle_resolution/README.md) |

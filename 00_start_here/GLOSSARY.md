...
- **3-2-1 voting** — rate each candidate **Good / OK / Bad**, then narrow in three steps: **3** semifinalists (most Good) → **2** finalists (fewest Bad) → **1** winner (pairwise runoff). Jameson Quinn / CES; a *reference* method, not EVC-endorsed. → engine + Tennessee demo [`06_Other/three_two_one/`](../06_Other/three_two_one/README.md)
...
See also: [00_START_HERE.md](00_START_HERE.md) (teaching sequence) · [Why_STAR_Voting.md](Why_STAR_Voting.md) (presentation + debate prep) · [CURRICULUM.md](CURRICULUM.md) (lesson outline).

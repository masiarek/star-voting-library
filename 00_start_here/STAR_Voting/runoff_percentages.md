...
[BetterVoting result — frozen snapshot (pet race)](../../01_STAR/pet_real_bv_election/BV_result_snapshot.md). (See [reading a STAR report](../tabulation_engines/LH_starvote/reading_a_star_report.md) for the
...
[A real BetterVoting election, end to end](../../01_STAR/pet_real_bv_election/).

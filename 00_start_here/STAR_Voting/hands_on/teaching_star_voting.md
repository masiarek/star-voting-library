...
The conceptual walkthrough is [Count a STAR election by hand](count_star_by_hand.md); why it scales (precinct-summable, unlike IRV) is [summability](STAR_summability.md).

...
STAR is [strategy-*resistant*, not strategy-*proof*](../topics/strategic_voting.md); it *usually* elects the head-to-head winner, but not always; and like every method it can be gamed in constructed cases. The repo documents these squarely — see [STAR's honest limits](STAR_honest_limits.md), [residual vote-splitting](residual_vote_splitting.md), and [favorite betrayal (301)](favorite_betrayal_voting_301.md). Overselling a reform is how you get backlash; STAR earns trust by being square about its limits.

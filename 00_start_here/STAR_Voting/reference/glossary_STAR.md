...
- **Scoring round** — STAR's first round: add up each candidate's scores; the top two become finalists. → concept [The Scoring Round](../the_count/STAR_Scoring_Round.md); demo [`equal_support_runoff_demo`](../../../01_STAR/_main/cases/cases_pages/equal_support_runoff_demo.md)

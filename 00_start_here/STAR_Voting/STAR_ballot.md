...
<img src="img/star_ballot_official_evc.png" width="460" alt="The official STAR Voting ballot: the STAR VOTING wordmark and tagline Score-Then-Automatic-Runoff, the four marking rules, and a grid of five candidates — Andre, Blake, Carmen, David, Erin — each with bubbles from 0 (Worst) to 5 (Best). This voter filled in Andre 5, Blake 0, Carmen 4, David 4, Erin 1. Footer: the two highest scoring candidates are finalists; your full vote goes to the finalist you prefer; the finalist with the most votes wins.">

...
- **Scoring round** — STAR's first round: add up each candidate's scores; the top
  two become finalists. → concept [The Scoring Round](STAR_Scoring_Round.md); demo [`equal_support_runoff_demo`](../../01_STAR/_main/_main_pages/equal_support_runoff_demo.md)
...
- **Three notions of "winner"** — Condorcet / Score / Runoff can name three
  ...
  → [Three Notions of "Winner" — Condorcet, Score, and Runoff](STAR_three_winner_notions.md)
...
- **Bloc STAR** — multi-winner STAR electing the top N (at-large / majoritarian,
  **not** proportional). → [02_STAR_Bloc — Bloc STAR (multi-winner, majoritarian)](../../02_STAR_Bloc/)
- **Proportional STAR** — multi-winner STAR variants (Allocated Score, Sequentially
  Spent Score, RRV) giving proportional representation. → [03_STAR_PR — proportional STAR (multi-winner)](../../03_STAR_PR/)

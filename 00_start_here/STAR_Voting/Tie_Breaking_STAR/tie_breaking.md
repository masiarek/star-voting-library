...
- Equal-score handling in the runoff: ["Aren't Equal-Score Votes Just Discounted?"](../reference/are_equal_score_votes_discounted.md) · demo [`equal_support_runoff_demo.yaml`](../../../01_STAR/_main/cases/equal_support_runoff_demo.yaml)

...
→ The payoff this design produces: [Runoff Reversal](../../01_STAR/runoff_overturns_leader/) and [Three notions of "winner"](STAR_three_winner_notions.md). Glossary: [`STAR`](../GLOSSARY.md).

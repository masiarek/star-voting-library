...
In the runnable [style-gallery election](../../../01_STAR/_main/cases/cases_pages/03c_c6_b8_style-gallery.md), the weak-backup row is `0,5,0,0,0,1` — Bianca 5, Frank 1. Bianca and Frank became the two finalists anyway, and the ballot's runoff vote went to Bianca (5 over 1), who won. Same runoff behavior as the decent backup — the difference was all in the scoring round, where this ballot gave Frank one point instead of four.

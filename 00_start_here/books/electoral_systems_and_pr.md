...
The definitive book on **apportionment** — how a fixed number of seats gets divided among states or parties by population. It's the source of the surprising impossibility results (you can't have every fairness property at once) that shaped how the U.S. House is apportioned. A different, tidy corner of the mathematics of democracy, done to completion.

...
**Alma is max-scored by an outright majority**, so [Choose-One](../topics/plurality.md) and [RCV-IRV](../RCV_IRV/RCV-IRV-Hare.md) — both of which satisfy the majority criterion — elect Alma, IRV in the first round. **Score, STAR and [Ranked Robin](../RCV_Ranked_Robin/why_ranked_robin.md) all elect Celia.**
...
→ Run it: [`majority_vs_consensus_51_49.yaml`](../../01_STAR/majority_criterion/cases/majority_vs_consensus_51_49.yaml) · full report: [page](../../01_STAR/majority_criterion/cases/cases_pages/majority_vs_consensus_51_49.md) · [`_tabulated`](../../01_STAR/majority_criterion/cases/cases_tabulated/majority_vs_consensus_51_49_tabulated.txt)

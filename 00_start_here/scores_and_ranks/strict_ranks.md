...
On a strict ballot you may not mark two candidates **equal**. If you honestly feel two candidates are about the same, the ballot forces you to invent an order anyway — "is she my 4th or my 5th?" Marking them the same is treated as an **overvote** and can spoil that rank.
...
The alternative — letting voters mark candidates equal — is a [weak rank](weak_ranks.md), which Ranked Robin and the other Condorcet methods allow. Scores go further still, carrying order *and* strength: [scores vs. ranks](scores_vs_ranks.md).

...
→ Hub: [STAR Reporting](../) · the mapping in full: [BetterVoting and the LH engine](../../tabulation_engines/bettervoting_and_the_engine.md) · the percentages: [Runoff percentages](../../STAR_Voting/the_count/runoff_percentages.md).
...
- **Race Details tables** — a **Scores Table** (the score totals) and a **Runoff Table** with **two percent columns**:
  ...
  - **% Between Finalists** — out of only the voters *with a preference*. This is the column that decides the race. (Same idea, named: [Runoff percentages](../../STAR_Voting/the_count/runoff_percentages.md).)
...
(The same screenshots, walked through against the two denominators, are in [Runoff percentages](../../STAR_Voting/the_count/runoff_percentages.md).)

...
- **Read with 301.18:** the forced-tie rotation profiles are the far end of this spectrum — quality signal exactly zero, pure circulation. And with [cycle resolution](../RCV_Ranked_Robin/cycle_resolution.md): resolution rules are what Condorcet methods *do* about the cycle part once it has flipped a sign.

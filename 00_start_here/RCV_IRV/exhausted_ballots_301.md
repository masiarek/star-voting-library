...
So the precise sentence is *"**RCV-IRV** has exhausted ballots,"* never *"RCV has exhausted ballots."* (See [the terminology tips](../tips/TIPS_terminology.md).) <!-- terminology-ok: quotes the imprecise phrasing to correct it -->
...
> [SLIDE] **Exhausted Ballots** (deck) — the red-box / blue-box flow chart (see [`LINKS.md`](../LINKS.md)). [REPO] full source notes: **Exhausted Ballots (doc)** in `LINKS.md`.
...
> [REPO] [`are_equal_score_votes_discounted.md`](../STAR_Voting/reference/are_equal_score_votes_discounted.md) — the STAR-side of this same contrast (Segment B: "declared tie vs lost voice"). [DEMO] `01_STAR/_main/equal_support_runoff_demo.yaml` — Equal Support ballots that *picked the finalists*, then stayed neutral in the runoff.
...
- **Level:** Voting 301 — pairs with [`favorite_betrayal_voting_301.md`](../STAR_Voting/properties_and_limits/favorite_betrayal_voting_301.md) (the *other* IRV-internals deep dive) and [`are_equal_score_votes_discounted.md`](../STAR_Voting/reference/are_equal_score_votes_discounted.md) (the STAR no-preference side of this exact contrast).
...
Cross-references:
- [`GLOSSARY.md`](../GLOSSARY.md) — "Exhausted ballot," "Equal Support / No Preference."
- [`TIPS_terminology.md`](../tips/TIPS_terminology.md) — exhaustion is IRV-specific, not all RCV.
- [`CURRICULUM.md`](../CURRICULUM.md) — 301.7.
- [`LINKS.md`](../LINKS.md) → **Exhausted Ballots (doc)**, **Exhausted Ballots (deck)**, **Full Deck 2025** ("Ranked Choice Deal Breakers" / exhausted-ballot slides), and the **RCV-IRV exhausted-ballot source notes** group (wasted-votes glossary, ranking-limit, definition, tabulation-transparency, commentary).

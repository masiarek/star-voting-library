...
- **2006 — enacted.** The General Assembly authorized IRV for certain judicial vacancies and set up a **pilot program** (up to 10 cities in 2007, up to 10 counties in
...
1. hurts **election integrity** and raises **cost and labor**, making audits and recounts harder;
2. doesn't give voters a real "second chance";
3. leaves **not all votes counted** (2nd/3rd choices are never tabulated unless a runoff round is reached);
...
Sources: [Electoral reform in North Carolina — Wikipedia](https://en.wikipedia.org/wiki/Electoral_reform_in_North_Carolina), [2010 North Carolina judicial elections — Wikipedia](https://en.wikipedia.org/wiki/2010_North_Carolina_judicial_elections), [The Short Life and Quiet Death of Ranked-Choice Voting in NC — The Assembly](https://www.theassemblync.com/news/politics/elections/ranked-choice-votingnorth-carolina-elections/), [NC Court of Appeals IRV Results — FairVote](https://www.fairvote.org/nc_court_of_appeals_instant_runoff_election_results). Critics' case (reader-supplied): [Instant-Runoff Voting regrets in NC — ncvoter.net](https://web.archive.org/web/20260513073459/https://ncvoter.net/instant-runoff-voting-regrets-in-nc/) and the NC Coalition for Verified Voting (Joyce McCloy) writings.

...
Method-specific terms for **Ranked Robin** (RCV-RR) and the broader Condorcet
family. Shared, cross-method vocabulary lives in the
...
- **Minimax (Simpson–Kramer)** — elect the candidate whose *worst* pairwise loss is
  smallest.
...
[main glossary](../GLOSSARY.md#properties--criteria) (they apply across methods).*

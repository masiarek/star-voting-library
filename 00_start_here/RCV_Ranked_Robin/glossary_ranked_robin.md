...
Method-specific terms for **Ranked Robin** (RCV-RR) and the broader Condorcet family. Shared, cross-method vocabulary lives in the [main glossary](../GLOSSARY.md).
...
- **Ranked (ordinal) ballot** — the ballot Ranked Robin reads: order over degree of support, shared with RCV-IRV and STV (the term is defined once in the [main glossary](../GLOSSARY.md)). Unlike IRV's strict ballot, Ranked Robin naturally allows **equal ranks** (weak ranks) — see [Strict vs. Weak Ranks — Not All Ranked Ballots Are the Same](../scores_and_ranks/strict_vs_weak_ranks.md) and scored vs ranked [Scores vs. Ranks — Don't Confuse Ranks and Ratings](../scores_and_ranks/scores_vs_ranks.md).

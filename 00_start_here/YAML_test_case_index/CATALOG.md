...
**Totals:** 284 elections, 417 races. Full drill-down: [`races.csv`](races.csv) · [`elections.csv`](elections.csv). Related: [BV registry](BV_registry.md) · [multi-race index](multirace_elections.md) · [by method](README.md).
...
| 01_c3_b31_graders-divide | The Graders' Divide — a harsh 0-2 camp meets a gentl | 1 | single-race | 31 | STAR | LH-only |
...
| 02_c4_b40_cliff-city | Cliff City food trucks — everyone scores 0 or 3-5, n | 1 | single-race | 40 | STAR | LH-only |
...
| 03_c4_b33_bullet-storm | Bullet Storm — a bullet-voting electorate and the fe | 1 | single-race | 33 | STAR | LH-only |
...
| 04_c4_b47_noise-soup | Noise Soup — weak factions, cross-winds, flat-liners | 1 | single-race | 47 | STAR | LH-only |
...
| 05_c3_b38_squeeze-survives | Does the squeeze survive noise? Two poles, one conse | 1 | single-race | 38 | STAR | LH-only |
...
| 06_c4_b24_narrow-bands | Narrow Bands — a paint-swatch election scored in sli | 1 | single-race | 24 | STAR | LH-only |
...
| 07a_c5_b36_herb-council-bloc-3-seats | The Herb Garden Council — Bloc STAR, 3 seats (the ma | 1 | single-race | 36 | STAR | LH-only |
| 07b_c5_b36_herb-council-pr-3-seats | The Herb Garden Council — Allocated Score / STAR-PR, | 1 | single-race | 36 | STAR_PR | LH-only |
| 08_c6_b29_quota-circus-pr-2-seats | Quota Circus — STAR-PR with cliff, slate and gentle  | 1 | single-race | 29 | STAR_PR | LH-only |
| 09_c4_b100_tennessee-capital | Tennessee Capital — classic STAR example | 1 | single-race | 100 | STAR | LH-only |
| 09_c7_b44_park-bloc-4-seats | Replant the Park — Bloc STAR with 7 trees, 4 seats,  | 1 | single-race | 44 | STAR | LH-only |
...
| s1_sincere_thin_moderate_c3_b100 | Sincere STAR — the center wins (Beth is the Condorce | 1 | single-race | 100 | STAR | LH-only |
| s2_strategic_510_thin_moderate_c3_b100 | Strategic 5-1-0 STAR — the center is squeezed out (f | 1 | single-race | 100 | STAR | LH-only |
| s3_irv_thin_moderate_c3_b100 | RCV-IRV on the same electorate — also squeezes the c | 1 | single-race | 100 | IRV | LH-only |
| s4_strategic_510_real_moderate_c3_b100 | Strategic 5-1-0 STAR, real moderate base — STAR STIL | 1 | single-race | 100 | STAR | LH-only |
| s5_irv_real_moderate_c3_b100 | RCV-IRV, real moderate base — still squeezes the cen | 1 | single-race | 100 | IRV | LH-only |
...
|---|--:|---|
| single-race | 222 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c3_b31_graders-divide, 01_c4_b2_bloc-star-2-seats |
...
|---|--:|---|
| single-winner | 367 | 00_plurality_vs_majority, 01_c3_b31_graders-divide, 01_condorcet_winner, 01_political_left_split |
...
|---|--:|---|
| score | 230 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c3_b31_graders-divide, 01_c4_b2_bloc-star-2-seats |
| ranked | 127 | 01_condorcet_winner, 02_cycle_no_condorcet, 03_real_record0_c6_b5, 03a_stv_3seats |
...
|---|--:|---|
| majoritarian | 325 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c3_b31_graders-divide, 01_c4_b2_bloc-star-2-seats |
...
|---|--:|---|
| STAR | 210 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c3_b31_graders-divide, 01_c4_b2_bloc-star-2-seats |
| RankedRobin | 61 | 01_condorcet_winner, 02_cycle_no_condorcet, 03_real_record0_c6_b5, 04_smith_set_c4_b7 |
| IRV | 53 | 2jrfpg, 4htk44, 6bry7c, 6fj2kg |
...
| LH-only | 166 | 00_c3_b3_bloc-baseline-2-seats, 00_plurality_vs_majority, 01_c3_b31_graders-divide, 01_c4_b2_bloc-star-2-seats |
